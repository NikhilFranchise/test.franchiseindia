...
// Temporally
    public function getInsightsDetails1(Request $request)
    {
        $id = $request->id;
        $locale = request()->segment(2) == 'hi' ? 'hi' : 'en';
        app()->setLocale($locale);
        ...
        // Return view with compacted variables
        return view('insights.insights_detail', compact('newsDetails', 'author_details', 'franchiseData', 'assocTags', 'trendingArticles', 'latestArticles'));
    }
