...
class SitemapController extends Controller
{
    public function sitemap()
    {
        ...
        /* Education Articles Site map Generation End */

//        /* Restaurant Articles Site map Generation Start */
//        $siteMapData = '<url>
//                                <loc>https://www.franchiseindia.com/restaurant/</loc>
//                                <lastmod>'.date('Y-m-d').'</lastmod>
//                            </url>
//                            <url>
//                            <loc>https://www.franchiseindia.com/restaurant/about</loc>
//                                <lastmod>'.date('Y-m-d').'</lastmod>
//                            </url>
//                            <url>
//                            <loc>https://www.franchiseindia.com/restaurant/contact/</loc>
//                                <lastmod>'.date('Y-m-d').'</lastmod>
//                            </url>
//                            <url>
//                                <loc>https://www.franchiseindia.com/restaurant/feedback/</loc>
//                                <lastmod>'.date('Y-m-d').'</lastmod>
//                            </url>
//                            <url>
//                                <loc>https://www.franchiseindia.com/restaurant/terms</loc>
//                                <lastmod>'.date('Y-m-d').'</lastmod>
//                            </url>';
//
//        $riArticles     = ContentList::query()->where('site_type', 'ri')->where('status', 1)->orderBy('content_id', 'desc')->get();
//        foreach ($riArticles as $article) {
//            $siteMapData .= "<url>
//                                <loc>
//                                https://www.franchiseindia.com/restaurant/".str_replace('&', '&amp;', $article->slug).".".$article->content_id."</loc>
//                                <lastmod>".substr($article->created_at, 0, 10)."</lastmod>
//                            </url>";
//        }
//        Storage::getFacadeRoot()->put( "sitemap_ricontent.xml", $siteMapInitializer.$siteMapData.$siteMapTerminator);
