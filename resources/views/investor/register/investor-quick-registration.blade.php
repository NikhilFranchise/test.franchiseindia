...
@section('seoDesc', 'All set to become an entrepreneur? Register with Franchise India and become an A-list Investor to
                  ...
                  <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                     <div class="row">
                        <input type="checkbox" name="is_termsagree4" id="is_termsagree4" value="1"
                           checked> I agree to the <a href="{{ Config('constants.MainDomain') }}/terms"
