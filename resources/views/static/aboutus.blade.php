...
<div class="row">
<div class="col-xs-12 col-sm-12 col-md-12"><h1> About Us</h1>
@php
...
<li class="col-xs-12 col-sm-3 col-md-3"> <div class="imgbat"><img src="{{URL::asset('images/about-us1.jpg')}}" alt="about us"/></div><span>Knowledge</span> Anchored by a consortium of global experts and seasoned professionals.</li>
<li class="col-xs-12 col-sm-3 col-md-3"> <div class="imgbat"><img src="{{URL::asset('images/about-us2.jpg')}}" alt="about us"/></div><span>Opportunity</span> Constructs a unified platform harnessing focused media to cultivate and present opportunities.</li>
<li class="col-xs-12 col-sm-3 col-md-3"> <div class="imgbat"><img src="{{URL::asset('images/about-us3.jpg')}}" alt="about us"/></div><span>Network</span>Supports local investors through its expansive presence, featuring 60 offices globally.</li>
<li class="col-xs-12 col-sm-3 col-md-3"> <div class="imgbat"><img src="{{URL::asset('images/about-us4.jpg')}}" alt="about us"/></div><span>Success</span> Distinguished by the successful execution of numerous franchising projects.</li>
</ul>
