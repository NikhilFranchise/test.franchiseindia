    ...
    <script>
        ...
        $(document).ready(function() {
            $("#sidebar").mCustomScrollbar({
                ...
                $("#sidebar").addClass("active"), $(".overlay").addClass("active"), $(".collapse.in")
                    .toggleClass("in"), $("a[aria-expanded=true]").attr("aria-expanded", "false")
            })
        });
    </script>
    <script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function submitCategory() {
                ...
                if (subSubCat) {
                    url = url + $('option:selected', $('#getSubCatCategoryDataHeader')).attr('slug') + '.ssc' +
                        subSubCat +
                        "?catTab=1";
                } else if (subCat) {
                    ...
                    "undefined") {
                    url = url + $('option:selected', $('#getMainCategoryDataHeader1')).attr('slug') + '.m' +
                        mainCat +
                        "?catTab=1";
                } else {
                    url = url + 'all/all';
    ...
    <script>
        $(document).ready(function() {
            ...
            l.select2({
                ...
                var t = l.val();
                t && 5 < t.length && (alert("You can select only 5 preferred cities."), $(e.params.data
                    .element).prop("selected", !1), l.trigger("change"))
