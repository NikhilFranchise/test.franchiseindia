...
.header-slider-tab2 .nav-tabs > li > a{font-size:14px; background:#fff; color:#222; margin-right:0px; padding:10px 50px; text-transform:uppercase; border-radius: 0px; border:#666 1px solid;}
...
<div class="modal fade header-slider2" id="desktop_modal_homepage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <form id="form1" action="/submit-enquiry" method="POST">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <select name="city" id="popupcity" class="form-control" required>
    ...
    <form id="form2" action="/submit-enquiry2" method="POST">
        @csrf
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <select name="city" id="popupcity2" class="form-control" required>
                    <option value="">Select City</option>
                </select>
            </div>
        </div>
