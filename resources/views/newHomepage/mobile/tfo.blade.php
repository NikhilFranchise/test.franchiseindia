            ...
            <div class="leading-card">
                <div class="brand-ins">
                    <a href="{{ $brandUrl }}" target="_blank" aria-label="{{ $logoDetail['brand_heading'] }}"><img
                            loading="lazy" src="{{ $logoDetail['brand_img'] }}" alt="{{ $logoDetail['brand_alt'] }}"
                            width="192" height="86" loading="lazy">
                </div>
                ...
                <div class="leading-card-brand-title">
                    <h2><a href="{{ $brandUrl }}" target="_blank"
                            aria-label="{{ $logoDetail['brand_heading'] }}">{{ $logoDetail['brand_heading'] }}</a>
                    </h2>
                </div>
                ...
                <a href="{{ $brandUrl }}" target="_blank" class="know-more"
                    aria-label="{{ $logoDetail['brand_heading'] }}">{{ Request::segment(1) == 'hi' ? 'अधिक जानिए' : 'Know More' }}</a>
            </div>
        @endforeach
    </div>
</section>
