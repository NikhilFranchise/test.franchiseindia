<section class="top-business-opportunities">
    <h2 class="brands-head">{{ Request::segment(1) == 'hi' ? 'शीर्ष कारोबारी अवसर' : 'Top Business Opportunities' }}</h2>
    <div class="card-wrap">
            ...
            @if ($loop->index < 12)
                ...
                <div class="leading-card">
                    ...
                    <div class="leading-card-investment">
                        <div class="card-info">{{ Request::segment(1) == 'hi' ? 'निवेश सीमा' : 'Investment range' }}
                        </div>
