...
<html lang="en">
   ...
   <head>
      ...
      <title>@if (request()->segment(2) != 'hi')@yield('seoTitle', 'Franchise India - Business Opportunities, Franchise Opportunities')@elseif (request()->segment(2) == 'hi')@yield('seoTitle', 'फ्रैंचाइज़ इंडिया - व्यावसायिक अवसर, फ्रैंचाइज़ अवसर')@endif</title>
      ...
      <link rel="preload" fetchpriority="high" as="image" href="cvw/assets/img/banner-expo.webp" type="image/webp">
      <link rel="stylesheet"
                     ...
                     <div class="d-flex p-30 m-align">
                        ...
                        <div class="logo"><a href="https://www.franchiseindia.com">
                           <img src="https://www.franchiseindia.com/newhomepage/assets/img/Logo.svg"
                              alt="Franchise India" height="32" width="200"></a>
                        </div>
                        <div class="d-flex m-search">
                           ...
                           <span class="login-text-right text-right d-main">
                              <span>
                              @if (Auth::check())
