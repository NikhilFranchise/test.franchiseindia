...
@endif
@php
	$hindiUrl = Config('constants.MainDomain').'/hi/brands/'.$franDetails->profile_name.'.'.$franDetails->fran_detail_id;
	$engUrl   = Config('constants.MainDomain').'/brands/'.$franDetails->profile_name.'.'.$franDetails->fran_detail_id;
@endphp
@section('hindibrandUrls')
    <link rel="amphtml" href="{{ Config('constants.MainDomain') }}/amp/brands/{{ $franDetails->profile_name }}.{{ $franDetails->fran_detail_id }}">
...
@section('content')
    ...
    @if($franDetails->membership_type != 1)
        ...
        <style type="text/css">
            .bgrunn { padding-top:0px!important; }
			.brandwidth { border:1px solid #dfdfdf; padding:20px; background:#fff; border-radius:10px; margin-top:10px;  }
            @media screen and (max-width: 767px){.bgrunn{padding-top: 0px!important;background-color: transparent;}}
        </style>
    @else
            ...
            <div class="modal-content">
                <form method="post" id="contactform" action="{{ Config::get('constants.MainDomain')}}/brandcontactinfo">
                    ...
                    <div class="modal-header" style="text-align: center;">
                        ...
                        <h4 class="modal-title" id="conactheading">You have requested information For <strong>{{$franDetails->company_name}}</strong></h4>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="infoname" id="contactname" class="form-control" placeholder="Enter Name" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="email" id="contactemail" class="form-control check-existing-registered-investor" placeholder="Enter E-mail" required name="infoemail">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="contactaddress" name="address" placeholder="Enter Address" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6" style="display: none;" id="otpblock">
                                        <div class="form-group pos-rel">
                                            ...
                                            <span class="vrfy" id="verify_button"  style="display: block" onclick="verify()">VERIFY</span>
                                        </div>
                                        <div style="display: none" id="mismatch">OTP Mismatch</div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group pos-rel">
                                            <input id="pincodecontact" type="text" class="form-control" name = "pincode" pattern="[0-9]{5,6}" minlength="6" maxlength="6" placeholder="Enter Pincode">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group pos-rel">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-12">
                                        <div class="form-group txt-center">
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="is_termsagree" id="is_termsagree1" value="1" checked>I agree to the <a href="{{Config('constants.MainDomain')}}/terms" target="_blank">Terms & Conditions</a></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="ratingmsg">
                            ...
                            <div class="sasnsta">
                                <div style="text-align: center;">
                                    ...
                                    <input type="button" class="btn btn-default btntb" value="Submit" onclick="ratings('{{$franDetails->franchisor_id}}');">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="macashare">
                        <ul class="sharecat">
                            <li><a href="http://www.facebook.com/sharer.php?u={{url()->current()}}" target="_blank"><img src="{{URL::asset('images/facebookcat.gif')}}" alt="Facebook"><span>Facebook</span></a></li>
                            <li><a href="https://twitter.com/share?url={{url()->current()}}" target="_blank"><img alt="twitter" src="{{URL::asset('images/twittercat.gif')}}"><span>Twitter</span></a></li>
                            <li class="btline"><a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{url()->current()}}" target="_blank"><img alt="linkedin" src="{{URL::asset('images/linkedincat.gif')}}"><span>LinkedIn</span></a></li>
                            <li class="webt"><a href="whatsapp://send?text={{url()->current()}}" target="_blank"><img alt="whatsapp" src="{{URL::asset('images/whatsappcat.gif')}}"><span>Whatsapp</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <form method="post" id="compareForm" style="display: none;" action="{{URL('compare-brands')}}">
        <input type="hidden" name="franchisors" id="franchisorsForComparison" value="{{$franDetails->franchisor_id}}">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ( $.isNumeric(data) ) {
                        ...
                        $('#queryCount').html('You have '+ data +' credits remaining. Do you want to use the credit');
...
//                        $('#companyContact').html(data.user.company_name);
                        ...
                        $('#addressocontact').html(obj.user.fran_address+""+obj.user.city+""+obj.user.state+""+obj.user.pincode);
                        $('#emailcontact').html("<a href='mailto:"+obj.user.email+"' target='_blank'>"+obj.user.email+"</a>");
                        $('#mobilecontact').html(obj.user.mobile);
                        $('#websitecontact').html("<a href='http://"+obj.user.website+"' target='_blank'>"+obj.user.website+"</a>");
                    }
                }
            });
        });
...
//                    $('#companyContact').html(data.user.company_name);
        ...
        function getcityinfo(value){
            ...
            $.ajax({
                ...
                data:{state : value, franId : franId},
                success:function(data){
        ...
        $(document).ready(function () {
            $('#applbtn').click(function () {
                $('.aplbtn').hide();
                $("html, body").animate({ scrollTop: $('.insta-apply').offset().top-150 }, 1000);
