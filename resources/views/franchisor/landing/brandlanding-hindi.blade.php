            ...
            <div class="modal-content">
                ...
                <input type="hidden" name="frandetailsid" id="freeinfovalue" value="{{$franDetails->franchisor_id}}">
                    <div class="modal-header" style="text-align: center;">
                        ...
                        <h4 class="modal-title" id="conactheading">आपने जानकारी के लिए अनुरोध किया है <strong>{{$franDetails->company_name}}</strong></h4>
                    </div>
                    ...
                    <div class="modal-body popcentreq" id="ajaxReshideblock">
                        ...
                        @if(Auth::user())
                            ...
                            <div class="requested-frm" id="upgradeContact" style="display: none">
                                ...
                                <a href="{{URL('investor/myaccount/payment')}}" class="btn btn-default btn-red" >खाते का उन्नयन</a>
                            </div>
                        @endif
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="infoname" id="contactname" class="form-control" placeholder="नाम दर्ज" required>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="email" id="contactemail" class="form-control check-existing-registered-investor" placeholder="ईमेल दर्ज करें" required name="infoemail">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="contactaddress" name="address" placeholder="पता लिखिए" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6" style="display: none;" id="otpblock">
                                    <div class="form-group pos-rel">
                                        ...
                                        <span class="vrfy" id="verify_button"  style="display: block" onclick="verify()">सत्यापित करें</span>
                                    </div>
                                    <div style="display: none" id="mismatch">ओटीपी मिस्चैच</div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                   <div class="form-group pos-rel">
                                       <input id="pincodecontact" type="text" class="form-control" name = "pincode" pattern="[0-9]{5,6}" minlength="6" maxlength="6" placeholder="पिनकोड दर्ज करें">
                                   </div>
                               </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group pos-rel">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group txt-center">
                                        <div class="checkbox">
                                            <label><input type="checkbox" id="expressinstanewsletters" name="newsletter_sub" checked>हां, मैं साप्ताहिक न्यूज़लेटर का ग्राहक बनना चाहूंगा</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ( $.isNumeric(data) ) {
                        ...
                        $('#creditRemaining').html('आपके पास '+ data +' शेष हैं| क्या आप क्रेडिट का उपयोग करना चाहते हैं');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ( $.isNumeric(data) ) {
                        ...
                        $('#queryCount').html('आपके पास '+ data +' शेष हैं| क्या आप क्रेडिट का उपयोग करना चाहते हैं');
