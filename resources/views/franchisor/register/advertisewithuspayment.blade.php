...
<div class="" style="text-align:center;margin-top: 45px; margin-bottom:30px; color: #000;font-size: 17px;font-weight: 400;clear: both;">Chat on <a href="https://api.whatsapp.com/send?phone=919312650021&amp;text=Hello,%20I%20am%20interested%20in%20knowing%20more%20about ?%20https://www.franchiseindia.com/" target="_blank"><img src="https://www.franchiseindia.com/newhomepage/assets/img/whatappsicon.svg" class="sts"></a></div>
                        ...
                        <div class="priclistinner">
                            ...
                            <div class="ftyblk">
                                <div class="rinr cent"><i class="fas fa-rupee-sign"></i>
                                    <span class="pf1">0</span><span class="pf2"></span></div>
                            </div>
   ...
   <!--<li>Get Maximum 5 Leads in a month</li>-->
                        ...
                        <div class="priclistinner">
                            ...
                            <div class="ftyblk">
                                ...
                                <div class="rinr otherp">
                                    ...
                                    <span class="pf1">1,43,000</span><span class="pf2"><!--<del class="dll">1,43,000</del>--> / 6 Months</span>
                                </div>
                                <div class="rinr otherp">
                                    <div class="radio-item">
                                    ...
                                    <i class="fas fa-rupee-sign"></i>
                                    <span class="pf1">1,62,500</span><span class="pf2"><!--<del class="dll">1,62,500</del>--> / 1 Year</span>
                                </div>
                            </div>
					...
					2,27,500</del>--> / 6 Months</span>
                                ...
                                <div class="rinr otherp">
                                    <div class="radio-item">
                                        <input type="radio" id="ritema7" name="memberplan"  value="121" checked>
                                        <label for="ritema7"></label>
                                    </div>
                                    <i class="fas fa-rupee-sign"></i>
                                    <span class="pf1">2,92,500</span><span class="pf2"><!--<del class="dll">2,92,500</del>--> / 1 Year</span>
                                </div>
                            </div>
                            <input class="btncir" type="submit" value="Buy Now">
                            </form>
                ...
                <div class="priclist">
                    ...
                    <div class="priclistinner">
                        ...
                        <div class="ftyblk">
                            ...
                            <div class="rinr otherp">
                                <div class="radio-item">
                                    <input type="radio" id="ritema21" name="memberplan" id="price2" value="123" >
