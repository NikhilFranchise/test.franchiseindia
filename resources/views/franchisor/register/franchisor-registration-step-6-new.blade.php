...
<html>
  ...
  <body>
          ...
          <section class="pricing" id="pricing">
            <div class="container">
              <div class="row">
                ...
                <div class="whatsapp_icon" style="text-align:center;margin-top: 45px;color: #000;font-size: 17px;font-weight: 400;">Chat on <a href="https://api.whatsapp.com/send?phone=919312650021&amp;text=Hello,%20I%20am%20interested%20in%20knowing%20more%20about ?%20https://www.franchiseindia.com/" target="_blank"><img src="https://www.franchiseindia.com/newhomepage/assets/img/whatappsicon.svg" class="sts" style="width:2%;"></a></div>
                <!--  -->
                <!-- Choose Your Plan & Enhance the online presence of your business (24x7) -->
                <div class="col-xs-12 col-sm-12 col-md-12
                  col-lg-12 col-xl-12 section-hed hide-div" style="display:none;">
                  <h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12
                  ...
                  <form class="form-horizontal" id="fran-form" name="form_franchisor" action="{{ url('franchisor/registration/step/final')}}" method="POST" role="form" enctype="multipart/form-data">
                      ...
                      <table  class="pricing-table-section">
                        <tbody>
                          ...
                          <tr class="subsection1">
                            <td></td>
                            <td>
                              <div class="free"><input class="form-check-input" type="radio" name="memberplan" value="1"  @if($advertiseplan == 1) checked @endif> FREE</div>
                            </td>
                            <td>
                              <div class="starting-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="113" @if($advertiseplan == 113) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Monthly: &nbsp;
                                </label>
                              ...
                              <div class="middle-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="114" @if($advertiseplan == 114) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Quarterly: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                                  <span class="offerd-price">
                                  &#x20B9; 24999
                              ...
                              <div class="annually-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="122" @if($advertiseplan == 122) checked @endif>
                                <input class="form-check-input" type="radio" name="memberplan" value="115" @if($advertiseplan == 115) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Annually: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                                  <span class="offerd-price">
                                  &#x20B9; 89988
                            ...
                            <td>
                              <div class="starting-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="116" @if($advertiseplan == 116) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Monthly: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                              ...
                              <div class="middle-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="117" @if($advertiseplan == 117) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Quarterly: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                              ...
                              <div class="annually-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="123" @if($advertiseplan == 123) checked @endif>
                                <input class="form-check-input" type="radio" name="memberplan" value="118" @if($advertiseplan == 118) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Annually: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                            ...
                            <td>
                              <div class="starting-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="119" @if($advertiseplan == 119) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Monthly: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                              ...
                              <div class="middle-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="120" @if($advertiseplan == 120) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Quarterly: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                              ...
                              <div class="annually-price-section">
                                <input class="form-check-input" type="radio" name="memberplan" value="124" @if($advertiseplan == 124) checked @endif>
                                <input class="form-check-input" type="radio" name="memberplan" value="121" @if($advertiseplan == 121) checked @endif>
                                <label class="form-check-label
                                  label-main-monthly" for="exampleRadios1">Annually: &nbsp;
                                </label>
                                <div class="pricing-section-main-strike">
                          ...
                          <tr class="under-section-subsection below-section-main bg-shw-dark">
                            ...
                            <td>-</td>
                            <td>
                              <img src="{{url('newhomepage/assets/img/tick.svg')}}" alt="tick">
                            </td>
                            <td>
                              <img src="{{url('newhomepage/assets/img/tick.svg')}}" alt="tick">
                            </td>
                    ...
                    <div class="row setpad">
                      ...
                      <div class="row colbg">
                        <center>
                          <input type="submit" id="franchisorsubmit" class=" btn-mainfrm" value="Submit"/>
                        </center>
                      </div>
                    </div>
                  </form>
                      ...
                      <div class="swiper-slide">
                        <div class="card card-pricing">
                          ...
                          <div class="pricing-mob-form-section">
                            <div class="starting-price-section">
                              <input class="form-check-input" type="radio" name="memberplan" value="1" @if($advertiseplan == 1) checked @endif>
                              <label class="form-check-label
                                label-main-monthly" for="exampleRadios1">Monthly: &nbsp; </label>
                              <div class="pricing-section-main-strike"> <span class="offerd-price">
                                ₹ 9999
                                </span> 
                              </div>
                            </div>
                        ...
                        <div class="card card-pricing">
                          ...
                          <div class="pricing-mob-form-section">
                            ...
                            <div class="middle-price-section">
                              <input class="form-check-input" type="radio" name="memberplan" value="114" @if($advertiseplan == 114) checked @endif>
                              <label class="form-check-label
                                label-main-monthly" for="exampleRadios1">Quarterly: &nbsp; </label>
                              <div class="pricing-section-main-strike"> <span class="offerd-price">
                                ₹ 24999
                            ...
                            <div class="annually-price-section">
                              ...
                              <input class="form-check-input" type="radio" name="memberplan" value="115" @if($advertiseplan == 115) checked @endif>
                              <label class="form-check-label
                                label-main-monthly" for="exampleRadios1">Annually: &nbsp; </label>
                              <div class="pricing-section-main-strike"> <span class="offerd-price">
                                ₹ 89988
                                </span> <span class="strike-through">
                                <span class="strike-text">
                            ...
                            <div class="section-primary-btn">
                              <button class="btn btn-p-pricing
                                btn-main-pricing"> Buy Now </button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="card card-pricing">
                          ...
                          <div class="pricing-mob-form-section">
                            ...
                            <div class="section-primary-btn">
                              <button class="btn btn-p-pricing
                                btn-outline-main"> Buy Now </button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <table class="main-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="image-tick"> <img src="{{url('newhomepage/assets/img/tick.svg')}}" alt="tick"> </div>
                            </td>
                            <td>
                              <div class="image-tick"> <img src="{{url('newhomepage/assets/img/tick.svg')}}" alt="tick"> </div>
                            </td>
    ...
    <noscript>
      <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1055876857756260&ev=PageView&noscript=1" />
    </noscript>
