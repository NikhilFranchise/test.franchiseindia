...
@section('content')
    <style type="text/css">.posabsoblock .posabso{z-index:2}.formbannerhead{margin-top:20px;margin-bottom:40px}.formsection.internat .eds .form-control{height:49px}.formbg{background:#f3f3f3 url('https://www.franchise.ae/images/formheader.jpg') no-repeat;-webkit-transition:all .4s ease;transition:all .4s ease;height:189px;background-position:center center;text-align:center}.tbft{text-align:center;font-family:"Open Sans Regular";font-size:26px;padding-top:30px;color:#000}.tbft span{font-family:'Open Sans Light';font-size:52px;line-height:50px}.hth{font-size:36px;font-family:"Open Sans Regular";text-transform:uppercase}.hth strong{font-family:'Open Sans ExtraBold';color:#89a908;text-decoration:underline}@media only screen and (min-width:1px) and (max-width:767px){.tbft{padding-top:0;font-size:20px}.tbft span{font-size:40px;line-height:50px}.hth{font-size:25px}.formbg{background:0;padding-bottom:0;padding-top:0;margin-bottom:0;height:auto}.formbannerhead{margin-bottom:20px;margin-top:20px}.formsection.internat .eds .form-control{height:47px}.formsection.internat .eds2 .form-control{padding:14px 12px 14px}}@media only screen and (min-width:768px) and (max-width:1023px){.formsection.internat .eds{width:113px}.formsection.internat .eds2{width:55.8%}}</style>
    ...
    <div class="container formsection internat">
        <div class="row margt0">
            <div class="col-xs-12 col-sm-9 bor-radius backwhite targleft row-no-padding">
                <form class="form-horizontal" id="franchisorRegform" name="form_franchisor" action="{{Config::get('constants.MainDomain')}}/franchisor/franchisor_registration?is_international=1" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="setup-content">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pad30 showbg">
                            ...
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Email Id (User Id)</label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/user.png')}}" alt="User Email"></span>
                                        <input name="email" type="text" maxlength="40" class="form-control" placeholder="Enter Your User ID" autocomplete="off">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/pwd.png')}}" alt="Password"></span>
                                        <input name="password" id="pwd1" type="password" class="form-control" placeholder="Enter Your Password" autocomplete="off">
                                        <div style="text-align: center;">
                                            <span onClick="toggle_password('pwd1')" id="showpwd1" maxlength="15" class="showhidecng">Show</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row row-no-margin">
                                        <div class="col-xs-3 col-sm-3 col-md-3 row-no-padding eds">
                                            <div class="input-group">
                                                ...
                                                <select name="country_code" class="form-control myselectclass3" id="country_code">
                                                    @php
                                                        $codes = Config('location.CountryCodes');
                                                        $codes = collect(array_unique($codes))->sort();
                                                    @endphp
                                                    @foreach( $codes as $countryCode )
                                                        <option value="{{$countryCode}}" @if( $countryCode==91) selected @endif>+ {{$countryCode}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xs-3 col-sm-9 col-md-9 row-no-padding eds2">
                                            <input name="mobile_int" id="mobile" onkeypress="return isNumber(event)" type="text" pattern="[0-9]{8,15}" class="form-control" maxlength="15" placeholder="Enter Mobile" minlength="8" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/brandnew.png')}}" alt="Brand Name"></span>
                                        <input name="brand_name" type="text" class="form-control" placeholder="Enter Your Brand Name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/company.png')}}" alt="Company Name"></span>
                                        <input name="company_name" id="company_name" type="text" maxlength="55" class="form-control" placeholder="Enter Company Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img alt="form-field" src="https://www.franchiseindia.com/images/companyceo.png"></span>
                                        <input type="text" class="form-control valid" name="ceo_name" placeholder="Enter CEO / Owner Name" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img alt="form-field" src="https://www.franchiseindia.com/images/email.png"></span>
                                        <input name="ceo_email" type="text" class="form-control" placeholder="Enter Email" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img alt="form-field" src="https://www.franchiseindia.com/images/mobile.png"></span>
                                        <input name="ceo_mobile" onkeypress="return isNumber(event)" type="text" class="form-control" maxlength="15" placeholder="Enter Mobile" value="">
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Manager (Franchise) Name</label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/user.png')}}"></span>
                                        <input type="text" class="form-control" name="fran_manager" id="fran_manager" placeholder="Enter Manager Name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/addreess.png')}}" alt="Address"></span>
                                        <input type="text" class="form-control" name="fran_address" id="fran_address" placeholder="Enter Your Address">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="pincode_int" maxlength="10" placeholder="Enter Pincode" onkeypress="return isNumber(event)">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="state_int" placeholder="Enter State">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/companywebsite.png')}}" alt="Company Website"></span>
                                        <input type="text" class="form-control" name="website" id="website" maxlength="35" placeholder="Enter Company Website">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row ProLooking">
                                        <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding">
                                            <label class="col-xs-6 col-sm-6 col-md-3 mdyreswidth"><input type="radio" name="looking_franchise" value="1" checked> Franchisee </label>
                                            <label class="col-xs-6 col-sm-6 col-md-4"><input type="radio" name="looking_franchise" value="0">Trade partners</label>
                                            <label class="col-xs-6 col-sm-6 col-md-4"><input type="radio" name="looking_franchise" value="2">Dealer/Distributor</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group lookingFranchisePartnerInput" style="">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row checkmargin">
                                        <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding" id="lookingFranchisePartnerInput">
                                            <label class="col-xs-6 col-sm-6 col-md-6"><input type="checkbox" name="franchise_partner_type[]" id="franchise_partner_type" value="lookingFrUnit" />Unit</label>
                                            <label class="col-xs-6 col-sm-6 col-md-6"><input type="checkbox" name="franchise_partner_type[]" id="franchise_partner_type1" value="lookingFrUnitMultiUnits"/>Master / Multi Units</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4 paddright0">
                                            <div class="input-group">
                                                ...
                                                <input name="unitinv_brand_fee" type="text" pattern="[0-9]{1,10}" minlength="1" maxlength="8" class="form-control" placeholder="Franchise / Brand Fee" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <div class="input-group">
                                                <span class="input-group-addon"><img src="{{url('images/commission.png')}}"></span>
                                                <input name="unitinv_royalty" type="text" pattern="[0-9]{1,2}" minlength="1" maxlength="2" class="form-control" placeholder="Royalty / Commission %" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row marginbottom10">
                                    <div class="bdr-tp-bt-col">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="countrywise" class="multiUnitCheckBoxes" id="countrywise" value="CountryWise">Country Wise
                                            </div>
                                            <div class="disabled-area CountryWise">
                                                <fieldset disabled>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="country_unitfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" class="form-control" placeholder="Unit / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="country_masterfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" class="form-control" placeholder="Master / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/commission.png')}}"></span>
                                                            <input type="text" name="country_royalty" pattern="[0-9]{1,2}" minlength="1" maxlength="2" class="form-control" placeholder="Royalty / Commission %" value="" />
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="regionwise" class="multiUnitCheckBoxes" id="regionwise" value="RegionWise"> Region wise
                                            </div>
                                            <div class="disabled-area RegionWise">
                                                <fieldset disabled>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="region_unitfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="region_unitfee" class="form-control" placeholder="Unit / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="region_masterfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="region_masterfee" class="form-control" placeholder="Master / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/commission.png')}}"></span>
                                                            <input type="text" name="region_royalty" pattern="[0-9]{1,2}" minlength="1" maxlength="2" id="region_royalty" class="form-control" placeholder="Royalty / Commission %" value="" />
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="statewise" class="multiUnitCheckBoxes" id="statewise" value="StateWise"> State wise
                                            </div>
                                            <div class="disabled-area StateWise">
                                                <fieldset disabled>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="state_unitfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="state_unitfee" class="form-control" placeholder="Unit / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="state_masterfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="state_masterfee" class="form-control" placeholder="Master / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/commission.png')}}"></span>
                                                            <input type="text" name="state_royalty" pattern="[0-9]{1,2}" minlength="1" maxlength="2" id="state_royalty" class="form-control" placeholder="Royalty / Commission %" value="" />
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="citywise" class="multiUnitCheckBoxes" id="citywise" value="CityWise"> City wise
                                            </div>
                                            <div class="disabled-area CityWise">
                                                <fieldset disabled>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="city_unitfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="city_unitfee" class="form-control" placeholder="Unit / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/brand.png')}}"></span>
                                                            <input type="text" name="city_masterfee" pattern="[0-9]{1,10}" minlength="1" maxlength="8" id="city_masterfee" class="form-control" placeholder="Master / Brand Fee" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><img src="{{url('images/commission.png')}}"></span>
                                                            <input type="text" name="city_royalty" pattern="[0-9]{1,2}" minlength="1" maxlength="2" id="city_royalty" class="form-control" placeholder="Royalty / Commission %" value="" />
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                            ...
                            <div class="hidden-area tradePartnersInputs bdr-tp-bt-rmgroup" id="trade-partner-blocks" style="display:none">
                            ...
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Operations Commenced On
                                </label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/year.png')}}" alt="Operations Year"></span>
                            ...
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory" id="commencedFranText">Franchising Commenced On</label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/year2.png')}}" alt="Franchising Year"></span>
                            ...
                            <div class="form-group multipleinputsetheight50">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Space Requirements</label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row row-no-margin">
                                        <div class="col-xs-12 col-sm-6 row-no-padding width184 FlrAreaMin">
                                            <div class="input-group">
                                                <span class="input-group-addon"><img src="{{url('images/calendar.png')}}" alt="Space Requirements"></span>
                                                <input type="text" name="prop_area_min" onkeypress="return isNumber(event)" pattern="[0-9]{2,5}" minlength="2" maxlength="5" class="form-control" placeholder="Min" id="prop_area_min">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-3 row-no-padding wwidth148 FlrAreaMax">
                                            <input type="text" name="prop_area_max" onkeypress="return isNumber(event)" pattern="[0-9]{3,6}" minlength="3" maxlength="6" class="form-control" placeholder="Max">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/roi.png')}}" alt="Return of investment"></span>
                                        <input name="anticipated_roi" onkeypress="return isNumber(event)" type="text" pattern="[0-9]{1,4}" maxlength="4" class="form-control" placeholder="enter  %">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group multipleinputsetheight50">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row row-no-margin">
                                        <div class="col-xs-12 col-sm-6 row-no-padding width184 FlrAreaMin">
                                            <div class="input-group">
                                                <span class="input-group-addon"><img src="{{url('images/range-rate.png')}}" alt="Investment Range"></span>
                                                <input type="text" onkeypress="return isNumber(event)" name="unit_investment_min" minlength="2" maxlength="7" class="form-control" placeholder="Min" id="unit_investment_min">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-3 row-no-padding wwidth148 FlrAreaMax">
                                            <input type="text" onkeypress="return isNumber(event)" name="unit_investment_max" minlength="3" maxlength="8" class="form-control" placeholder="Max">
                                        </div>
                                        <div class="col-xs-12 col-sm-3 row-no-padding wwidth148 FlrAreaSqFt">
                            ...
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label line2padcheckbox mandatory">Support provided to franchise</label>
                                <div class="col-sm-1 com1mod padcheck hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding">
                                            <label class="col-xs-6 col-sm-6 col-md-3"><input type="radio" name="Support_provided" value="1" checked="checked"> Yes</label>
                                            <label class="col-xs-6 col-sm-6 col-md-3"><input type="radio" name="Support_provided" value="0"> No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Where are you looking for expansion?</label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    ...
                                    <div style="display:none;color:red" id="locaitonError">Please select atleat one location</div>
                                </div>
                            </div>
                        @php
                        ...
                        <!-- State & city Start here -->
                            <!--State section Start-->
                            <div class="row hidden-area stateWiseInput bdr-tp-bt-rmgroup" id="dead"  style="display:block">
                                <div  class="col-xs-12 col-sm-4 col-md-4">
                                    <ul id="divNorthState" class="natio">
                                        ...
                                        @foreach($northStates as $index => $value)
                                            <li><input  value='{{ $value }}' name="state[]" type="checkbox" > <span>{{ $value }}</span></li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input type="file" name="company_logo" class="form-control" placeholder="Upload your Company Logo" >
                                    </div>
                                </div>
                            </div>
                            <!--State section End-->
    ...
    <script language="javascript">
        ...
        $.validator.setDefaults({ ignore: '.hiddenMarkettingMaterials' });
        ...
        $("#franchisorRegform").validate({
                ...
                rules: {
                    ...
                    company_name: { required: true, minlength: 1, maxlength: 55 },
                    mobile_int: { required: true, number: true, minlength: 8, maxlength: 15 },
                    website: { required: true, minlength: 3, maxlength: 255 },
                    ceo_name: { required: true, minlength: 3, maxlength: 35 },
                    fran_manager: { required: true, minlength: 3, maxlength: 35 },
                    ...
                    ceo_mobile: { required: true, number:true, minlength: 8, maxlength: 15  },
                    state_int: { required: true },
                    city: { required: true, lettersonly: true },
                    telephone: { number: true },
                    pincode_int: { required: true, minlength: 4, maxlength: 8, number: true },
                    ...
                    "state[]": { required: true },
                    prop_area_min: { required: true,  minlength: 2, maxlength: 6 },
                    city_investment:{ required: true},
                    city_unitfee:{ required: true,  minlength: 1, maxlength: 8 },
                    city_masterfee:{ required: true,  minlength: 1, maxlength: 8 },
                    city_royalty:{ required: true,  minlength: 1, maxlength: 2 },
                    state_investment:{ required: true},
                    state_unitfee:{ required: true,  minlength: 1, maxlength: 8 },
                    state_masterfee:{ required: true,  minlength: 1, maxlength: 8 },
                    state_royalty:{ required: true,  minlength: 1, maxlength: 2 },
                    country_investment:{ required: true},
                    country_unitfee:{ required: true,  minlength: 1, maxlength: 8 },
                    country_masterfee:{ required: true,  minlength: 1, maxlength: 8 },
                    country_royalty:{ required: true,  minlength: 1, maxlength: 2 },
                    region_investment:{ required: true},
                    region_unitfee:{ required: true,  minlength: 1, maxlength: 8 },
                    region_masterfee:{ required: true,  minlength: 1, maxlength: 8 },
                    region_royalty:{ required: true,  minlength: 1, maxlength: 2 },
                    prop_area_max: { required: true, minlength: 3, maxlength: 8, greaterThanId: "#prop_area_min" },
                    unit_investment_min: { required: true,  minlength: 2, maxlength: 8 },
                    unit_investment_max: { required: true, minlength: 3, maxlength: 10, greaterThanId: "#unit_investment_min" },
                    company_logo: {required: true, acceptedFileTypes: "jpg,png,jpeg,gif", fileSize: 2 * 1024 * 1024}
                },
                messages: {
                    company_name: {
        ...
        $('#more').on('click', function () {
            var newfield = '<div class="row posrel"><hr size="5"><div class="col-xs-12 col-sm-4 paddleft30"><div class="form-group margintb15">Types of Channels</div><div class="form-group"><div class="input-group"><span class="input-group-addon"><img alt="channels" src="https://www.franchiseindia.com/images/channels.png"></span><select name="channel_type[]" class="form-control myselectclass"></select></div></div></div><div class="col-xs-12 col-sm-4 padd-lft-rht"><div class="form-group margintb15">Investment (If any)</div><div class="form-group"><div class="input-group"><span class="input-group-addon"><img alt="rate" src="https://www.franchiseindia.com/images/range-rate.png"></span><select name="trade_investment[]" class="form-control myselectclass">' +
                    @foreach(Config("constants.investRangeInWords") as $index => $value)'<option value="{{$index}}">{{ $value }}</option>' + @endforeach
