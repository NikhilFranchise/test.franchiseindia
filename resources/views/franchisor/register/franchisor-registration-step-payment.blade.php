...
<!--  -->
                    ...
                    <div class="priclist">
                        <div class="priclistinner">
                            ...
                            <form class="form-horizontal" id="fran-form" name="form_franchisor" action="{{ url('franchisor/registration/step/6')}}" method="POST" role="form" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <input type="hidden" name="franchisorId" value="{{ $franchisorId }}">
                                <div class="ftyblk">
                                    <div class="rinr cent"><i class="fas fa-rupee-sign"></i>
                                        <span class="pf1">0</span><span class="pf2">/mo</span></div>
                                </div>
                                <input type="radio" name="memberplan" value="1" checked style="display: none;">
                        ...
                        <div class="priclistinner" style="display:none;">
                            ...
                            <form class="form-horizontal" id="fran-form" name="form_franchisor" action="{{ url('franchisor/registration/step/6')}}" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="ftyblk">
                                    ...
                                    <div class="rinr otherp">
                                        <div class="radio-item">
                                            <input type="radio" id="ritema10" name="memberplan" id="price2" value="122" >
                                            <label for="ritema10"></label>
                                        </div>
                                        <i class="fas fa-rupee-sign"></i>
                        ...
                        <div class="priclistinner">
                            ...
                            <form class="form-horizontal"  name="form_franchisor" action="{{ url('franchisor/registration/step/6')}}" method="POST" role="form" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <input type="hidden" name="franchisorId" value="{{ $franchisorId }}">
                                <div class="ftyblk">
                                    ...
                                    <div class="rinr otherp">
                                        ...
                                        <i class="fas fa-rupee-sign"></i>
                                        <span class="pf1">1,43,000</span><span class="pf2"> <!--<del class="dll">1,95,000</del>-->/Half</span>
                                    </div>
                                    <div class="rinr otherp">
                                        <div class="radio-item">
                                            <input type="radio" id="ritema3" name="memberplan"  value="118" checked>
                                            <label for="ritema3"></label>
                                        </div>
                                        <i class="fas fa-rupee-sign"></i>
                                        <span class="pf1">1,62,500</span><span class="pf2"> <!--<del class="dll">3,90,000</del>-->/Yr</span>
                                    </div>
                                </div>
                        ...
                        <div class="priclistinner">
                            ...
                            <form class="form-horizontal" name="form_franchisor" action="{{ url('franchisor/registration/step/6')}}" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="ftyblk">
                                    ...
                                    <div class="rinr otherp">
                                        <div class="radio-item">
                                            <input type="radio" id="ritema51" name="memberplan" value="124" >
                                            <label for="ritema51"></label>
                                        </div>
                                        <i class="fas fa-rupee-sign"></i>
                                        <span class="pf1">2,27,500</span><span class="pf2"> <!--<del class="dll">
					2,39,994</del>-->/Half</span>
                                    </div>
                                    <div class="rinr otherp">
                                        <div class="radio-item">
                                            <input type="radio" id="ritema6" name="memberplan"  value="121" checked>
                                            <label for="ritema6"></label>
                                        </div>
                                        <i class="fas fa-rupee-sign"></i>
                                        <span class="pf1">2,92,500</span><span class="pf2"> <!--<del class="dll">5,27,988</del>-->/Yr</span>
                                    </div>
                                </div>
                                <input class="btncir" type="submit" value="Buy Now">
                            </form>
                            <ul class="listp">
                                <li>Get Priority over other business listings under -  <strong>Master and Sub Category</strong></li>
                    ...
                    <div class="feblk_body">
                        ...
                        <ul class="priceplan">
                            ...
                            <li>
                                ...
                                <div class="iconblk htset"><div class="pvalue"><i class="fas fa-check"></i></div></div>
                                <div class="iconblk htset"><div class="pvalue"><i class="fas fa-check"></i></div></div>
                                <div class="iconblk htset"> <div class="pvalue">70%</div></div>
                            </li>
            ...
            <div class="container">
                ...
                <div class="priclist">
					...
					1,31,997</del> --> /Qrt</span>
                                ...
                                <div class="rinr otherp">
                                    <div class="radio-item">
                                        <input type="radio" id="ritema51" name="memberplan" id="price2" value="124" >
                                        <label for="ritema51"></label>
                                    </div>
                                    <i class="fas fa-rupee-sign"></i>
                                    <span class="pf1">2,27,500</span><span class="pf2"> <!-- <del class="dll">
					2,63,994</del> --> /Half</span>
                                </div>
                                <div class="rinr otherp">
                                    <div class="radio-item">
                                        <input type="radio" id="ritema6" name="memberplan"  value="121" checked>
