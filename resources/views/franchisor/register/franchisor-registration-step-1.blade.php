...
.footrtwhatsapp-icon { display: none; }
.margintop60.staicp.topsetv { margin-top: 150px; }
@media only screen and (min-width: 1px) and (max-width: 767px) {
    .margintop60.staicp.topsetv { margin-top:110px ; }
}
</style>
            ...
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="col-xs-2 stepwizard-step">
                        ...
                        <span class="disnone"><i class="fa fa-pencil-square fa-lg" aria-hidden="true" title="Training/Agreements"></i></span>
                        <a href="#" class="btn btn-default btn-circle overfla"></a>
                    </div>
                    <div class="col-xs-2 stepwizard-step">
    ...
    <div class="container formsection">
        <div class="row margt0">
            ...
            <div class="col-xs-12 col-sm-9 bor-radius backwhite targleft row-no-padding">
                <!---->
                <form class="form-horizontal" id="fran-form" name="form_franchisor" action="{{ url('franchisor/registration/step/2')}}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <!-- displaying exception errors -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pad30 showbg">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="email" id="emailfran" type="text" class="form-control" placeholder="Enter Your User ID">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="mobile" id="mobile" type="text" pattern="[0-9]{10,10}" class="form-control" maxlength="10" placeholder="Enter Mobile" minlength="10">
                                        <div style="text-align: center;"><span onClick="validatemobile();" id="validatemobile" class="showhidecng" style="display: none">Verify</span></div>
                                        <div style="text-align: center;"><span onClick="editmobile();" id="editmobile" class="showhidecng" style="display: none">Edit</span></div>
                                        <div style="text-align: center;"><span id="successmobile" class="showhideright" style="display: none"><i class="fa fa-check fa-lg" aria-hidden="true"></i></span></div>
                                    </div>
                            ...
                            <div class="form-group" style="display: none;" id="otpblock">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{url('images/mobile.png')}}" alt="user otp"></span>
                                        <input id="otp" type="text" class="form-control" maxlength="4" placeholder="Enter OTP" onkeyup="varifyOtp(this.value);">
                                        <div style="text-align: center;"><span id="verify_button" class="showhidecng" style="display: none" onclick="verify()">Verify</span></div>
                                    </div>
    ...
    <script language="javascript">
        $(document).ready(function () {
            ...
            $("#mobile").on('change keyup', function () {
                ...
                if (email.val() !== 'fiblbrands@franchiseindia.in' && email.val() !== 'info@franglobal.com' && email.val() !== 'info@opportunityindia.com' && value != 9818029389 && value != 8588819019) {
                        ...
                        if (value.length === 10) {
                            if ($.isNumeric(value)) {
                                $.ajax({
                                    ...
                                    data: {mobile: value, email:email.val()},
                                    success: function (data) {
                                        if (data.check === 0) {
