    ...
    <div class="container formsection">
        <div class="row margt0">
            <div class="col-xs-12 col-sm-9 bor-radius backwhite targleft row-no-padding">
                <form class="form-horizontal" id="fran-form" name="form_franchisor" action="{{ url('franchisor/registration/step/3')}}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="setup-content BusDtl" id="step-2">
                        <div class="col-xs-12 col-sm-12 col-md-12 pad30 showbg">
                            ...
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Brand Name </label>
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="brand_name" id="brand_name" type="text" maxlength="55" class="form-control" placeholder="Enter Brand Name" value="{{$franData->brand_name}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="ceo_mobile" onkeypress="return isNumber(event)" type="text" class="form-control" maxlength="10" placeholder="Enter Mobile" value="{{$franData->ceo_mobile }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="pincode" id="pincode" maxlength="6" onkeyup="getPinCodeDetails(this.value)" placeholder="Enter Pincode" value="{{$franData->pincode}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group lookingFranchisePartnerInput" style="{{$displayFranchiseopt}}">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="row checkmargin">
                                        <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding">
                                            <label class="col-xs-6 col-sm-6 col-md-6"><input type="checkbox" id="franchise_partner_type" value="lookingFrUnit" name="franchise_partner_type[]" {{ $unit }} />Unit</label>
                                            <label class="col-xs-6 col-sm-6 col-md-6"><input type="checkbox" id="franchise_partner_type1" value="lookingFrUnitMultiUnits" name="franchise_partner_type[]" {{ $multiUnit }} />Master / Multi Units</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row marginbottom10">
                                    <div class="bdr-tp-bt-col">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="countrywise" class="multiUnitCheckBoxes" id="countrywise" title="CountryWise" value="CountryWise" {{ $countryWise }}>Country Wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="regionwise" class="multiUnitCheckBoxes" id="regionwise" title="regionwise" value="RegionWise" {{$regionwise}}> Region wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="statewise" class="multiUnitCheckBoxes" id="statewise" title="statewise" value="StateWise" {{$stateWise}}> State wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="citywise" class="multiUnitCheckBoxes" id="citywise" title="citywise" value="CityWise" {{ $cityWise }}> City wise
                                            </div>
                            ...
                            <div class="form-group">
                                <label for="no_fran_outlets" class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory" id="outletCountText">No of @if( $lookingTradePartner == "checked" || $lookingDealerDistributor == "checked") Dealerships @else Franchise Outlets @endif </label>
                                <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#fran-form").validate({
                ...
                rules: {
                    brand_name: {required: true, minlength: 5, maxlength: 55, brandExist: true},
