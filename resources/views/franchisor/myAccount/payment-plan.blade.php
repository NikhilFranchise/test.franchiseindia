                           ...
                           @csrf
                            <div class="col-xs-12 col-sm-12 col-md-12 pad30 showbg">
                                ...
                                <div class="pricesection fraprice">
                                    <!--2 Silver Plan start -->
                                    <div class="col-xs-12 col-sm-3 col-md-3 bor-radius row-no-padding boxheight boxwidth" style="display:none;">
                                        <label class="pad15b5"><input type="radio"  @if(Auth::user()->membership_type != 1) checked @endif  name="membership_plan" id="silverplanmain" value="2" @if(Auth::user()->membership_type == 1)@if(isset($franData)) @if( $franData->membership_plan == 2) checked @endif @endif @endif> Sub-Sub Category</label>
                                        <div class="priceshow"><span>Rs. <strong id="silverPlan">9999</strong></span>
                                            ...
                                            <div class="">
                                                <select name="membership_plan_month" id="membership_plan_month_sub_sub"
                                                        onclick="getPlanTotal(this.id);" onchange="getPlanTotal(this.id);" class="form-control width110">
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-3 bor-radius row-no-padding boxheight boxwidth">
                                        <label class="pad15b5"><input type="radio" name="membership_plan" id="goldplanmain" value="3" @if(Auth::user()->membership_type == 1) @if(isset($franData)) @if($franData->membership_plan == 3) checked @endif @endif @endif> Sub Category</label>
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-3 bor-radius row-no-padding boxheight boxwidth">
                                        <label class="pad15b5"><input type="radio" name="membership_plan" id="platinumplanmain" value="4" @if(Auth::user()->membership_type == 1) @if(isset($franData)) @if($franData->membership_plan == 4) checked @endif @endif @endif> Master Category</label>
                                    ...
                                    <input type="hidden" name="amount_to_pay" class="form-control" id="amount" value="123">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                        <div class="input-group">
                                            <span class="input-group-addon"><img alt="GST" src="{{url('images/commission.png')}}"></span>
