            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 marleft">
                    ...
                    <div class="bor-radius backwhite ovfl exyab">
                        @if (request()->user()->membership_type != 1 && !empty($regionFranData) &&
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                @if ($i < $ded) <tr class="extrl">
                                    ...
                                    $i++;
                                    @endphp
                                    @elseif($i >= $ded && $i <= $basic_count) <tr class="extrl">
                                        <td>
                                            <div class="fra-title">{{ $instaApply->name . '' . $instaApply->lname }}
                                            </div>
                                        </td>
                                        ...
                                        $i++;
                                        @endphp
                                        @elseif ($i <= $basic_count) <tr class="extrl">
                                            <td>
                                                <div class="fra-title">{{ $instaApply->name . '' . $instaApply->lname }}
                                                </div>
                                            </td>
