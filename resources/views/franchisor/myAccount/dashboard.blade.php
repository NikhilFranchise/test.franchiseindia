            ...
            <div class="col-xs-12 col-sm-10 col-md-10 formsection myaccright">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 marleft">
                        <div class="row newclassmar"><h2 class="mysubhead fleft">Insta Interest</h2> <div class="viewlink"><a href="{{ url('franchisor/myaccount/insta-response')}}"> View All <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 marleftmir">
                        <div class="row newclassmar"><h2 class="mysubhead fleft">Expressed Interest</h2> <div class="viewlink"><a href="{{ url('franchisor/myaccount/expressed-interest') }}"> View All <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div></div>
                        <div class="bor-radius backwhite ovfl exyab">
                            ...
                            <table class="table table-responsive">
                                ...
                                @foreach ($expressedInterests as $expData)
                                    ...
                                    @endphp
                                        <tr class="extrl">
                                            <td><div class="fra-title">{{ $name }}</div></td>
                                            <td><div class="fra-title">{{ $email }}</div></td>
                                            <td><div class="fra-title">{{ $mobile }}</div></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
