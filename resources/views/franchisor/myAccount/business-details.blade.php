            ...
            <div class="col-xs-12 col-sm-10 col-md-10 formsection myaccright BusDtl">
                ...
                <div class="bor-radius backwhite marleft">
                    <form class="form-horizontal" id="fran-form" name="form_franchisor"
                        action="{{ url('franchisor/myaccount/updatebusinessdetails') }}" method="POST" role="form"
                        ...
                        <div class="col-xs-12 pad30 showbg">
                            ...
                            @if ($franData->business_desc_update != '')
                                <div class="alert alert-info">Your business description changes has been submitted to the
                                    moderator. We will inform you through email once approved</div>
                            @endif
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="ceo_mobile" onkeypress="return isNumber(event)" type="text"
                                            class="form-control"
                                            maxlength=@if ($franData->is_international_client != 1) "10" @else "15" @endif
                                            placeholder="Enter Mobile" value="{{ $franData->ceo_mobile }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="pincode" id="pincode"
                                            @if ($franData->is_international_client != 1) maxlength="6" onkeyup="getPincodeDetails(this.value);" @endif
                            ...
                            @if (request()->segment(1) == 'campaign')
                                <div class="form-group">
                                    <label
                                        class="col-xs-12 col-sm-4 col-md-4 com4mod control-label mandatory">Email</label>
                                    <div class="col-sm-1 com1mod padtop20 hidden-xs">:</div>
                                    <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                        <div class="input-group">
                                            <span class="input-group-addon"><img alt="form-field"
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7 com7mod">
                                    <div class="input-group">
                                        ...
                                        <input name="mobile" id="mobile" type="text" class="form-control"
                                            maxlength=@if ($franData->is_international_client != 1) "10" @else "15" @endif
                                            placeholder="Enter Mobile" value="{{ request()->user()->mobile }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="row checkmargin">
                                        <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding">
                                            <label class="col-xs-6 col-sm-6 col-md-6">
                                                <input type="checkbox" id="franchise_partner_type" value="lookingFrUnit"
                                                    name="franchise_partner_type[]" {{ $unit }} />Unit
                                            </label>
                                            <label class="col-xs-6 col-sm-6 col-md-6">
                                                <input type="checkbox" id="franchise_partner_type1"
                                                    value="lookingFrUnitMultiUnits" name="franchise_partner_type[]"
                                                    {{ $multiUnit }} />Master / Multi Units
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="countrywise" class="multiUnitCheckBoxes"
                                                    id="countrywise" value="CountryWise" {{ $countryWise }}>Country Wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="regionwise" class="multiUnitCheckBoxes"
                                                    id="regionwise" value="RegionWise" {{ $regionwise }}> Region wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" name="statewise" class="multiUnitCheckBoxes"
                                                    id="statewise" value="StateWise" {{ $stateWise }}> State wise
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 paddleft-lft30">
                                            <div class="form-group">
                                                <input type="checkbox" name="citywise" class="multiUnitCheckBoxes"
                                                    id="citywise" value="CityWise" {{ $cityWise }}> City wise
                                            </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="ind_main_cat" id="ind_main_cat" class="form-control myselectclass"
                                            ...
                                            @foreach (Config('constants.CategoryArr') as $index => $value)
                                                <option value="{{ $index }}"
                                                    @if ($index == $franData->ind_main_cat) selected @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
