...
@include('includes.myfranchiseleft')
    ...
    <div class="col-xs-12 col-sm-10 col-md-10 formsection myaccright">
      ...
      <div class="bor-radius backwhite marleft">     
          <form class="form-horizontal formInv" name="form_investor" id="invchangepasswordform" action="updatepassword" method="POST" role="form">
              ...
              <div class="col-xs-12 pad30 showbg">
                  ...
                  <div class="form-group">
                    ...
                    <div  class="col-xs-12 col-sm-7 col-md-7 com7mod">
                      <div class="input-group">
                        <span class="input-group-addon"><img alt="password" src="{{URL::asset('images/pwd.png')}}"></span>
                        <input type="password" id="oldpassword" name="password" class="form-control"  placeholder="Enter Old Password">
                  ...
                  <div class="form-group">
                    ...
                    <div  class="col-xs-12 col-sm-7 col-md-7 com7mod">
                      <div class="input-group">
                        <span class="input-group-addon"><img alt="password" src="{{URL::asset('images/pwd.png')}}"></span>
                        <input type="password" name="password_again" class="form-control"  placeholder="Enter  Confirm  Password">
                      </div>
                    </div>
                  </div>
