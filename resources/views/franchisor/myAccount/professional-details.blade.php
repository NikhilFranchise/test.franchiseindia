...
<div class="container myaccount">
    ...
    <style type="text/css">
        .bdr-tp-bt-col  label.error { display: none!important; }
    </style>
    ...
    <div class="col-xs-12 col-sm-10 col-md-10 formsection myaccright ProDtl">
        ...
        <div class="bor-radius backwhite marleft">
            <form class="form-horizontal" id="fran-form" name="form_franchisor" action="updateprofessionaldetails" method="POST"  role="form" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="col-xs-12 pad30 showbg">
                        ...
                        <div class="form-group hidden-area AcrossIndiaInput" style="display:block;">
                            <label class="col-xs-12 col-sm-4 col-md-4 com4mod control-label padcheck mandatory">What type of franchisees are you considering across India ?</label>
                            <div class="col-sm-1 com1mod padcheck hidden-xs">:</div>
                            <div  class="col-xs-12 col-sm-7 col-md-7 com7mod">
