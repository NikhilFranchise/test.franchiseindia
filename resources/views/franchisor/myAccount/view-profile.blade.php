    ...
    <!-- Business Details  Start here -->
        ...
        <div class="bor-radius backwhite marleft">                           
            <div class="col-xs-12 pad15 showbg">       
                ...
                <div class="col-xs-12 col-sm-8 col-md-6">{{Config::get('constants.CategoryArr.'.$franData->ind_main_cat)  ?: '-N/A-'}}
                </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-8 col-md-6">{{Config::get('constants.subCategoryArr.'.$franData->ind_main_cat.'.'.$franData->ind_cat)  ?: '-N/A-'}}
                </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-8 col-md-6">{{Config::get('constants.subSubCategoryArr.'.$franData->ind_cat.'.'.$franData->ind_sub_cat)  ?: '-N/A-'}}
                </div>
                </div>
...
<!-- Personal  Start here -->
        <h2 class="mysubhead marleft fleft" >Professional Details</h2> <div class="editlink"><a href="professionaldetails"> Edit <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div>
        <div class="clearfix"></div>
        <div class="bor-radius backwhite marleft">                           
            <div class="col-xs-12 pad15 showbg">                  
                <div class="row row-no-margin labeshow">
                ...
                <div class="col-xs-12 col-sm-8 col-md-6 catmodf">Storewise
                        ...
                        <div class="exphead">Units</div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="pull-left">Cost</div><div class="pull-right">
                                            <strong>
                                                @php
                                                    $unitinv = Config::get('constants.investRangeInWords.'.$franData->unit_investment);
                                                    if(empty($unitinv))
                                                        $unitinv = "-N/A-"
                                                @endphp
                                                {{$unitinv}}
                ...
                <div class="row row-no-margin labeshow">
                <div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">What type of franchises are you considering?
                </div>
                <div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
                </div>
                ...
                <div class="bor-radius backwhite ovfl blmcats">
                 <div class="exphead">Master / Multi Units</div>
                   ...
                   <!--Region wise start here -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding"><strong>Country Wise</strong></div>  
                    <span class="myclr">
                    <div class="pull-left">Investment</div>                    
                    <div class="pull-right">
                        <strong>
                            @php
                                $countryInvest      = Config::get('constants.investRangeInWords.'.$franMultiUnitData->country_investment);
                  ...
                  <div class="pull-right"><strong>{{$countryUnitFee}}</strong></div> 
                    </span>
                     <span class="myclr">
                    ...
                    @endphp                
                    <div class="pull-right"><strong>{{$countryMasterFee}}</strong></div> </p>
                     <span class="myclr">
                    <div class="pull-left">Royalty/Commission</div>                    
                    <div class="pull-right"><strong>
                    @php
                        $countryRoyalityData      = $franMultiUnitData->country_royalty;
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding"><strong>Region Wise</strong></div>  
                       <span class="myclr">
                    <div class="pull-left">Investment</div>                    
                    <div class="pull-right"><strong>{{Config::get('constants.investRangeInWords.'.$franMultiUnitData->region_investment) ?: '-N/A-'}}</strong></div> 
                    </span>
                       <span class="myclr">
                    <div class="pull-left">Unit/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->region_unitfee ?: '-N/A-'}}</strong></div> 
                    </span>
                       <span class="myclr">
                    <div class="pull-left">Master/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->region_unitfee ?: '-N/A-'}}</strong></div> 
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 row-no-padding bright">
                    <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding"><strong>CIty Wise</strong></div> 
                       <span class="myclr"> 
                    <div class="pull-left">Investment</div>                    
                    <div class="pull-right"><strong>{{Config::get('constants.investRangeInWords.'.$franMultiUnitData->city_investment) ?: '-N/A-'}}</strong></div>
                    </span>
                       <span class="myclr"> 
                    <div class="pull-left">Unit/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->city_unitfee ?: '-N/A-'}}</strong></div> 
                    </span>
                       <span class="myclr">
                    <div class="pull-left">Master/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->city_unitfee ?: '-N/A-'}}</strong></div> 
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 row-no-padding padingleft20">
                    <div class="col-xs-12 col-sm-12 col-md-12 row-no-padding"><strong>State Wise</strong></div>  
                    <span class="myclr">
                    <div class="pull-left">Investment</div>                    
                    <div class="pull-right"><strong>{{Config::get('constants.investRangeInWords.'.$franMultiUnitData->state_investment) ?: '-N/A-'}}</strong></div> 
                    </span>
                    <span class="myclr">
                    <div class="pull-left">Unit/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->state_unitfee ?: '-N/A-'}}</strong></div> 
                    </span>
                    <span class="myclr">
                    <div class="pull-left">Master/Brand Fee</div>                    
                    <div class="pull-right"><strong>{{$franMultiUnitData->state_unitfee ?: '-N/A-'}}</strong></div> 
        ...
        <div class="row row-no-margin labeshow">
        <div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Are you looking for Trade Partners (Dealers,
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 catmodf margint5">
                ...
                <div class="bor-radius backwhite ovfl blmcats paddingt20">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="pull-left">Types of Channels</div><div class="pull-right"><strong>{{Config::get('constants.channelArr.'.$tradePartner[$i]->channel_type)}}</strong></div> 
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="pull-left">Investment If any</div><div class="pull-right"><strong>{{Config::get('constants.investRangeInWords.'.$tradePartner[$i]->trade_investment)}}</strong></div>                    
                            </div>
                             <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="pull-left">Margin / Commissions %</div><div class="pull-right"><strong>{{$tradePartner[$i]->trade_margin}}%</strong></div>                    
                            </div>
                             <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="pull-left">Area Requirement (If Any)</div><div class="pull-right"><strong>{{$tradePartner[$i]->area_min}}-{{$tradePartner[$i]->area_max}}&nbsp{{$tradePartner[$i]->area_type}}</strong></div>                    
                            </div>
                    </div>
                @endfor
        </div>
        ...
        @endif
        <div class="row row-no-margin labeshow">
        <div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Are you looking for International Franchisee?
        </div>
        <div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
        </div>
        <div class="col-xs-12 col-sm-8 col-md-6">
...
<h2 class="mysubhead marleft fleft">Franchise Details</h2> <div class="editlink"><a href="propertydetails"> Edit <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div>
<div class="clearfix"></div>
<div class="bor-radius backwhite marleft">                           
<div class="col-xs-12 pad15 showbg">                  
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Are there exclusive territorial rights given
to a unit franchise?
</div>
<div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
</div>
...
<div class="col-xs-12 col-sm-8 col-md-6">{{$franData->anticipated_roi ?: '-N/A-'}}@if(!empty($franData->anticipated_roi))%@endif
</div>
</div>
...
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Are there any other investment requirements?
</div>
<div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
</div>
...
<div class="col-xs-12 col-sm-8 col-md-6">{{$franData->premise_outfit_arrangement ?: '-N/A-'}}
</div>
</div>

<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Do you provide site selection assistance?
</div>
<div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
</div>
<div class="col-xs-12 col-sm-8 col-md-6">
...
<!-- Training Start here -->
<h2 class="mysubhead marleft fleft" >Training Details</h2> <div class="editlink"><a href="training-aggrement-details"> Edit <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div>
<div class="clearfix"></div>
<div class="bor-radius backwhite marleft">                           
<div class="col-xs-12 pad15 showbg">                  
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Do you currently have detailed operating manuals for franchises?
</div>
<div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
</div>
<div class="col-xs-12 col-sm-8 col-md-6">
...
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Is field assistance available for franchises?
</div>
<div class="col-xs-12 col-sm-1 col-md-1 row-no-padding hidecolon">:
</div>
<div class="col-xs-12 col-sm-8 col-md-6">
...
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">What IT systems do you presently have that will be
...
<h2 class="mysubhead marleft fleft" >Agreements  Details</h2> <div class="editlink"><a href="training-aggrement-details"> Edit <i class="fa fa-angle-right" aria-hidden="true"></i> <span></span></a></div>
<div class="clearfix"></div>
<div class="bor-radius backwhite marleft">                           
<div class="col-xs-12 pad15 showbg">                  
<div class="row row-no-margin labeshow">
<div class="col-xs-12 col-sm-3 col-md-5 row-no-padding">Do you have a standard Franchise Agreement?
