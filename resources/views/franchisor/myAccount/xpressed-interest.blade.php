                                ...
                                <tbody>
                                    @foreach ($expressedInterests as $expData)
                                        @php
                                            ...
                                            $invAmt = $expData->investor
                                                ? Config('constants.investRangeInWords.' . $expData->investor->inv_amt)
                                                : null;
                                            ...
                                            if (
                                                ...
                                                $email = $expData->investor
                                                    ? $expData->investor->userDetail->email
                                                    : null;
                                                $mobile = $expData->investor
                                                    ? $expData->investor->userDetail->mobile
                                                    : null;
                                            }
                                        @endphp
                                        <tr class="extrl">
