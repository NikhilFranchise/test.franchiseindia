...
@section('content')
    <div class="maininnver homeh">
        <div class="inner-top-head">
            <div class="container">
                <h1>{{ $locale == 'en' ? 'Executive Interviews' : 'कार्यकारी साक्षात्कार' }}</h1>
            </div>
        </div>

        <x-breadcrumb :items="[
            ['label' => 'Home', 'url' => url('/crre')],
            ['label' => $locale == 'en' ? 'Executive Interviews' : 'कार्यकारी साक्षात्कार'],
        ]" />
        <div class="stories">
            <div class="container">
                <h3>{{ $locale == 'en' ? 'Executive Interviews' : 'कार्यकारी साक्षात्कार' }}</h3>
                <div class="row">
                    <div class="col-md-8">
