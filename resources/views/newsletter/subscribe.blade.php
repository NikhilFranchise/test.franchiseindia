    ...
    <div class="container mostpopu arttilist">
        ...
        @if($news == 'pending')
            <div class="thanksmsg"><br>
                <h2>Thanks</h2><br>
                Thank you for registering for our daily online newsletter.<br><br> Kindly check you email and verify the given mail for further
                process......
                <br><br>
            </div>
        @endif
        ...
        @if($news == 'subscribed')
            <div class="thanksmsg"><br>
                <h2>Thanks</h2><br>
                Thank you for registering for our daily online newsletter. You will be able to enjoy the fresh industry
                news from now on.
                <br><br>
                Keep Reading!!!
            </div>
        ...
        @if($news == 'thanks')
            <div class="thanksmsg"><br>
                ...
                <h2>Thanks</h2>
                Thank you for subscribing our daily online newsletter. Now you will recieve Daily / Monthly Newsletters as per your Subscription...
            </div>
        @endif
        ...
        @endif
        @if($news == 'alreadysubscribed')
            <div class="thanksmsg"><br>
                <h2>Thank You!</h2><br>
                You have already applied for the newsletter. Please enjoy the services.
                <br><br>
            </div>
        @endif
