...
<div class="maininnver homeh">
   ...
   <div class="container">
      ...
      <div id='Desktop_ROS_728x90_ATF' style='width: 728px; height: 90px;'>
         <script>
            googletag.cmd.push(function() {
                  googletag.display('Desktop_ROS_728x90_ATF');
            });
         </script>
       </div>
   </div>
...
<div class="contentwrapper">
   <div class="container">
      <ul class="breadcrumb">
         ...
         <li class="breadcrumb-item">
            <a href="{{ url('/insights') }}" class="tip-bottom">{{
               $newsDetails->insight_type }}</a>
         </li>
         @foreach ($newsDetails->category as $category)
         <li class="breadcrumb-item"><a href="{{ $baseUrl . $category->slug }}" class="tip-bottom">{{
               $category->catname }}</a></li>
         @endforeach

         @foreach ($newsDetails->Subcategory as $subcat)
         <li class="breadcrumb-item"><a href="{{ $baseUrl . $category->slug . '/' . $subcat->slug }}">{{
         ...
         <div class="col-md-8">
               ...
               <div class="article-features">
                  <div class="article-date">
                     <div class="article-logo">
                        <img src="{{ $authorImage }}" width="51" height="51" alt="Indian Retailer" loading="lazy"
                           class="">
                     </div>
                  ...
                  <div class="content-share">
                     <ul>
                        ...
                        <li>
                           <a target="_blank"
                              href="https://x.com/intent/post?url={{ $newsUrl }}">
            ...
            <div class="content-main">
               ...
               <div class="articlecontent">
                  ...
                  foreach ($custom_data as $cdata) {
                  $articleData[] = $cdata;
                  if ($counter == 1) { // Change the position based on your requirement
                  $articleData[] =
                  '<div class="inner-article-detail-desktop-ad">
                     <img src="' . url("insight-new/images/desk-ad.png") . '" class="img-fluid">
                              </div>' ; } if ($counter==2) { $articleData[]='
                                  <div id="v-franchiseindia"></div>
                                  <script>
                                      (function(v, d, o, ai) {
                                          ai = d.createElement("script");
                     ...
                     <div class="popular-articles">
                        ...
                        <ul>
                           ...
                           <li>
                              ...
                              $baseUrl1 = Config('constants.MainDomain') .
                              "/insights/$locale/".strtolower($trend->insight_type).'/';
       ...
       if (validateForm()) {
           ...
           doAjax(formData).then((data) => {
               if (data.error === false) {
                   ...
                   window.location.href = 'https://www.franchiseindia.com/insights/hi/thanks';
