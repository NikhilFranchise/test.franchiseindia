...
<div class="maininnver">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/insights') }}" class="tip-bottom">{{
                    $newsDetails->insight_type }}</a></li>
...
<div class="container">
    ...
    <a href="{{ $baseUrl . $category->slug . '/' . $subcat->slug }}" role="button" class="detailbtn">{{
        $subcat->subcat_name }}</a>
    @endif
...
<div class="contentarea">
    ...
    <div class="tag-block">
        <ul class="tag-list">
            ...
            @endphp
            <li><a href="{{ Config('constants.MainDomain') . '/insights/' . $locale . '/tag/' . $tagslug }}">{{
                    $assocTagsData->name }}</a>
            </li>
            @endforeach
            @endif
        </ul>
