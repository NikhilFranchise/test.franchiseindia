...
<div class="maininnver">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/insights') }}" class="tip-bottom">{{ $newsDetails->insight_type }}</a></li>

            @foreach ($newsDetails->category as $category)
                <li class="breadcrumb-item"><a href="{{ $baseUrl . $category->slug }}" class="tip-bottom">{{ $category->catname }}</a></li>
            @endforeach

            @foreach ($newsDetails->Subcategory as $subcat)
                <li class="breadcrumb-item"><a href="{{ $baseUrl . $category->slug . '/' . $subcat->slug }}">{{ $subcat->subcat_name }}</a></li>
            @endforeach
...
<div class="container">
    ...
    @if (!empty($subcat->subcat_name))
        <a href="{{ $baseUrl . $category->slug . '/' . $subcat->slug }}" role="button" class="detailbtn">{{ $subcat->subcat_name }}</a>
    @endif
