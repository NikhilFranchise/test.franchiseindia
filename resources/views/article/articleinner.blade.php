...
@php
    ...
    if (empty($seoDesc)) {
        $seoDesc = strip_tags(
            implode('. ', array_slice(explode('.', substr($articles['content'], 0, 250)), 0, 2)) . '.',
        );
    }
@endphp
...
@section('content')
    ...
    <style type="text/css">
        .articlesection ol.breadcrumb {
            margin-left: -5px;
        }

        @media only screen and (max-width:767px) and (min-width: 320px) {
            .articlesection .breadcrumb>li {
                line-height: 18px;
    ...
    <script type="text/javascript">
        ...
        addthis_share = {
            media: "{{ Config('constants.awsS3Url') . $articles->image }}",
            passthrough: {
                twitter: {
                    via: "FranchiseIndia"
                }
    ...
    <div class="container articlesection">
        ...
        <div class="row row-no-margin">
            <div class="artimainhead">
                <a
                    href="{{ Config('constants.MainDomain') }}/content/{{ $articles['urlKicker'] }}">{{ $articles->kicker }}</a>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="artiaut">
                    By <a href="#" rel="author" itemprop="author" itemscope itemtype="https://schema.org/Person">
                        {{ $articles->author ?: '' }}</a>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-6 pull-left">
                        <div class="addthis_sharing_toolbox"
                            data-media="{{ Config('constants.awsS3Url') . $articles->image }}"></div>
                    </div>
        ...
        <div class="row row-no-margin">
            <div class="col-xs-12 col-sm-9 col-md-9 row-no-padding resmodfidevice">
                <div class="abigima"><img itemprop="image" itemscope itemtype="https://schema.org/ImageObject"
                        src="{{ Config('constants.awsS3Url') . $articles->image }}" alt="{{ $articles['title'] }}"></div>
                <div class="clr"></div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 artinner articontent">
                        @php
                            ...
                            if (count($custom_data) == 1) {
                                $articleData[0] =
                                    $custom_data[0] . '<div id = "v-franchiseindia"></div><script>
                                        (function(v, d, o, ai) {
                                ...
                                foreach ($custom_data as $cdata) {
                                    if ($counter == 2) {
                                        $articleData[] =
                                            $cdata . '<div id = "v-franchiseindia"></div><script>
                                                (function(v, d, o, ai) {
                                                    ai = d.createElement("script");
                                                    ai.defer = true;
                                                    ai.async = true;
                        ...
                        <div class="sidemediablk" id="scrollmedia">
                            <ul class="sidemedia" style="display:none">
                                <li><a href="whatsapp://send?text={{ request()->url() }}"
                                        data-text="{{ $articles['title'] }}" data-action="share/whatsapp/share"><img
                                            class="lozad" data-src="{{ url('images/side-whatsapp.png') }}"
                                            alt="whatsapp" /></a></li>
                                <li><a
                                ...
                                <li><a class="twitter-share-button"
                                        ...
                                        target="_blank"><img class="lozad" data-src="{{ url('images/side-twitter.png') }}"
                                            alt="twiter" /></a></li>
                        ...
                        <div class="tag-block">
                            <ul class="tag-list">
                                @foreach ($seoVal as $value)
                                    <li> <a
                                            href="{{ Config('constants.MainDomain') }}/content/{{ $value['urlSlug'] }}">{{ $value['name'] }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                            ...
                            <div class="row rownewmar formsection commentsblk" id="commentplace">
                                ...
                                <div class="bor-radius backwhite ovfl margintb20 pad20">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><img class="lozad"
                                                            data-src="{{ url('images/user.png') }}"
                                                            alt="image"></span>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><img class="lozad"
                                                            data-src="{{ url('images/mobile.png') }}"
                                                            alt="mobile"></span>
                                                    <input type="text" class="form-control" id="commentmobile"
                                                        name="mobile" pattern="[789][0-9]{9}" minlength="10"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon height100">
                                                        <img class="lozad" data-src="{{ url('images/addreess.png') }}"
                                                            alt="address">
                                                    </span>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <img class="lozad"
                                                            data-src="https://www.franchiseindia.com/images/star.png"
                                                            alt="star franchise india"
                                                            src="https://www.franchiseindia.com/images/star.png"
                                                            data-loaded="true">
                                                    </span>
                                                    <select name="opt" id="opt"
                                                        class="form-control myselectclass pads sekcv">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10 widthfiz">
                                            <input type="submit" id="commentBoxbtn" class="btn btn-default cmbtn"
                                                value="Submit" />
                                        </div>
                                    </div>
                                </div>
                                @foreach ($comment as $comnt)
                                    ...
                                    <div class="bor-radius backwhite ovfl margintb20 pad20 commrply">
                                        <div class="maintxt"> {{ $comnt['comment_user'] }} : <span> {{ $date }}
                                                at {{ $time }} </span></div>
                        ...
                        <div class="text-center">
                            ...
                            @desktop
                                <div id='adslot970x90'>
                                    <script>
                                        googletag.cmd.push(function() {
                                            googletag.display('adslot970x90');
                                        });
                                    </script>
                                </div>
                            @enddesktop
                    ...
                    @foreach ($likeArticles as $article)
                        @if ($loop->index > 11 && $loop->index < 24)
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 mdywi">
                                <a href="{{ $url }}">
                                    @if (empty($article['image']))
                                        <div class="artibtmimg">
                                            <img class="lozad" alt="no image franchise india"
                                                data-src="{{ url('images/no-image1000.jpg') }}" />
                                        </div>
                                    @endif
                                    <div class="artibtmimg {{ $article['contentType'] == 'Interview' ? 'int' : '' }}">
                                        @if ($site == 'gallery')
                                            <div class="gallopt"><img class="lozad" alt="gallery icon franchise india"
                                                    data-src="{{ url('images/galleyicon.png') }}">
                                            </div>
                                        @endif
                                ...
                                <div class="artbtmsubhead"><a href="{{ $kicker }}">{{ $article['kicker'] }}</a>
                                </div>
            ...
            @tablet
                <div class="text-center">
                    <div id='adslot468x60_ACS'>
                        <script>
                            googletag.cmd.push(function() {
                                googletag.display('adslot468x60_ACS');
                            });
                        </script>
                    </div>
                </div>
                    ...
                    @if ($loop->index > 25 && $loop->index < 34)
                        <div class="col-xs-12 col-sm-3 col-md-3 mdywinew">
                            <div class="artifotbtmimg">
                                <a href="{{ $url }}">
                                    @if ($site == 'gallery')
                                        <div class="gallopt"><img class="lozad"
                                                data-src="{{ url('images/galleyicon.png') }}" alt="image"></div>
                                    @endif
