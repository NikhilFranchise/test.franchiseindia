    ...
    <div class="container articlesection">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                        <div class="addthis_sharing_toolbox"
                            data-media="{{ Config('constants.awsS3Url') . $article->image }}"></div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                        <div class="other-s-iconlayout">
                            <span class="commentlayout"><a href="#commentplace"><i class="fa fa-comment fa-lg"></i><span
                                        class="s-val-clayout">Comment</span></a></span>
                            <span class="email-blayout"><a href="mailto:editor@franchiseindia.com"><i
                                        class="fa fa-envelope fa-lg"></i></a></span>
                            <span class="print-blayout"><a href="#" onclick="window.print()"><i
                                        class="fa fa-print fa-lg"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row row-no-margin">
            <div class="col-xs-12 col-sm-9 col-md-9 row-no-padding resmodfidevice">
                @if ($article->image != '')
                    <div class="abigima"><img src="{{ Config('constants.awsS3Url') . $article->image }}"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 artinner articontent">
                        @php
                            ...
                            if (count($custom_data) == 1) {
                                ...
                                $articleData[1] = '<div id = "v-franchiseindia"></div><script>
                                    (function(v, d, o, ai) {
                                ...
                                foreach ($custom_data as $cdata) {
                                    if ($counter == 1) {
                                        $articleData[] = '<div id = "v-franchiseindia"></div><script>
                                            (function(v, d, o, ai) {
                                                ai = d.createElement("script");
                                                ai.defer = true;
                                                ai.async = true;
                                ...
                                <div class="bor-radius backwhite ovfl margintb20 pad20">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><img class="lozad"
                                                            data-src="{{ url('images/user.png') }}" alt="user"></span>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><img class="lozad"
                                                            data-src="{{ url('images/email.png') }}" alt="email"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon height100"><img class="lozad"
                                                            data-src="{{ url('images/addreess.png') }}"
                                                            alt="address"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><img class="lozad"
                                                            ...
                                                            data-loaded="true" alt="star"></span>
                ...
                @foreach ($likeArticles as $article)
                    @if ($loop->index > 8 && $loop->index < 11)
                        @php
                            ...
                            //$kicker = Config('constants.MainDomain').'/content/'.$article['urlKicker'];
                            $kicker =
                                'https://opportunityindia.franchiseindia.com/english/tag/' . $article['urlKicker'];
                            $image = Config('constants.awsS3Url') . $article['image'];
                            //$url = Config('constants.MainDomain').'/'.$site.'/'.$article['slug'].'.'.$article['content_id'];
                            $url =
                                'https://opportunityindia.franchiseindia.com/article/' .
                                $article['slug'] .
                                '-' .
                                $article['content_id'];
                            if ($article['site_type'] == 'ga') {
                                    ...
                                    <div class="text-rep-blk">
                                        <div class="a-name-red">
                                            <span><a target="_blank"
                                                    href="{{ $kicker }}">{{ $article['kicker'] }}</a></span>
                                        </div>
