...
@section('seoDesc',
    'Read our latest and popular collection of franchise articles includes new business ideas,franchise
    information and franchise opportunities')
@section('seoKeywords',
    'best franchise, franchising, new business ideas, buy franchise, franchise information, small
    franchise business, best franchise business company in India')
    @php
...
@section('content')
    ...
    <div class="container articlesection">
        ...
        <div class="sidearce @if ($loop->index == 0) firstmargin0 @endif">
            <div class="artsideimg">
                @if ($site == 'gallery')
                    <div class="gallopt"><img class="lozad" alt="gallery icon franchiseindia"
                            data-src="{{ url('images/galleyicon.png') }}"></div>
                @endif
                <a href="{{ $url }}">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 artimiddlepanel">
        ...
        @php
            ...
            $url =
                ...
                $homeArticle[4]['slug'] .
                '.' .
                $homeArticle[4]['content_id'];

            if ($homeArticle[4]['site_type'] == 'ga') {
                $kicker =
                    Config('constants.MainDomain') .
                    '/gallery/' .
                    Str::slug($homeArticle[4]['kicker']) .
                    '/' .
                    $homeArticle[4]['kicker_id'];
        ...
        <div class="mdeo">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 row-no-padding respaddingauto">
                                <div class="middlesubhead">
                                    ...
                                    @if ($site == 'gallery')
                                        <img class="lozad" data-src="{{ url('images/galleyicon2.png') }}"
                                            class="gallicon2" />
                                    @endif
                                </div>
            ...
            <div class="row marminleft bortop">
                <div class="mohead">
                    Most Commented
                    <!--<a href="{{ Config('constants.MainDomain') }}/commented" class="commanviewall">View All</a>-->
                </div>
    ...
    <div class="col-xs-12 col-sm-3 col-md-3 row-no-padding artirightpanel">
        ...
        <div class="artihaed">Popular Stories
            <!--<a href="{{ Config('constants.MainDomain') }}/popular" class="commanviewall">View All</a>-->
        </div>
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 paddingright50 responleft">
                            ...
                            @if ($loop->index > 3 && $loop->index < 13)
                                ...
                                <div class="smallatc">
                                    <div class="artbtmsubhead">
                                        <a href="{{ $kicker }}">{{ $article['kicker'] }}</a>
                                        @if ($site == 'gallery')
                                            <img class="gallicon2 lozad" data-src="{{ url('images/galleyicon2.png') }}"
                                                alt="gallico">
                                        @endif
                                    </div>
                                    <div class="artbtmtext">
                ...
                <div class="row  marbtm40">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="pull-right seeinsi"><a href="{{ Config('constants.MainDomain') }}/magazine">See All
                                Issues</a> ></div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 responmagleft">
                        <a
                            href="{{ Config('constants.MainDomain') }}/magazine/{{ $magazineCategory[0]['iss_year'] }}/{{ $monthName }}/The-Franchising-World-{{ $magazineCategory[0]['iss_year'] }}-{{ $magazineCategory[0]['category_id'] }}">
                            <img class="magimga lozad" alt="magazine franchise india"
                                data-src="{{ Config('constants.awsS3Url') . $magazineCategory[0]['image'] }}">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-8 responmagright">
                        ...
                        @foreach ($magazine as $mag)
                            <div class="witwr">
                                ...
                                <p class="amagtxt">
                                    <a
                                        href="{{ Config('constants.MainDomain') }}/magazine/{{ $magazineCategory[0]['iss_year'] }}/{{ $monthName }}/{{ $mag['urlTitle'] }}.{{ $mag['item_id'] }}">
                                        {{ $mag['title'] }}
                                    </a>
                                </p>
                                <p>
