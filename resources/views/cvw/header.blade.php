...
.login-pnl-error{display: block;font-size: 13px;margin: -10px 0px 5px 0px;}
#expandFranchisenew .modal-dialog, #login-pnl .modal-dialog {width: 416px;}
 #expandFranchisenew h2{
    ...
    #expandFranchisenew .radio{margin-top: 10px!important;margin-right: 20px;}
    #expandFranchisenew .frm-input{padding: 0px 15px;}
...
.btn-main,  .btn-main:focus,  .btn-main:hover  {
    color:  #fff;
}
...
.tab-content .tab-pane.active  {
    ...
    opacity:  1;
    -webkit-animation:  .8s forwards fadeUp;
    -moz-animation:  .8s forwards fadeUp;
    -o-animation:  .8s forwards fadeUp;
...
@media only screen and (min-width:993px) and (max-width:1199px)  {
    ...
    ul.top-navigation li{margin-right: 5px!important;}
    .policydropdown .btn{font-size:12px;}
    .business-a  {
    position:  relative;
    z-index:  2;
    margin-bottom:  15px;
...
ul.top-navigation li:nth-child(6)::after{display: none;}
.policydropdown .btn {
    background:  top;
    border:  none;
    padding:  0px;
...
.top-navigation .top-investors{display: none;}
.p-30  {
...
@import url(https://fonts.googleapis.com/css2?family=Roboto:wght@200..800&family=Roboto:ital, wght@0, 100;
    0, 300;
    0, 400;
    0, 500;
    0, 700;
...
.d-flex  {
    display:  flex }
ul.fihl-loaction-browse li:last-child::after,  ul.login-main-section li:last-child::after,  ul.top-navigation li:last-child::after  {
    content:  "" }
.header-btm  {
    padding-top:  20px;
    background:  #fff;
...
.border-bottom-1,  .google-search,  .language-main-bx,  .side-bar-social  {
    border-bottom:  1px solid #dfdfdf }
.google-search  {
    padding:  10px 2px;
...
ol.tree li input  {
    ...
    top:  0 }
ol.tree li input+ol  {
    background:  url(https://www.franchiseindia.com/images/redup.png?d=2) 40px 0 no-repeat;
...
.logo  {
    padding:  0;
    margin:  0 0 0 4px }
.login-text-right img,  .search img  {
    width:  22px;
    height:  24px }
.header-btm  {
    padding-top:  5px;
...
@media screen and (max-width:768px)  {
    ...
    <script defer="defer" src="https://www.franchiseindia.com/newhomepage/assets/vendor/fontawesome/js/solid.js"></script>
    <script defer="defer" src="https://www.franchiseindia.com/newhomepage/assets/vendor/fontawesome/js/fontawesome.js"></script>
</head>
