        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="hero-search" id="hero-search">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#categories1" aria-controls="categories1" role="tab"
                                    data-toggle="tab">Categories</a></li>
                            <li role="presentation"><a href="#location1" aria-controls="location1" role="tab" data-toggle="tab">Location</a>
                            </li>
                            <li role="presentation"><a href="#investment1" aria-controls="investment1" role="tab"
                                    data-toggle="tab">Investment</a></li>
                        </ul>
                        <div class="tab-content">
                            <div id="categories1" class="tab-pane fade in active" role="tabpanel" aria-labelledby="categories-tab">
                                <form class="form-horizontal" method="get" action="{{ url('category/searchby') }}"
                                    onsubmit="return submitCategory1()"><input type="hidden" name="catTab" value="1">
                                    <ul class="hero-search-main">
                                        <li class="p-0 m-0">
                <select name="mc" aria-label="Select Industry" class="form-control form-control-custom dropdown-toogle-icon"
                            ...
                            <div id="location1" class="tab-pane fade" role="tabpanel" aria-labelledby="location-tab">
                                <form class="form-horizontal" method="get" action="{{ url('category/searchby') }}"
                                    onsubmit="return submitLocation1()"><input type="hidden" name="locTab"
                                        value="1">
                                    <ul class="hero-search-main">
                        ...
                        <select aria-label="Select Industry" class="form-control form-control-custom dropdown-toogle-icon"
                            ...
                            <div id="investment1" class="tab-pane fade" role="tabpanel" aria-labelledby="investment-tab">
                                <form class="form-horizontal" method="get" action="{{ url('category/searchby') }}"
                                    onsubmit="return submitInvestment1()"><input type="hidden" name="invTab"
                                        value="1">
                                    <ul class="hero-search-main">
