<section class="testimonia-section section-30 testimonial" id="testimonia-section">
    <div class="container">
                            ...
                            <div class="testimonial-main">
                                ...
                                <div class="testimonial-brand-summury">
                                    ...
                                    <p>हम फ्रैंचाइज़ इंडिया द्वारा प्रदान की गई असाधारण सेवाओं से बेहद प्रसन्न हैं।
                                        ...
                                        सेवाओं की तहे दिल से अनुशंसा करते हैं।</p>
                                    <div
                                        class="textimonial-brand-section">Naturals Salon &amp; Spa</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p>"आपकी टीम के समर्पण और विशेषज्ञता ने हमारे आउटरीच प्रयासों को बढ़ाने और सार्थक
                                    ...
                                    प्रति प्रतिबद्धता की सराहना करते हैं। "</p>
                                <div class="textimonial-brand-section">Apollo Health and Lifestyle Limited</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p>यह वास्तव में किसी भी ब्रांड पैन इंडिया का विस्तार करने के लिए एक आदर्श मंच
                                    ...
                                    300+ आउटलेट स्थापित करने में मदद की है "</p>
                                <div class="textimonial-brand-section">Ferns N Petals</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p>एक विश्वसनीय ट्रेड पत्रिका फ्रैंचाइज़ इंडिया के रूप में, फ्रैंचाइज़
                                    ...
                                    हमारा अनुभव पत्रिका</p>
                                <div class="textimonial-brand-section">Liberty Shoes Ltd</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p> हम बहुत लंबे समय से फ्रैंचाइज़ इंडिया वेबसाइट सेवाओं का उपयोग कर रहे हैं। और
                                    ...
                                    दूसरों को भी अपने विशेषज्ञ और सलाहकार लेने की सलाह देंगे। </p>
                                <div class="textimonial-brand-section">IMS Learning Resources pvt ltd</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets"><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 2"></span>
                    <span
                        class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 5"></span></div><span class="swiper-notification"
                            ...
                            <div class="testimonial-main">
                                ...
                                <div class="testimonial-brand-summury">
                                    ...
                                    <p>We are extremely pleased with the exceptional services provided by Franchise India. The team demonstrated unparalleled professionalism, efficiency, and dedication. Their commitment to excellence and attention
                                        to detail have surpassed our expectations. Working with Franchise India has been a truly rewarding experience and we wholeheartedly recommend their services to anyone seeking top-notch quality and reliability.</p>
                                    <div
                                        class="textimonial-brand-section">Naturals Salon &amp; Spa</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        ...
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p>Your team's dedication and expertise have played a pivotal role in enhancing our outreach efforts and driving meaningful results. The quality of leads generated through our partnership with Franchise India has exceeded
                                    our expectations and we are truly appreciative of the commitment to excellence demonstrated by each member of your team."</p>
                                <div class="textimonial-brand-section">Apollo Health and Lifestyle Limited</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-main">
                            ...
                            <div class="testimonial-brand-summury">
                                ...
                                <p>We have been using Franchise India website services for a very long time. And we have been able to create some very successful franchisee partners. The quality and flow of leads is really very good. Our association
                                    with Franchise India has been a great experience and we will not only continue this relationship but also recommend others to take their expert services and advisory.</p>
                                <div class="textimonial-brand-section">IMS Learning Resources pvt ltd</div>
                                <div class="close-quotes"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
                            </div>
                        </div>
