   ...
   <div class="comparechk">
    ...
    <div class="catlistdest">
        <div class="catdleft pad20">
                ...
                <div class="cattxtimg trst">
                    <div class="phoicon">
                        <a data-toggle="modal" data-target="#catgalleryform">
                            <i class="fa fa-camera fa-2x" aria-hidden="true" onclick="getImages(this.id)" id="fran_{{ $brandResult->franchisor_id }}"></i>
                        </a>
                    </div>
            ...
            <div class="commanmbsmobile">
                ...
                <div class="subcat hindi pright">
                    <span>{{ $brandResult->looking_tradepartner == 1 ? "डीलरशिप" : "फ़्रैंचाइजिंग" }} लॉन्च तिथि</span>
                    {{$brandResult->franchise_start_year}}</div>
                <div class="subcat hindi pleft">
                ...
                @if($brandResult->looking_tradepartner != 1)
                    <div class="subcat hindi pleft">@if($mc != 5)<span>फ़्रैंचाइजी प्रकार</span>@endif
                        @if($mc == 5)<span>चैनल का प्रकार</span>@endif
                        {{Config('hindiConstants.masterfranchiseType.'.$brandResult->franchise_partner_type)}}
                    </div>
                @endif
                <div class="subcat hindi pright">
                    @if($mc != 5)<span>फ़्रैंचाइजी आउटलेट्स</span>@endif
                    @if($mc == 5)<span>डीलरशिप आउटलेट्स</span>@endif
        ...
        <div class="catdright pad20">
            <a href="{{ $brandUrl }}" target="_blank" id="brandnamecategory{{$brandResult->franchisor_id}}"><div class="catimg"><img src="{{$brandImagepath}}" alt="{{$brandResult->company_name}}" /></div></a>
            ...
            @if($brandResult->looking_tradepartner != 1)
                <div class="subcat hindi">
                    @if($mc != 5)<span>फ़्रैंचाइजी प्रकार</span>@endif
                    @if($mc == 5)<span>चैनल का प्रकार</span>@endif
                    {{Config('hindiConstants.masterfranchiseType.'.$brandResult->franchise_partner_type)}}
                </div>
            @endif
    ...
    <div class="catbottp">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="col-xs-4 col-sm-4 col-md-4 bd"><i class="fa fa-thumbs-up fa-lg" aria-hidden="true"></i>@if($likes != 0){{$likes}}@endif </div>
            <div class="col-xs-4 col-sm-4 col-md-4 bd"><i class="fa fa-share-alt fa-lg" aria-hidden="true"></i></div>
            <div class="col-xs-4 col-sm-4 col-md-4 bd"><i class="fa fa-star-half-o fa-lg" aria-hidden="true"></i>@if($rate != 0){{$rate}}@endif</div>
        </div>
    </div>
</div>
