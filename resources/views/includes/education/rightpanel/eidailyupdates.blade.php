<div class="sidearce ei">
    <div class="bor-radius backgrey pad20 ovfl ">
        <div class="arthads">Daily Updates</div>
        <form id="update" method="post" action="{{Config::get('constants.MainDomain')}}/education/newslettersignup">
            <div class="form-group posl">
                <input type="hidden" name="site_type" value="edu">
