...
<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Pre-schools and K-12</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Pre-schools-and-K-12">More >></a></div>
    </div>
    <ul class="row ri-img-txt-list">
        @foreach( $preArticles as $article )
        @php
...
<!-- educationstartups Launch End here-->