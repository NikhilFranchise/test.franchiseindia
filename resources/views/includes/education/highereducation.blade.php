...
<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Higher Education</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Higher-education">More >></a></div>
    </div>
    <ul class="row ri-img-txt-list">
        @foreach( $higherArticles as $article )
        @php
