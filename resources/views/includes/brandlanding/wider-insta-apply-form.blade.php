<div class="tab-section frmwider">
    <form method="post" id="wider-insta-form" action="{{ url('brandcontactinfo') }}">
            ...
            <div class="requested-frm">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <input type="email" name="infoemail"
                                class="form-control check-existing-registered-investor" placeholder="Enter E-mail">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6" style="display:none" id="otp-block-wider">
                        <div class="form-group pos-rel">
                            <input id="otp-insta-wider" type="text" class="form-control" maxlength="4"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group pos-rel">
                            <input type="text" class="form-control" name="pincode" pattern="[0-9]{5,6}"
                                minlength="6" maxlength="6" placeholder="Enter Pincode">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group pos-rel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group txt-center">
                            <div class="checkbox">
                                <label><input type="checkbox" name="newsletter_sub" checked>Yes, I want to subscribe for
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group txt-center">
                            <div class="checkbox">
                                <label><input type="checkbox" name="is_termsagree2" id="is_termsagree2" checked
                                        required="required">I agree to the <a
                                        href="{{ Config('constants.MainDomain') }}/terms" target="_blank">Terms &
                                        Conditions</a></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-footer txt-center">
            <input type="submit" class="btn btn-default btn-red" id="wider-submit-button" value="Submit Request"
                style="float: none;">
        </div>
    </form>
</div>
