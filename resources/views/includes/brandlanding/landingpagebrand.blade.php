<div class="row row-no-margin cateblock catartiblk landcat">
    ...
    <div class="mycatheadarotcle ctal">YOU MIGHT ALSO BE INTERESTED IN THESE FRANCHISE OPPORTUNITIES</div>
                    ...
                    <div class="catlistdest">
                        ...
                        <div class="catdright pad20">
                            <div class="catimg">
                                ...
                                @if($article['company_logo']!='')
                                    <img src="{{Config::get('constants.franAwsImgPath')}}{{$article['company_logo']}}" alt="{{$article['company_name']}}" />
                                @endif
                                </a>
                            </div>
                            ...
                            <div class="subcat"><span>Headquarter</span>
