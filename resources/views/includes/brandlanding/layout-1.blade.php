             ...
             <div class="tab-content" id="bdy-height">
                ...
                <div class="lft-pnl">
                   ...
                   <div class="brandwidth">
                      ...
                      <script>
                         (function(v,d,o,ai){ai=d.createElement("script");ai.defer=true;ai.async=true;ai.src=v.location.protocol+o;d.head.appendChild(ai);})(window, document, "//a.vdo.ai/core/v-franchiseindia/vdo.ai.js");
                      </script>
                   </div>
                ...
                <div class="rht-pnl">
                   ...
                   <div class="share-rat-pnl">
                      ...
                      <div class="rat-info">
                         <ul>
                            ...
                            <li><span><strong id="likecount">{{ $likesCnt }}</strong><strong> likes</strong></span>
                            </li>
                         </ul>
                      </div>
                   ...
                   @endif
                   @if($eligibility == 1 || $checkData['abilityToApply'] == 1)
                   <input type="button" value="Submit Your Interest" id="expbtn" class="btn btn-default submi"/></br>
                   @endif
                   ...
                   <div class="insta-apply thankscs" id="expmsg" style="display:none;">
                      <div class="green">
                         ...
                         <p><span class="popinfohead" id="companyContactinsta" style="color:#fff!important"></span>
                         </p>
                         ...
                         <form id="insta" action="{{ url('brandcontactinfo') }}" method="post" name="insta">
                            ...
                            <div class="form-group">
                               <select class="form-control" id="state" name="infostate" onchange="getcityinfoinsta(this.value)">
                                  ...
                                  @php
                                  $stateListArray = Arr::get(json_decode($stateList, true), 'region', []);
