                ...
                <div class="row">
                    <div class="normal">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 mdy-width pad-top">
                            ...
                            @endphp
                            <div class="brand-logo"><img src="{{ $img }}"
                                    alt="{{ $franDetails->company_name }}" /></div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    @if ($franDetails->ind_main_cat == 5)
                                        <h1 class="ttl">{{ $franDetails->company_name }} Dealership & Distributorship
                                            Cost – How to get, Contact, Apply, Fee</h1>
                                    @else
                                        ...
                                        <div class="lft-pnl">
                                            <ul class="tabScroll">
                                                <li class="Brandpadleft10"><a href="#" id="businessnew_tab"
                                                        onclick="setPos('business_tab', this.id)"
                                                        class="active">Business</a></li>
                                                <li><a href="#" id="investmenttab_tab"
                                                        onclick="setPos('investmentnew_tab', this.id)">Investment</a>
                                                </li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a class="active" href="#" data-toggle="modal"
                                                                    data-target="#modalGetFree" id="Investor">View
                                                                    Contact</a>
                                                            </li>
                                                        </ul>
                                                    @else
                                                        <ul>
                                                            <li>
                                                                <a class="active" href="#" data-toggle="modal"
                                                                    data-target="#modalGetFree"
                                                                    id="seo_contacts_btn">View Contact</a>
                                                            </li>
                                                        </ul>
                                                    @endif
                                                @endif
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                @foreach ($images as $imageSlider)
                    <div class="item @if ($loop->first) active @endif sliderWidth"
                        style="background: url({{ $imageSlider->image_type_slider1 }}) no-repeat center center;">
            ...
            <div class="rate-action">
                <ul>
                    ...
                    <li>
                        ...
                        @else
                            <a data-toggle="modal" onclick="ratebtn()"id="rateButton"><i class="fa fa-star-half-o"
                                    aria-hidden="true"></i> Rate</a>
                        @endif
                    </li>
                    <li><a data-toggle="modal" data-target="#mysocial" id="seo_shareButton"><i class="fa fa-share-alt"
                    ...
                    <div class="rht-pnl">
                        ...
                        <div class="insta-apply thankscs" id="expmsg" style="display:none;">
                            <div class="green">
                                ...
                                <p><span class="popinfohead" id="companyContactinsta" style="color:#fff!important">
                                </p>
                                ...
                                <div class="frm-sec" id="instaForm">
                                    <form id="insta" action="{{ url('brandcontactinfo') }}" method="post"
                                        ...
                                        <div class="form-group pos-rel" style="position: relative;">
                                            ...
                                            <span id="sub1" class="showhideright" style="display:none"><i
