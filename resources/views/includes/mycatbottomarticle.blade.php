...
<div class="row row-no-margin cateblock catartiblk bordeb">
    <div class="mycatheadarotcle">Related opportunities</div>
    <ul id="flexiselDemo1">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 catlistinfo row-no-padding">
                    ...
                    <div class="catlistdest">
                        <div class="catdleft pad20">
                            ...
                            <!--btn s-->
                            <div class="catbtn">
                                <a href="{{ Config('constants.MainDomain') }}/brands/{{$article['profile_name']}}.{{$article['fran_detail_id']}}" class="btn btn-default">View Detail</a>
                            </div>
                            <!--btn E-->
                        </div>
                            ...
                            <div class="catimg">
                                <a href="{{ Config('constants.MainDomain') }}/brands/{{$article['profile_name']}}.{{$article['fran_detail_id']}}">
                                    @if($article['company_logo']=='')
                                        <img class="lozad" alt="no image" data-src="{{URL::asset('images/no-img.jpg')}}">
                                    @endif

                                    @if($article['company_logo']!='')
                                        <img class="lozad" alt="{{$article['company_name']}}" data-src="{{Config('constants.franAwsImgPath')}}{{$article['company_logo']}}">
                                    @endif
                                </a>
                            </div>
