<div class="col-xs-12 col-sm-2 col-md-2 row-no-padding myaccleft">
    <div class="bor-radius backwhite myshadow">
        ...
        @if ((!empty(request()->user()) && request()->user()->membership_type == 0) && (!empty($regionFranData) &&
        $regionFranData->membership_type == 0))
                    ...
                    <div class="fdkblk">
                        ...
                        <div class="sbkblk">
                            ...
                            <div class="ratingleadsquality">
                                <label><input type="radio" name="ratingleadsquality" value="5" title="5 stars">
                                    5</label>
                                <label><input type="radio" name="ratingleadsquality" value="4" title="4 stars">
                                    4</label>
                                <label><input type="radio" name="ratingleadsquality" value="3" title="3 stars">
                                    3</label>
                                <label><input type="radio" name="ratingleadsquality" value="2" title="2 stars">
                                    2</label>
                        ...
                        <div class="sbkblk">
                            ...
                            <ul class="webrating">
                                <li><input type="radio" name="websiterating" value="1" title="0-5" checked="checked">0-5
                                </li>
