...
@section('content')
    <div class="container mostpopu arttilist">
        ...
        <div class="thanksmsg"><br>
            <h2>Thank You</h2><br>
            Thank You for registration process. Our team will get back to you. Kindly verify your e-mail address by clicking on link sent on your registered email address.
            <br><br>
			<img height="1" width="1" style="display:none;" alt="Linked In ads" src="https://px.ads.linkedin.com/collect/?pid=252867&conversionId=2099337&fmt=gif" />
        </div>
