...
<div class="row row-no-margin cateblock catartiblk bordeb">
    ...
    <div class="mycatheadarotcle">संबंधित अवसर</div>
                            ...
                            <div class="catimg">
                                <a href="{{ Config('constants.MainDomain') }}/brands/{{$article['profile_name']}}.{{$article['fran_detail_id']}}">
                                    @if($article['company_logo']=='')
                                        <img class="lozad" data-src="{{URL::asset('images/no-img.jpg')}}" alt="no-img" />
                                    @endif

                                    @if($article['company_logo']!='')
                                        <img class="lozad" data-src="{{Config('constants.franAwsImgPath')}}{{$article['company_logo']}}" alt="{{$article['company_name']}}" />
                                    @endif
                                </a>
                            </div>
