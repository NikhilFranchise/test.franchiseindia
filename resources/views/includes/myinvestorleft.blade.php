<div class="col-xs-12 col-sm-2 col-md-2 row-no-padding myaccleft">
    <div class="bor-radius backwhite myshadow">
        @if(Auth::user()->membership_plan < 405) <a href="payment" class="btn btn-default sidebtn">Upgrade Account </a>
            @endif
            ...
            <ul class="nvss">
                <li @yield('db')>
                    <div><span class="icon-spc"><img alt="dashboard" src={{URL::asset('images/dashboard.png')}}></span><span class="fl"><a href="dashboard">Dashboard</a></span></div>
                </li>
                <li @yield('vp')>
                    <div><span class="icon-spc"><img alt="view profile" src={{URL::asset('images/view-profile.png')}}></span><span><a href="viewprofile">View Profile</a></span></div>
                </li>
                <li @yield('ep')>
                    <div><span class="icon-spc"><img alt="response" src={{URL::asset('images/response.png')}}></span><span><a href="expressed-interest">Expressed Interest</a></span></div>
                </li>
                @if(Auth::user()->membership_plan != 401)
                <li @yield('rec')>
                    <div><span class="icon-spc"><img alt="recommendation" src="/images/recommendationbtn.png"></span><a href="recommendations" class="trsts">Recommendation</a><span class="pright">15</span></div>
                </li>
                @endif
            </ul>
            ...
            <div class="nav__list">
                ...
                <ul class="nvss group-list pafdd">
                    ...
                    @if(Auth::user()->membership_plan < 405) <li @yield('pp')><a href="payment">Payment</a></li>
                        @endif
                </ul>
            </div>
            <ul class="nvss">
