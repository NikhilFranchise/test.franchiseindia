<!-- healthcarefitness start here -->

<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Healthcare Fitness</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Healthcare">More >></a></div>
    </div>
...
</div><!-- healthcarefitness  End here-->