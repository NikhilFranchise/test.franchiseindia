                            ...
                            <div class="catimg">
                                <a href="{{ Config('constants.MainDomain') }}/brands/{{$article['profile_name']}}.{{$article['fran_detail_id']}}">
                                    @if($article['company_logo']=='')
                                        <img class="lozad" data-src="{{URL::asset('images/no-img.jpg')}}" alt="{{$article['profile_name']}}">
                                    @endif

                                    @if($article['company_logo']!='')
                                        <img class="lozad" data-src="{{Config('constants.franAwsImgPath')}}{{$article['company_logo']}}" alt="{{$article['profile_name']}}">
                                    @endif
                                </a>
                            </div>
