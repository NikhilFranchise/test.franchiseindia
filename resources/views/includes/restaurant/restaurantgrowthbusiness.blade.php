...
<div class="bor-radius backwhite pad20 ovfl mart20">
    ...
    <div class="ri-haeding-blk"><span><h3>Restaurant Growth and Business</h3></span>
        <div class="pull-right">
            <a href="{{ Config('constants.MainDomain') }}/content/Growth">
                <img class="fr" alt="" src="{{ Config('constants.MainDomain') }}/images/buttons/more.gif">
            </a>
        </div>
    </div>
    ...
    <ul class="row ri-img-txt-list">
                @foreach( $growthArticles as $article )
            @php
