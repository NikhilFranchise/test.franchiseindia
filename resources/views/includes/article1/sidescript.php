...
<div class="vttbl-cell">
        ...
        <div class="sideslideform">
            ...
            <div id="tryyyy" style="box-shadow: none;">
                        ...
                        <form id="homepage" name="homepage" method="post" action="https://www.franchiseindia.com/freeadvice">
                            ...
                            <div class="frm-input">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control blur" name="namefreeadvice" id="namefreeadvice" placeholder="Enter Name">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"><div class="emailsprite"></div></span>
                                    <input type="text" name="emailfreeadvice" id="emailfreeadvice" class="form-control blur" placeholder="Enter E-mail">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"><div class="usersprite"></div></span>
                                    <input type="text" class="form-control blur" maxlength="10" name="mobilefreeadvice" id="mobilefreeadvice" placeholder="Enter Mobile">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"><img alt="pincode" src="https://www.franchiseindia.com/images/pincode.png"></span>
                                    <input type="text" name="pincodefreeadvice" id="pincodefreeadvice" class="form-control blur" placeholder="Enter Pincode">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon height80"><div class="addreesssprite"></div></span>
                                    <textarea class="form-control height80 blur" name="detailsfreeadvice" id="detailsfreeadvice" placeholder="Enter Details"></textarea>
                                </div>
