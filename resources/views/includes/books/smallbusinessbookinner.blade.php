    ...
    <div class="container formsection margintop60 staicp">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="bookimg"><img src="https://www.franchiseindia.com//images/books-other-1.jpg" alt="books-other-1"/></div>
            </div>


            <div class="col-xs-12 col-sm-9 col-md-9">
                <h1 class="bookhead">India small business report- a year book on franchise, retail & small business</h1>

                <div class="costbok">Out of Stock</div>
                ...
                <div class="booktobmain">
                    ...
                    <div class="booktabcontent">
                        <div id="booktabcontent1">
                            ...
                            <p class="book-st-txt">The most popular and best-selling "India Small Business Report', you
                        ...
                        <div id="booktabcontent2">
                            ...
                            <p class="book-st-txt"><strong>ABOUT SMALL BUSINESS REPORT:</strong><BR/>
                                ...
                                <BR/><BR/>
                                <strong>SMALL BUSINESS IS BIG BUSINESS</strong><BR/>
                                ...
                                new India.
                                <BR/><BR/>
                                <strong>SERVICE SECTOR IN INDIA</strong><BR/>
                                ...
                                <BR/><BR/>
                                <strong>RETAIL REVOLUTION</strong><BR/>
                                ...
                                <BR/><BR/>
                                <strong>FRANCHISING IN INDIA</strong><BR/>
                            ...
                            <div class="bookpart">
                                <div class="bookpart1">
                                    <ul class="book-capt-list">
                                        ...
                                        <li><strong>Foreword - ( 8 )</strong></li>
                                        <li><strong>About the book - ( 10 )</strong></li>
                                        <li><strong>SOME FACTS AND FIGURES ABOUT INDIA - ( 14 )</strong></li>
                                        <li><strong>SMALL BUSINESS IN INDIA - ( 18 ) </strong></li>

                                        <li><strong>INDIA SHINNING - ( 32 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Great Indian Retail Boom<br/></li>

                                        <li><strong>CONSUMERISM IN INDIA - ( 32 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Transformation in Consumption<br/>
                                            <i class="fa fa-arrow-right"></i> Consumerism: Advantage<br/>
                                            <i class="fa fa-arrow-right"></i> Consumer Behaviour<br/>
                                            <i class="fa fa-arrow-right"></i> Urbanisation<br/>
                                            <i class="fa fa-arrow-right"></i> Lifestyle Shopping habits
                                        </li>

                                        <li><strong>SERVICE SECTOR - ( 47 )</strong><br/>
                                            <i class="fa fa-arrow-right"></i> Consumption Boom<br/>
                                        </li>
                                        <li><strong>CASE STUDIES - ( 53 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Coaching Service Providers<br/>
                                            <i class="fa fa-arrow-right"></i> Dairy Products<br/>
                                            <i class="fa fa-arrow-right"></i> IBM Solutions<br/>
                                            <i class="fa fa-arrow-right"></i> Mumbai's Dabbawalas<br/></li>

                                        <li><strong>SMALL BUSINESS ENTREPRENEURS REPORT - ( 59 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> The Economic Impact on the Small
                                            Business<br>
                                            <i class="fa fa-arrow-right"></i> The Evolving Environment for Small
                                            Business<br>
                                            <i class="fa fa-arrow-right"></i> Create a Better Environment for Small
                                            Business<br>
                                            <i class="fa fa-arrow-right"></i> Stimulate Growth<br>
                                            <i class="fa fa-arrow-right"></i> Inspire Entrepreneurship<br>
                                            <i class="fa fa-arrow-right"></i> Implementation Recommendation to
                                            Action<br/></li>


                                        <li><strong>IMPACT OF RETAILING ON SMALL BUSINESS - ( 114 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Policy on Organised Retail<br/></li>

                                        <li><strong>FRANCHISING IN INDIA - ( 122 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Current Status Understanding the
                                            Market<br/></li>

                                        <li><strong>FRANCHISING FLOURISHING GLOBALLY - ( 132 )</strong></li>
                                        <li><strong>IMPACT OF FRANCHISING ON SMALL BUSINESS - ( 139 )</strong></li>
                                        <li><strong>FRANCHISING IN RETAILING - ( 143 )</strong></li>
                                        <li><strong>IMPACT OF FRANCHISING IN CHINA - ( 148 )</strong></li>
                                        <li><strong>RIDING GROWTH IN INDIA & CHINA - ( 155 )</strong></li>
                                        <li><strong>FUTURE OF FRANCHISING - ( 158 )</strong></li>
                                        <li><strong>ENTREPRENEURSHIP IN INDIA - ( 161 )</strong></li>
                                    </ul>
                                ...
                                <div class="bookpart2">
                                    <ul class="book-capt-list">
                                        <li><strong>LEGENDARY ENTREPRENEURS - ( 167 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Kishore Biyani-Future Group<br>
                                            <i class="fa fa-arrow-right"></i> Kiran Mazumdar Shaw-Biocon<br>
                                            <i class="fa fa-arrow-right"></i> Sunil Mittal--Airtel<br>
                                            <i class="fa fa-arrow-right"></i> Mehul Choksi-Gitanjali Group<br>
                                            <i class="fa fa-arrow-right"></i> Naresh Goyal-Jet Airways<br>
                                            <i class="fa fa-arrow-right"></i> R S Agarwal-Emami Group<br>
                                            <i class="fa fa-arrow-right"></i> Tulsi Tanti-Suzlon Energy Ltd.<br>
                                            <i class="fa fa-arrow-right"></i> Subhash Chandra-Zee Network<br>
                                            <i class="fa fa-arrow-right"></i> Uday Kotak-Kotak Finance<br>
                                            <i class="fa fa-arrow-right"></i> Brijmohan Lall Munjal-Hero Honda<br>
                                            <i class="fa fa-arrow-right"></i> Shiv Nadar-HCL<br/></li>

                                        <li><strong>RETAILING CASE STUDY - ( 187 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Apparel Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Furniture and Furnishing Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Footwear Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Stationery, Music, Book Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Grocery Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Education Service<br>
                                            <i class="fa fa-arrow-right"></i> Hospitality Sector<br>
                                            <i class="fa fa-arrow-right"></i> Gems and Jewellery<br>
                                            <i class="fa fa-arrow-right"></i> Pharmacy Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Mobile Phone Retailing<br>
                                            <i class="fa fa-arrow-right"></i> Beauty & Personal<br>
                                        </li>


                                        <li><strong>ECONOMIC ROLE OF SMEs IN WORLD ECONOMY - ( 242 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Russia<br>
                                            <i class="fa fa-arrow-right"></i> China<br>
                                            <i class="fa fa-arrow-right"></i> Singapore<br>
                                            <i class="fa fa-arrow-right"></i> Australia<br>
                                            <i class="fa fa-arrow-right"></i> USA<br>
                                        </li>
                                        <li><strong>FOCUS ON SMALL CITIES - ( 278 )</strong><br>
                                            <i class="fa fa-arrow-right"></i> Agra<br>
                                            <i class="fa fa-arrow-right"></i> Amritsar<br>
                                            <i class="fa fa-arrow-right"></i> Bhiwadi<br>
                                            <i class="fa fa-arrow-right"></i> Bhopal<br>
                                            <i class="fa fa-arrow-right"></i> Coimbatore<br>
                                            <i class="fa fa-arrow-right"></i> Greater Noida<br>
                                            <i class="fa fa-arrow-right"></i> Bangalore<br>
                                            <i class="fa fa-arrow-right"></i> Goa<br>
                                            <i class="fa fa-arrow-right"></i> Ghaziabad<br>
                                            <i class="fa fa-arrow-right"></i> Indore<br>
                                            <i class="fa fa-arrow-right"></i> Jaipur<br>
                                            <i class="fa fa-arrow-right"></i> Jamshedpur<br>
                                            <i class="fa fa-arrow-right"></i> Kochi<br>
                                            <i class="fa fa-arrow-right"></i> Kanpur<br>
                                            <i class="fa fa-arrow-right"></i> Ludhiana<br>
                                            <i class="fa fa-arrow-right"></i> Mysore<br>
                                            <i class="fa fa-arrow-right"></i> Mohali<br>
                                            <i class="fa fa-arrow-right"></i> Nagpur<br>
                                            <i class="fa fa-arrow-right"></i> Panipat<br>
                                            <i class="fa fa-arrow-right"></i> Thiruvananthapuram<br>
                                            <i class="fa fa-arrow-right"></i> Zirakpur<br>
                                        </li>

                                        <li><strong>CONCLUSION - ( 301 )</strong></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="clr"></div>
