...
<div id="my_modal" class="model_top" style="width:600px;"> 
  ...
  <div class="expo-header">
      <a href="https://www.franchiseindia.com/bos/" target="_blank"><img src="https://www.franchiseindia.com/images/popup/bosheader-noida.jpg" /></a>
  </div>
  </div>
       ...
       <form method="post" id="form1-stall" name="form1-stall" action="https://master.franchiseindia.com/bos/insta_reg_ticket.php" class="fro-expo-form">
           ...
           <div class="sec">
                               	<select class="form-control myselectclasscat" placeholder="Select City to Attend" name="city" type="text" required="">
                                    ...
                                    <option value="Noida" selected="selected">Noida</option>
