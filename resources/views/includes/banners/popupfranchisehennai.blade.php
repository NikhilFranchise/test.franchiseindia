...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfrobottomchennai.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupfroheadchennai.jpg") no-repeat center top;
overflow: hidden;
...
<form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_chennai.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
<input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
<input type="hidden" value="FRO 2022 Chennai" name="event_title" id="event_title">
<input type="hidden" value="Chennai April 2022" name="event_year" id="event_year">
<input type="hidden" value="Chennai" name="event_city" id="event_city">                          
<input id="source" name="source" type="hidden" value="popup"> 
<input id="hidden" name="tfw_interest" type="hidden" value="Visit the Expo - Paid">   
...
<select type="text" placeholder="No. of Visitors" id="eventdays" name="eventdays" class="form-control myselect" accesskey="">
                     <option value="Saturday16thApril" selected="selected">Saturday, 16th April</option>
                     <option value="Sunday17thApril">Sunday, 17th April</option>
                     <option value="Bothdays1617April">Both days, 16th-17th April</option>
                  </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers(){var amt=500;var eventdays=$("#eventdays :selected").val();var visitVal=$("#txtDelegates :selected").val();if(eventdays=="Saturday22ndJanuary")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Sunday23rdJanuary")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Bothdays2223January")
