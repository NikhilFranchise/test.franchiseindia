...
/*input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fro-expo-hyderabad-footer.webp") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/fro-expo-hyderabad-popup-header.webp") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        <div class="boxblk">
        <form class="form registration-form align-center" action="https://www.franchiseindia.net/fro/hyderabad/register_update.php" method="post" target="_blank">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Hyderabad March 2025" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2025 Hyderabad" name="event_title" id="event_title">  
...
<input name="txtName" type="text" class="form-control myselect" placeholder="Name" required="" style="color:#ffffff;">
                  ...
                  <select type="text" placeholder="Select event date" id="eventdays" name="eventdays" class="form-control myselectclass3" accesskey="" onchange="checkNumbers();">
                                            <option value="Saturday8thMarch" selected="selected">Saturday, 8th March</option>
                                            <option value="Sunday9thMarch">Sunday, 9th March</option>
                                            <option value="Bothdays89March">Bothdays, 8th-9th March</option>
                  </select>
                                    </div>
                                </div>
