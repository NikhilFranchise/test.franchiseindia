...
/*input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-india-delhi-may-footer.webp?ver=2") no-repeat center top;
    }
  ...
  height: 40px;
  border: 1px solid #201d59!important;
  margin-top: 7px;
    }
...
.sec button, sec button:hover{border: none;outline: none;background: transparent;}
.sec button{margin-top: 9px;}


.headtag { height: 266px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/franchise-india-delhi-may-header.webp?ver=2") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
           ...
           <form action="https://www.franchiseindia.com/expo/register_update.php" class="form registration-form align-center" method="post" target="_blank">
                        ...
                        <input type="hidden" value="Delhi May 2025" name="event_year" id="event_year">


                       <div class="sec">
                                    <div class="f1">
<input name="txtName" type="text" class="form-control myselect" placeholder="Name" required="">
                                    </div>
                                    <div class="f3">
                  ...
                  <select type="text" placeholder="Select event date" id="eventdays" name="eventdays" class="form-control myselectclass3" accesskey="" onChange="checkNumbers();">
                    <option value="Saturday17May">Expo Visit Saturday 17 May</option>
                    <option value="Sunday18May">Expo Visit Sunday 18 May</option>
                    <option value="BothDays1718May">Expo Visit Both days, 17th-18th May</option>
                    <option value="PremiumVisitorPass17May">Premium Visitor Pass - Saturday 17 May</option>
                    <option value="PremiumVisitorPass18May">Premium Visitor Pass - Sunday 18 May</option>
                    <option value="BothDaysPremiumVisitorPass1718May">Premium Visitor Pass - Both Days, Saturday 17 May & Sunday 18 May</option>
                    <option value="StartupSummit17May">Startup Summit Pass - Saturday 17 May</option>
                    <option value="StartupSummit18May">Startup Summit Pass - Sunday 18 May</option>
                    <option value="StartupSummit1718May">Startup Summit Pass - Both Days, Saturday 17 May & Sunday 18 May</option>
                              </select>
                            ...
                            <div class="sec" style="text-align:center">
                                    <button type="submit" name="btnSubmitReg"><img src="https://www.franchiseindia.com/images/popup/submit.webp" alt="Franchise India"></button>
                                </div>
                            </form>
                        </div>
                    </div>
