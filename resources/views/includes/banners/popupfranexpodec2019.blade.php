<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/expo-backdec.jpg") no-repeat center top
    }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    <div class="headtag">
                        <img src="https://www.franchiseindia.com/images/popup/expo-headback.jpg?id=1" /></a>
                    </div>
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <select type="text" id="eventdays" name="eventdays" class="form-control" accesskey="" onchange="checkNumbers()" required>
                                            <option value="Chandigarhsunday12thjanuary" selected="selected">Chandigarh, Sunday, 12th January 2020</option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    ...
    if(eventdays=="Lucknowsunday22nddecember")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Chandigarhsunday12thjanuary")
    {amt=500;$('#txtAmount').val(amt);}
