                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/fro/" target="_blank"><img class="lozad" data-src="https://www.franchiseindia.com/images/popup/popup-hyderabad2019.jpg" /></a>
                        </div>
                    </div>
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select name="txtState" class="form-control myselectclasscat" id="txtState">
                                            ...
                                            <option value="Telangana" selected>Telangana</option>	</select>
                                    </div>
                                </div>
                                    ...
                                    <div class="sec">
                                        ...
                                        <div class="f2">:</div>
                                        <div class="f3">
                                            <input id="txtCity" name="txtCity" type="text" class="form-control" placeholder="City" required="">
                                        </div>
                                    </div>
