...
#myModal .modal-dialog{width:605px!important;}
...
#myModal .modal-content{border:none!important;}
#myModal .modal-dialog{height:310px; background:#fff;width:606px!important;}
...
#update input[type="email"] {border: 1px solid #CCCCCC;margin-bottom: 15px;padding: 9px;width: 331px;     margin-top: 7px;}
...
.modal .close{right:-17px!important; top:-17px!important;}
/* End popup start */
...
<div class="dot-bod"></div>
<div class="sp10"></div>
<img src="https://www.franchiseindia.com/images/icons/lock-icon.gif" class="fl" style="margin-right:8px;" /><p class="pop-txt">We value your privacy.<br />
...
<a href="https://master.franchiseindia.com/emagazine/" target="_blank"><img src="https://www.franchiseindia.com/images/magazine/tfw-165x225.jpg" /></a>
