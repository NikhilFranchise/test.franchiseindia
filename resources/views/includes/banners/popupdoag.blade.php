<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        padding-top:77px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupdoagbtm.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupdoagtop.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
<form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_doag_show.php" method="post">
    <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
    <input id="lp_type" name="event_title" type="hidden" value="Dealer Opportunities - DOAG">  
...
<option value="Gujarat12November2021"> -- Select Event Date --</option> 
<option value="Gujarat12November2021">Gujarat 12 November 2021</option>
<option value="AssamWestBengal13November2021">Assam & West Bengal 13 November 2021</option>
<option value="HaryanaPunjab16November2021">Haryana & Punjab 16 November 2021</option> 
<option value="MadhyaPradeshChhattisgarh17November2021">Madhya Pradesh & Chhattisgarh 17 November 2021</option>
<option value="UttarPradeshBihar19November2021">Uttar Pradesh & Bihar 19 November 2021</option>
<option value="Maharashtra20November2021">Maharashtra 20 November 2021</option>
                                        </select>
                                    </div>
                                    <div class="f1">
