...
/*input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fro-expo-chennai-footer.webp?ver=5") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/fro-expo-chennai-header.webp?ver=5") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        <div class="boxblk">
     <form class="form registration-form bg-black-transparent align-center" action="https://www.franchiseindia.net/tamil-nadu/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Chennai June 2025" name="event_year" id="event_year">
         <input type="hidden" value="FRO 2025 Chennai" name="event_title" id="event_title">
...
<input name="txtName" type="text" class="form-control myselect" placeholder="Name" required="" style="color:#ffffff;">
                  ...
                  <select type="text" placeholder="Select event date" id="eventdays" name="eventdays" class="form-control myselectclass3" accesskey="" onchange="checkNumbers();">
                                            <option value="Friday27thJune" selected="selected">Friday, 27th June</option>
                                            <option value="Saturday28thJune">Saturday, 28th June</option>
                                            <option value="Bothdays2728June">Bothdays, 27th-28th June</option>
                  </select>
                                    </div>
                                </div>
