...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-left: 6px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-expo-vishakhapatnam-footer.jpg") no-repeat center top;
    }
...
.headtag { height:345px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/franchise-expo-vishakhapatnam-header.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                    	<div class="boxblk">
<form class="form registration-form align-center" action="https://www.franchiseindia.net/andhra-pradesh/franchise-expo/register_update.php" method="post">
<input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
      ...
      <input type="hidden" value="FROBOS 2025" name="event_title" id="event_title">
      <input type="hidden" value="Visit the Expo - Paid" name="tfw_interest" id="tfw_interest"> 
<input type="hidden" value="Visakhapatnam13thOct2025" name="eventdays" id="eventdays">
<div class="sec">
                                      <div class="f1">
                                    </div>
                                    <div class="f1">
