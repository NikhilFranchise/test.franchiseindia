<style type="text/css">
    ...
    #myModal .close {
        ...
        top: -19px!important;
        box-shadow: 0 0px 15px 8px rgba(0, 0, 0, 0.35)!important;
    }
    ...
    .fi-expotest{font-size:30px; color:#fff; font-family:'Open Sans Regular';  padding:15px 0 0 0; line-height:26px; text-transform:uppercase;}
    ...
    .expo-submitnew{background:url("https://www.franchiseindia.com/images/popup/submitfro2018.gif") no-repeat; width:123px;
        height:35px;cursor:pointer;  margin:2px auto 0 0; border:none; display:inline-block;}
...
@php
    ...
    $cities = Config('location.cityArr.33');
        asort($cities);
@endphp
                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/fro/" target="_blank"><img class="lozad" data-src="https://www.franchiseindia.com/images/popup/popup-kolkata2019.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form class="form fro-expo-form" action="https://master.franchiseindia.com/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                ...
                                <input type="hidden" value="Kolkata April 2019" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2019 Kolkata" name="event_title" id="event_title">
                                <input type="hidden" value="Kolkata" name="event_city" id="event_city">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f2">:</div>
                                    <div class="f3">
                                        <input id="txtPhone" name="txtPhone" type="tel" placeholder="Mobile" class="form-control" pattern="[789][0-9]{9}" minlength="10" maxlength="10" onkeypress="return isNumber(event)" oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);" required="">
                                    </div>
                                </div>
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f2">:</div>
                                    <div class="f3">
                                        <select name="txtState" onchange="getcitypopup(this)" class="form-control myselectclasscat" required id="txtState">
                                            <option value="" data-id="">Select State</option>
                                            @foreach($states as $index => $value)
                                                <option value="{{ $value }}" data-id="{{ $index }}" @if($index == 33) selected @endif >{!! $value !!}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f2">:</div>
                                    <div class="f3">
                                        <select name="txtCity" class="form-control myselectclasssearch" required id="popupcity" >
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f2">:</div>
                                    <div class="f3">
                                        <input id="txtPincode" name="txtPincode" minlength="6" maxlength="6"  onkeypress="return isNumber(event)"  type="text" class="form-control" placeholder="Pincode" required="">
                                    </div>
                                </div>
