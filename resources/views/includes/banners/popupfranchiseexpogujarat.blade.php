...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-top:110px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-expo-gujarat-bottom.jpg") no-repeat center top;
    }
...
.headtag { height:233px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/franchise-expo-gujarat-top.jpg") no-repeat center top;
overflow: hidden;
