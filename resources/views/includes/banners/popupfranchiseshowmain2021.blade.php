...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        margin: 0 auto;
		padding-top:0px;
        background: url("https://www.franchiseindia.com/images/popup/bottomfs2021.jpg") no-repeat center top;
    }
...
.headtag { height:341px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/topfs2021.jpg") no-repeat center top;
...
<input type="hidden" value="Paytm" name="mop" id="mop" >     
		           ...
		           <option value="Kanpur, 10 April 2021, Hotel The JS Residency" selected="selected">Select Event Date </option>
  
      <option value="Kanpur, 10 April 2021">Kanpur, 10 April 2021, Hotel The JS Residency</option>
    <option value="Lucknow, 11 April 2021">Lucknow, 11 April 2021, Hotel Golden Tulip</option>
