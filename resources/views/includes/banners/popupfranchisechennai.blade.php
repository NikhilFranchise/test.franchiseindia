...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfrobottommay.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupfroheadmay.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
               <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_chennai.php" method="post">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Chennai May 2021" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2021 Chennai " name="event_title" id="event_title">  
  ...
  <input type="hidden" name="src" value="popup"> 
   <input type="hidden" name="tfw_interest" value="Visit the Expo - Paid"> 
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                                <select type="text" placeholder="No. of Visitors" id="eventdays" name="eventdays" class="form-control" accesskey="">
                     <option value="Saturday29thMay" selected="selected">Saturday, 29th May </option>
                     <option value="Sunday30thMay">Sunday, 30th May </option>
                     <option value="Bothdays2930May">Both days, 29th-30th May </option>
                  </select>
                                    </div>
                                </div>
