...
/*input:focus {
  ...
  margin-right: 10px;
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfroexpogujarat-footer.webp") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupfroexpogujarat-header.webp") no-repeat center top;
overflow: hidden;
