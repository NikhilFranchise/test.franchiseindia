...
/*input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/frex-bengaluru-popup-footer.jpg") no-repeat center top;
    }

    select option{background: #386f48}
    select option:hover{background: #386f48!important;}
...
.headtag { height: 271px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/frex-bengaluru-popup-header.jpg") no-repeat center top;
overflow: hidden;
...
<form class="form registration-form bg-black-transparent align-center" action="https://www.franchiseindia.net/karnataka/frex/register_update.php" method="post">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Bengaluru August 2025" name="event_year" id="event_year">
         <input type="hidden" value="FRO 2025 Bengaluru" name="event_title" id="event_title">
...
<input name="txtName" type="text" class="form-control myselect" placeholder="Name" required="" style="color:#ffffff;">
                  ...
                  <select type="text" placeholder="Select event date" id="eventdays" name="eventdays" class="form-control myselectclass3" accesskey="" onchange="checkNumbers();">
                    <option value="Bothdays3031August" selected>Both Days, 30th-31st August </option>
                                            <option value="Saturday30thAugust">Saturday, 30th August </option>
                            <option value="Sunday31stAugust">Sunday, 31st August </option>
