                ...
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_lucknow.php" method="post">

           <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Lucknow January 2023" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2023 Lucknow" name="event_title" id="event_title">  
         <input type="hidden" value="Lucknow" name="event_city" id="event_city">                             
