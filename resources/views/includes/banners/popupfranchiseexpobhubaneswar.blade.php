...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-top:0px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-expo-bhubaneswar-footer.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/franchise-expo-bhubaneswar-header.jpg") no-repeat center top;
overflow: hidden;
...
<input type="hidden" value="Bhubaneswar28thDec2024" name="eventdays" id="eventdays">
<div class="sec">
                                      <div class="f1">
                                    </div>
                                    <div class="f1">
