...
@php
    $states = Config('location.stateArr');
        asort($states);
    $cities = Config('location.cityArr.9');
        asort($cities);
@endphp
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/bos/" target="_blank">
                                <img src="https://www.franchiseindia.com/images/popup/bos-gujarat.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form method="post" id="form1-stall" name="form1-stall"
                                  action="https://master.franchiseindia.com/bos/insta_reg_ticket.php" class="fro-expo-form">
                                ...
                                <input type="hidden" name="event_year" id="event_year" value="Gujarat August 2019">
