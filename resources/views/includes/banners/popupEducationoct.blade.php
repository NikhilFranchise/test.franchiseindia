...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/edu-btm-popup.jpg") no-repeat center top;
    }
...
.headtag { height:393px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/edu-top.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                                 <form class="form registration-form align-center" action="https://www.entrepreneurindia.com/edawards/register_update.php" method="post">
          <input type="hidden" value="Education-Insta-Registration" id="ref" name="ref">
      <input type="hidden" name="src" id="src" value="Popup">
      <input type="hidden" value="Education Award Registration" name="reg_type" id="reg_type">  

	   <input type="hidden" value="Attend the Conference VIP" name="want" id="want">     
      <input type="hidden" value="15 October 2020" name="event_year" id="event_year">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <input name="txtcompany" type="text" class="form-control" placeholder="Organization" required="">
                                    </div>
                                </div>
                                ...
                                <div class="sec" style="text-align:center">
                                    <input type="submit" value="Get Your Free Pass" name="btnSubmitReg" class="expo-submitnew">
                                </div>
                            </form>
                        </div>
                    </div>
