...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fijulybtm.jpg") no-repeat center top;
    }
...
.headtag { height:423px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/fijulynew18.jpg") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" value="18 July 2020" name="event_year" id="event_year">  
           ...
           <input type="hidden" name="txtDelegates" value="1">           
                                ...
                                <div class="sec">
                                    <div class="f1">
                                         ...
                                         <input class="form-control" type="text" value="INR 1000 PLUS 18% GST" id="txtAmount" readonly>
                                    </div>
                                    <div class="f3">
                                     <select id="mop" name="mop" class="form-control myselectclass3" >
