...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        margin: 0 auto;
		padding-top:0px;
        background: url("https://www.franchiseindia.com/images/popup/bottompopsmall.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/topheadsmall.jpg") no-repeat center top;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
               <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_hyderabad.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
<input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
<input type="hidden" value="Hyderabad March 2021" name="event_year" id="event_year">  
<input type="hidden" value="FRO 2021 Hyderabad LP" name="event_title" id="event_title">  
<input type="hidden" value="Hyderabad" name="event_city" id="event_city">							
...
<input type="hidden" value="Paytm" name="mop" id="mop" >     
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <input name="txtPhone" type="tel" placeholder="Contact" class="form-control" pattern="[56789][0-9]{9}" minlength="10" maxlength="10" onkeypress="return isNumber(event)" required="">
                                    </div>
                                    <div class="f3">
		           ...
		           <option value="Saturday13thMarch" selected="selected">Saturday, 13th March </option>
                     <option value="Sunday14thMarch">Sunday, 14th March </option>
                     <option value="Bothdays1314March">Both days, 13th-14th March </option>
...
<script language="javascript">
    function checkNumbers(){var amt=500;var eventdays=$("#eventdays :selected").val();var visitVal=$("#txtDelegates :selected").val();if(eventdays=="Saturday13thMarch")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Sunday14thMarch")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Bothdays1314March")
    ...
    /*<![CDATA[*/if(screen.width>767)
    {
		...
		$(document).ready(function(){  setTimeout(function () { $('#myModal').modal('show'); }, 30000)
    });
