<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        padding-top:30px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/euro-bottom.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/euro-head.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
 <form id="form1" name="form1" action="https://www.franchiseindia.in/lighthouse-learning-franchise/reg_sub.php" method="post" class="form registration-form align-center">
 <input type="hidden" name="brand" id="brand" value="FIBL-Lighthouse-Learning" />
 <input type="hidden" name="brandid" id="brandid" value="6063" /> 
