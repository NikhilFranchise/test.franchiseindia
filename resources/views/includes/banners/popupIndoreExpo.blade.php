<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("images/popup/fro-expo-indore-popup-footer.webp") no-repeat center top;
    }
    ...
    .headtag {
        ...
        overflow: hidden;
        width: 600px;
        background: url("images/popup/fro-expo-indore-popup-header.webp") no-repeat center top;
        overflow: hidden;
    }
                    ...
                    <div class="fi-bg-expo">
                        <div class="boxblk">
                            <form class="form registration-form bg-black-transparent align-center"
                                action="https://www.franchiseindia.net/madhya-pradesh/franchise-expo/register_update.php"
                                method="post">

                                <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
                                <input type="hidden" value="Indore December 2025" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2025 Indore" name="event_title" id="event_title">
                                <input type="hidden" value="Indore" name="event_city" id="event_city">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select type="text" placeholder="Select event date" id="eventdays"
                                            ...
                                            <option value="Sunday21stDecember">Sunday, 21st December</option>
                                            <option value="PremiumPass21December">Premium Pass, 21st December
                                            </option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers() {
        ...
        if (eventdays == "Sunday21stDecember") {
            amt = 500;
            $('#txtAmount').val(amt);
        } else if (eventdays == "Sunday21stDecember") {
            amt = 500;
            $('#txtAmount').val(amt);
        } else if (eventdays == "Bothdays21December") {
            amt = 1000;
            $('#txtAmount').val(amt);
        } else {
            amt = 500;
