<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("images/popup/fro-expo-hyderabad-popup-footer.webp") no-repeat center top;
    }
    ...
    .headtag {
        ...
        overflow: hidden;
        width: 600px;
        background: url("images/popup/fro-expo-hyderabad-popup-header.webp") no-repeat center top;
        overflow: hidden;
    }
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        <div class="boxblk">
                            <form class="form registration-form bg-black-transparent align-center"
                                action="https://www.franchiseindia.net/telangana/fro/register_update.php"
                                method="post">
                                <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
                                <input type="hidden" value="Hyderabad March 2026" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2026 Hyderabad" name="event_title" id="event_title">
                                <input type="hidden" value="Hyderabad" name="event_city" id="event_city">
                                <input id="source" name="source" type="hidden" value="Popup" />
                                <input id="tfw_interest" name="tfw_interest" type="hidden"
                                    value="Visit the Expo - LP Paid">

                                <div class="sec">
                                    <div class="f1">
                                        <input name="txtName" type="text" class="form-control myselect"
                                            placeholder="Name" required="" style="color:#ffffff;">
                                    </div>
                                    <div class="f3">
                                ...
                                <div class="sec">
                                    <div class="f1">
                                       <select name="txtCity" class="form-control myselect" id="popupcity"
                                            required="">
                                    ...
                                    <div class="f3">
                                        <select type="text" placeholder="Select event date" id="eventdays"
                                            ...
                                            <option value="Saturday14thMarch">Saturday, 14th March</option>
                                            <option value="Sunday15thMarch">Sunday, 15th March</option>
                                            <option value="Bothdays1415March" selected>Both Days, 14th-15th March
                                            </option>
                                            <option value="PremiumPass1415March" selected>Premium Pass</option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers() {
        ...
        if (eventdays == "Sunday15thMarch") {
            amt = 500;
            $('#txtAmount').val(amt);
        } else if (eventdays == "Sunday15thMarch") {
            amt = 500;
            $('#txtAmount').val(amt);
        } else if (eventdays == "Bothdays1415March") {
            amt = 1000;
            $('#txtAmount').val(amt);
        } else {
            amt = 500;
