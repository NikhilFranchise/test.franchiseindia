...
input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfooterdelhishow.jpg") no-repeat center top;
    }
...
.headtag { height: 287px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/popupheaderdelhishow.jpg") no-repeat center top;
overflow: hidden;
...
<input type="hidden" value="Delhi July 2023" name="event_year" id="event_year">
<input type="hidden" value="VIP VISITOR PASS - REGULAR" name="package" id="package">
...
<input name="txtName" type="text" class="form-control myselect" placeholder="Name" required="" style="color:#ffffff;">
                  ...
                  <select placeholder="No. of Visitors" id="txtDelegates" name="txtDelegatesRDP" class="form-control myselect" onchange="checkNumbersforfrom(this.value);">
                        <option selected="selected" value="1">Select No of Passes</option>
