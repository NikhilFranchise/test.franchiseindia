...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-top:110px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-expo-pune-bottom.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/franchise-expo-pune-top.jpg") no-repeat center top;
overflow: hidden;
...
<input type="hidden" value="Pune03rdFebruary2024" name="eventdays" id="eventdays">
<div class="sec">
                                      <div class="f1">
                                    </div>
                                    <div class="f1">
