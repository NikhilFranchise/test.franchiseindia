...
select option{background: #000000;}
    ...
    .model_top{
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/dale-carnegie.webp") no-repeat center top;
    }
...
<input type="hidden" value="FIHL684825" id="franchisor_id" name="franchisor_id">
