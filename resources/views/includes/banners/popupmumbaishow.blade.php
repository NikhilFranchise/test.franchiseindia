...
input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfootermumbaishow.jpg") no-repeat center top;padding-top: 29px;
    }
...
.headtag { height: 286px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/popupheadermumbaishow.jpg") no-repeat center top;
overflow: hidden;
