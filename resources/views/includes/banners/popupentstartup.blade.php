...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/ent-back-bottom.jpg") no-repeat center top;
    }
...
.headtag { height: 387px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/ent-back-header.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                                  <form name="sentMessage" id="contactForm" action="https://www.entrepreneurindia.com/smbwebinar/register_update.php" method="post" enctype="multipart/form-data"> 
  <input type="hidden" name="ref" value="Entrepreneur-Webinar-Registration">
  <input type="hidden" name="reg_type" value="Entrepreneur India Webinar Registration"> 
  <input type="hidden" name="visit_type" value="Attend the Webinar">                
  <input type="hidden" name="event_year" value="07 April 2020">              
