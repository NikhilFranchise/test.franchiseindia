...
input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfooterlicensingexpo.jpg") no-repeat center top;padding-top: 29px;
    }


    .sec .f1 .form-control,
    .sec .f3 .form-control {
/*        background:rgb(4 40 76/100%);*/
background: transparent;
        border:1px solid #b3b3b3!important;
        color: #000000!important;box-shadow: none;
...
button{outline: none;border: none;margin-top: 15px;}
 .expo-submitnew {
    padding: 12px 19px;
...
.headtag { height: 274px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/popupheaderlicensingexpo.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
   <form id="msform" action="https://www.licenseindia.com/expo/register_update.php" name="msform1" method="post">
...
<input type="hidden" value="Mumbai November 2023" name="event_year" id="event_year">
<input type="hidden" value="VIP VISITOR PASS - EARLY BIRD" name="package" id="package">
...
<option value="21">Rs. 5 Cr. above</option>
 ...
 -->
                                ...
                                <div class="sec" style="text-align:center">
                                    <button type="submit" value="Get Your Entry Pass" name="btnSubmitReg">
                                        <img src="https://www.franchiseindia.com/images/popup/bookbtn.png">
                                    </button>
