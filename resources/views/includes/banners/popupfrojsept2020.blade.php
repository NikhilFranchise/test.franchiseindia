...
<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/froseptbtm.jpg") no-repeat center top;
    }
...
.headtag { height:380px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/popupsept2020.jpg") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" value="26 September 2020" name="event_year" id="event_year">  
