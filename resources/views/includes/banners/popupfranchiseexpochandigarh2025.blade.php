<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("/images/popup/fro-expo-punjab-popup-footer.webp") no-repeat center top;
    }
    ...
    .headtag {
        ...
        overflow: hidden;
        width: 600px;
        background: url("/images/popup/fro-expo-punjab-popup-header.webp") no-repeat center top;
        overflow: hidden;
    }
                    ...
                    <div class="fi-bg-expo">
                        <div class="boxblk">
                            <form class="form registration-form bg-black-transparent align-center"
                                action="https://www.franchiseindia.net/punjab/fro/register_update.php" method="post">
                                <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
                                <input type="hidden" value="Chandigarh December 2025" name="event_year"
                                    id="event_year">
                                <input type="hidden" value="FRO 2025 Chandigarh" name="event_title" id="event_title">
                                <input type="hidden" value="Chandigarh" name="event_city" id="event_city">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select type="text" placeholder="Select event date" id="eventdays"
                                            ...
                                            <option value="Saturday13thDecember">Saturday, 13th December</option>
                                            <option value="Sunday14thDecember">Sunday, 14th December</option>
                                            <option value="Bothdays1314December" selected>Both Days, 13th-14th
                                                December
                                            </option>
                                            <option value="PremiumPass1314December">PremiumPass, 13th-14th December
                                            </option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers() {
        ...
        if (eventdays == "Saturday28thAugust") {
            amt = 500;
            $('#txtAmount').val(amt);
