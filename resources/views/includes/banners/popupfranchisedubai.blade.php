...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popup-franchise-dubai-top.jpg") no-repeat center top;
    }
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popup-franchise-dubai-bottom.jpg") no-repeat center top;
    }
...
.headtag { height: 258px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/popup-franchise-dubai-top.jpg") no-repeat center top;
overflow: hidden;
...
<div class="boxblk">
<form name="sentMessage" id="contactForm" action="https://www.franglobal.com/franglobal-franchise-open-house/register_update.php" method="post" enctype="multipart/form-data"> 
<input type="hidden" name="ref" value="Insta-Registration">
<input type="hidden" name="reg_type" value="FranGlobal"> 
<input type="hidden" name="visit_type" value="Dubai Show">                
<input type="hidden" name="event_year" value="29 April 2023">         
<input id="source" name="source" type="hidden" value="popup">
                                   ...
                                   <div class="sec">
                                    ...
                                    <div class="f3">
                                       <input type="text" placeholder="Email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" name="email" class="form-control" required="">
                                    </div>
                                </div>

                                <div class="sec">
                                    <div class="f1">
                                        <input type="text" name="telephone" maxlength="12" placeholder="Mobile" onkeypress="return isNumber(event)" class="form-control" required="">
                                    </div>
                                    <div class="f3">
                                  <input type="text" placeholder="Company Name" name="company" class="form-control" required="">
                                    </div>
                                </div>
          ...
          <option selected="selected">Type of Company</option>
          <option value="Family Business">Family Business</option>
          <option value="Start UP">Start UP </option>
          <option value="Legacy Brands">Legacy Brands</option>
          <option value="Multi unit Business">Multi Unit Business</option>
        </select>
                                        
                                    </div>
                                    <div class="f3">
                                        <select class="form-control" name="package2">
          <option selected="selected">Your Role</option>
