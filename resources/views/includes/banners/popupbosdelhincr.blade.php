<style type="text/css">
    ...
    .expo-header{ }
    .fi-bg-expo{height:577px; width:600px; margin:0 auto; background:url("../images/popup/backncr2020.jpg") no-repeat center top;}
    ...
    .boxblk { padding:10px 30px;}
    .fblk {  padding-top: 25px; margin-left:30px; width: 300px;}
    .fblk img { width: 100%; }
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/bos/" target="_blank">
                                <img src="../images/popup/bos-head-ncr2020.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form method="post" id="form1-stall" name="form1-stall" action="https://master.franchiseindia.com/bos/insta_reg_ticket.php" class="fro-expo-form">
                                ...
                                <input type="hidden" name="reg_type" id="reg_type" value="BOS-Paid-Ticket-NorthIndia-LP">
                                <input type="hidden" name="event_year" id="event_year" value="North India January 2020">

                                <input type="hidden" name="want" id="want" value="Visit The Show">
                                <div class="sec">
                                    <select id="event_city" name="event_city" required="">
                                        <option value="">Select City to Attend</option>
