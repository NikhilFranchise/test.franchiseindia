<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupfrobottomoctober.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupheadfrobengaluru.jpg") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
         ...
         <input type="hidden" value="Bengaluru September 2022" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2022 Bengaluru" name="event_title" id="event_title">  
         ...
         <!-- <option value="Sunday25thSeptember" selected="selected">Sunday, 25th  September </option> -->
                     <option value="Monday26thSeptember">Monday, 26th September  </option>
                     <option value="Bothdays2526September">Both days, 25th-26th September </option>
                  </select>
