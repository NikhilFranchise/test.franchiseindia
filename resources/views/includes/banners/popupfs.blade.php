<style type="text/css">
    ...
    .expo-header{ }
    .fi-bg-expo{height:534px; width:600px; margin:0 auto; background:url("https://www.franchiseindia.com/images/popup/fs-back.jpg") no-repeat center top;}
    ...
    .expo-bgcolor { padding: 5px 0;}
    .expo-bgcolor a { color: #333;}
    .expo-bgcolor a span{ color:#ED3338;}
</style>
@php
                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/franchise-show/" target="_blank">
                                <img src="https://www.franchiseindia.com/images/popup/fs-header.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form id="form1-stall" name="form1-stall" method="post" action="https://master.franchiseindia.com/fro/register_update_franchise_show.php" class="fro-expo-form">
                                ...
                                <div class="sec">
                                    <select id="city" value="Guwahati" name="eventdays" required>
                                        <option value="" selected="selected">Select City to Attend</option>

                                        <option value="Bengalurusaturday21stmarch">Bengaluru, Saturday, 21st March 2020</option>
                                        <option value="Chennaisunday22ndmarch">Chennai, Sunday, 22nd March 2020</option>
                                        <option value="Delhisunday22ndmarch">Delhi, Sunday, 22nd March 2020</option>
                                        <option value="Mumbaisunday29march">Mumbai, Sunday, 29 March 2020</option>
                                    </select>
                                </div>


                                <div class="sec">
                                    <input id="name" name="txtName" type="text" class="form-control" placeholder="Name *" required="">

                                </div>

                                <div class="sec">

                                    <input id="email" name="txtEmail" type="email"  pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" class="form-control" placeholder="Email *" required="">

                                </div>

                                <div class="sec">

                                    <input id="phone" name="txtPhone" type="tel" placeholder="Contact No. *" class="form-control"
                    ...
                    <div class="expo-bgcolor">
                        <span href="https://www.franchiseindia.com/franchise-show/" target="_blank">https://www.franchiseindia.com/<span>franchise-show/</span></a>
                    </div>
                </div>
            </div>
