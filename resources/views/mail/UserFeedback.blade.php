...
<tr>
    <td valign="top"><table width="100%" cellspacing="0" cellpadding="0">
        <tbody><tr>
          <td valign="top" class="td-business" style="padding:0px 76px 40px 76px; line-height:22px; text-align:center; font-size:18px; color:#666666;"><font face="Arial, Helvetica, sans-serif"><b style="color:#333;">"{{$name}}"</b> has given a feedback. The details are given below</font></td>
        </tr>
      </tbody></table></td>
  </tr>
<tr>
        <td valign="top" style="padding-bottom:60px;">
          <table width="89%" class="tbl-main" cellpadding="0" align="center" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666;text-align:left; border:1px solid #eaeaea; ">
              <tbody>
                ...
                <tr>
                <td width="25%" valign="top" class="td-name" style="background:#f4f4f4;padding:10px 0 10px 20px;">Address</td>
                <td width="5%" valign="top" class="td-dot" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
                <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;">{{$address}}</td>
                </tr>
                <tr>
                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                </tr>
                 ...
                 <tr>
                <td width="25%" valign="top" class="td-name" style="background:#f4f4f4;padding:10px 0 10px 20px;">Topic</td>
                <td width="5%" valign="top" class="td-dot" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
                <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;">{{$topic}}</td>
                </tr>
                <tr>
                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                </tr>
                 ...
                 <tr>
                <td width="25%" valign="top" class="td-name" style="background:#f4f4f4;padding:10px 0 10px 20px;">Feedback</td>
                <td width="5%" valign="top" class="td-dot" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
                <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;">{{$feedback}}</td>
                </tr>
                <tr>
                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                </tr>
