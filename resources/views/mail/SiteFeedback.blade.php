...
<tr>
    <td valign="top"><table width="100%" cellspacing="0" cellpadding="0">
        <tbody><tr>
          <td valign="top" class="td-business" style="padding:0px 76px 40px 76px; line-height:22px; text-align:center; font-size:18px; color:#666666;">
              &nbsp;
          </td>
        </tr>
      </tbody></table></td>
...
<tr>
    ...
    <tr>
    <td width="25%" valign="top" class="td-name" style="background:#f9f9f9;padding:10px 0px 10px 20px;">Topic</td>
    <td width="5%" valign="top" class="td-dot" style="background:#f9f9f9;padding:10px 20px 10px 0px;">:</td>
    <td width="70%" valign="top" class="td-value" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;">{{$feedbackTopic}}</td>
    </tr>
    <tr>
    <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
    </tr>
    ...
    <tr>
    <td width="25%" valign="top" class="td-name" style="background:#f4f4f4;padding:10px 0 10px 20px;">Site</td>
    <td width="5%" valign="top" class="td-dot" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
    <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;">{{$site}}</td>
    </tr>
    <tr>
    <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
    </tr>
