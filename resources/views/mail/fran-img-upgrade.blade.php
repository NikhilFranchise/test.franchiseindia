...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Franchisor Upgrade</title>
                ...
                <td valign="top" class="mt-tbl">
                  <table width="100%" class="tbl-mo" cellpadding="0" cellspacing="0">
                    <tbody>
                      ...
                      <tr>
                        <td width="25%" class="td-name" valign="top" style="background:#f4f4f4;padding:10px 0px 10px 20px;">Company Name</td>
                        <td width="5%" class="td-dot" valign="top" style="background:#f4f4f4;padding:10px 20px 10px 0px;">:</td>
                      ...
                      <tr><td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td></tr>
                      <tr>
                        <td width="25%" class="td-name" valign="top" style="background:#f9f9f9;padding:10px 0px 10px 20px;">Mobile</td>
                        <td width="5%" class="td-dot" valign="top" style="background:#f9f9f9;padding:10px 20px 10px 0px;">:</td>
                        <td width="70%" class="td-value" valign="top" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;">{{Auth::user()->mobile}}</td>
                      </tr>
                      <tr><td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td></tr>
                      <tr>
                      ...
                      <tr><td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td></tr>   
                      <tr>
                        <td width="25%" valign="top" class="td-name" style="background:#f9f9f9;padding:10px 0px 10px 20px;">Member Since</td>
                        <td width="5%" valign="top" class="td-dot" style="background:#f9f9f9;padding:10px 20px 10px 0px;">:</td>
                        <td width="70%" valign="top" class="td-value" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;">{{Auth::user()->created_at}}</td>
                      </tr>
                      <tr>
                        <td width="25%" valign="top" class="td-name" style="background:#f9f9f9;padding:10px 0px 10px 20px;">Membership Type</td>
                        <td width="5%" valign="top" class="td-dot" style="background:#f9f9f9;padding:10px 20px 10px 0px;">:</td>
                        <td width="70%" valign="top" class="td-value" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;">Free</td>
                      </tr>
                      <tr>
                        <td width="25%" valign="top" class="td-name" style="background:#f9f9f9;padding:10px 0px 10px 20px;">Time of trying to update</td>
                        <td width="5%" valign="top" class="td-dot" style="background:#f9f9f9;padding:10px 20px 10px 0px;">:</td>
                        <td width="70%" valign="top" class="td-value" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;">{{date('d-m-Y H:i:sa')}}</td>
                      </tr>
                    </tbody>
                  </table>
                </td>
