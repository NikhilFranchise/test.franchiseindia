...
@section('seoKeywords', 'best franchise, franchising, new business ideas, buy franchise, franchise information, small
    ...
    <div class="container articlesection">
        <div class="row row-no-margin">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 artimiddlepanel">
                <div class="artihaed">
                    <h1>Recent News</h1>
                    <a href="{{ Config('constants.MainDomain') }}/insightslatest" class="commanviewallBT">View All</a>
                </div>
                @php
                    ...
                    <div class="row marminleft bortop">
                        <div class="mohead">
                            Most Commented <a href="{{ Config('constants.MainDomain') }}/commented"
                                class="commanviewall">View All</a>
                        </div>
...
@else
    ...
    @endforeach -->
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 row-no-padding artirightpanel">
            ...
            <!--<div class="artihaed">Popular News <a href="{{ Config('constants.MainDomain') }}/popular" class="commanviewall">View All</a></div>-->
            <div class="artihaed">Popular News <a href="{{ Config('constants.MainDomain') }}/popular"
                    class="commanviewall">&nbsp;</a></div>
   ...
   --}}
    ...
    {{-- <div class="row row-no-margin adcebtbtm">
      ...
      @endtablet
      @mobile
      @include("includes.banners.dfp_300X250_Mid_3")
      @endmobile
   </div> --}}
    ...
    <div class="container mostpopu">
        <div class="row row-no-margin">
            <div class="col-xs-12 col-sm-9 col-md-9 paddingright50 responleft">
                <div class="topcat">More News</div>
                @php
                    $date = date_format($a, 'M, d Y');
                @endphp
                <div class="row mostw">
