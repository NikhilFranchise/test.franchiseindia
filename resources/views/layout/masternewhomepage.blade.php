...
<body>
    @php
        ...
        $engUrl = url('');
    @endphp
    @section('hindiUrl', $hindiUrl) @section('englishUrl', $engUrl)
        ...
        @if ($agent->isDesktop())
            ...
            <div id="content">
                ...
                <main class="main" id="main">
                    ...
                    {{-- @include('layout.newhomepage.upcomingevents') --}} @include('layout.newhomepage.videoevent')
    ...
    {{-- @mobile --}} @if ($agent->isMobile())
        <div id="content">
            @include('layout.newhomepage.mobile.header')
            <!-- HERO SECTION STARTS -->
            {{-- @include('layout.newhomepage.mobile.herosection') --}} @include('layout.newhomepage.mobile.herosectionwithsearch')
            <!-- HERO SECTION EMDS -->
            <main class="main" id="main">
                <!-- COVID PROOF BUSINESS OPPORTUNITIES START  -->
    ...
    @if (
        ...
        App\Http\Controllers\CommonController::checkCampaignUrl(); @endphp
            @if (
                $expoPopup == 1 &&
