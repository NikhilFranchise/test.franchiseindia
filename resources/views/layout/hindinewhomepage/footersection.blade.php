    ...
    <div class="container">
        <div class="row">
            <div class="modified-col col-xs-12 col-sm-12 col-md-12 col-xl-12
                           col-lg-12">
                <p class="section-th">व्यवसाय के अवसर
                </p>
            </div>
                    ...
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.indianretailer.com/">
                                <img src="{{url('newhomepage/assets/img/indianretailer.jpg')}}"
                                     class="img-b"
                                     alt="">
                            </a>
                        </div>
                    ...
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.restaurantindia.in/">
                                <img src="{{url('newhomepage/assets/img/restaurantindia.jpg')}}"
                                     class="img-b"
                                     alt="">
                            </a>
                        </div>
                    ...
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franchiseindia.com/wellness/">
                                <img src="{{url('newhomepage/assets/img/frachiseindia-wellness.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franchiseindia.com/education/">
                                <img src="{{url('newhomepage/assets/img/frachiseindia-education.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franchisenepal.com/">
                                <img src="{{url('newhomepage/assets/img/franchiseindia-nepal.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="http://www.franchisebangladesh.com/">
                                <img src="{{url('newhomepage/assets/img/frachiseindia-bangladesh.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.businessex.com/">
                                <img src="{{url('newhomepage/assets/img/businessex.jpg')}}" class="img-b"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.bradfordlicenseindia.com/">
                                <img src="{{url('newhomepage/assets/img/brandford.jpg')}}" class="img-b"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franchiseindia.net/">
                                <img src="{{url('newhomepage/assets/img/franchiseindia-exbition.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franchiseindia.in/">
                                <img src="{{url('newhomepage/assets/img/franchiseindia.jpg')}}"
                                     class="img-b"
                                     alt="">
                            </a>
                        </div>
                    ...
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.francorp.in/">
                                <img src="{{url('newhomepage/assets/img/fancorp.jpg')}}" class="img-b"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.franglobal.com/">
                                <img src="{{url('newhomepage/assets/img/fanglobal.jpg')}}" class="img-b"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="http://www.franchiseindiaventures.com/">
                                <img src="{{url('newhomepage/assets/img/franchiseindia-aventure.jpg')}}"
                                     class="img-b" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="modified-col col-xs-4 col-sm-4 col-md-4 col-xl-2
                        ...
                        <div class="our-group-site-main">
                            <a href="https://www.gauravmarya.com/">
                                <img src="{{url('newhomepage/assets/img/gauravmarya.jpg')}}" class="img-b"
                                     alt="">
                            </a>
                        </div>
                    </div>
