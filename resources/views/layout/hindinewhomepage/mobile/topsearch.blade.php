                    ...
                    <form method="get" action="{{ url('category/search') }}">
                        <div class="input-group
                            ...
                            <input type="text"
                                ...
                                name="text" placeholder="व्यवसाय के अवसरों के लिए खोज" id="dealer-bar-search"
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                 ...
                                 bhide-main bhide">
                                        ...
                                        <span class="clear">
                                            <a href="javascript:void(0)" onclick="catform.reset();">साफ करें</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                       ...
                                       form-group-search-section-li">
                                          ...
                                          form-control-search-main-custom"
                                                    ...
                                                    @foreach ($states as $index => $value)
                                                        <option slug="{{ strtolower(str_slug($value)) }}"
                                                            value="{{ $index }}"
                                 ...
                                 bhide-main bhide">
                                        ...
                                        <span class="clear">
                                            <a href="javascript:void(0)" onclick="locform.reset();">साफ करें</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                 ...
                                 bhide-main bhide">
                                        ...
                                        <span class="clear">
                                            <a href="javascript:void(0)" onclick="invform.reset();">साफ करें</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
