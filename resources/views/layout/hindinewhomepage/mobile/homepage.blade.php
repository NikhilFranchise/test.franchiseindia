                            ...
                            <div class="popfi">
                                ...
                                <div class="popleft">
                                    ...
                                    <ul class="socl">
                                        ...
                                        <li><a
                                                    href="https://www.franchiseindia.com/auth/google"><img src="{{url('newhomepage/assets/img/google.svg')}}" alt="google" class=""/></a></li>
                                    </ul>
                                </div>
...
<!-- Sidebar End -->
    ...
    <div id="content">
                        ...
                        <div class="d-flex">
                            <div class="p-2">
                                <div id="sidebarCollapse" class="menu-bar">
                                    <img src="{{url('newhomepage/assets/img/menu-icon.svg')}}" alt="menu-icon" />
                                    <!-- <span>Menu</span> -->
                                </div>
                            </div>
                            <div class="p-2 logo"> <a href="#"><img
                                            src="{{url('newhomepage/assets/img/Logo.svg')}}" alt="Franchise Logo"></a></div>
                            <div class="ml-auto d-flex">
                              ...
                              <img src="{{url('newhomepage/assets/img/Search.svg')}}" alt="Search">
                                ...
                                <span class="login-text-right text-right"
                                      data-toggle="modal" data-target="#login-pnl">
                              <img src="{{url('newhomepage/assets/img/Login.svg')}}" alt="Franchise Login">
                              </span>
                            </div>
                        </div>
                    </div>
        ...
        <main class="main" id="main">
                        ...
                        <div class="col-md-12">
                            <div class="brand-img-google">
                                <div class="brand-img-section">
                                    <a href="">
                                        <img src="./assets/img/Google-Ads-testmonial.jpg"
                                             class="" alt="Testimonial">
                                    </a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="brand-image-section-events">
                                            <div class="brand-main-section">
                                                <a href="http://www.globalfranchiseleaders.com/" target="_blank">
                                                    <img src="https://www.franchiseindia.com/images/events/gflfbg.jpg" class="img-fluid" alt="gflfbg">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                                        ...
                                        <div class="brand-image-section-events">
                                            <div class="brand-main-section">
                                                <a href="https://www.franchiseindia.com/franchise-show-south/" target="_blank">
                                                    <img src="https://www.franchiseindia.com/images/events/southfs.png" class="img-fluid" alt="img-fluid">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                                        ...
                                        <div class="brand-image-section-events">
                                            <div class="brand-main-section">
                                                <a href="https://www.franchiseindia.com/franchise-show-west/" target="_blank">
                                                    <img src="https://www.franchiseindia.com/images/events/westfs.png" class="img-fluid" alt="img-fluid">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
            ...
            <section class="top-international-opportunities section-30"
                                ...
                                <div class="swiper-slide-international-opportunities">
                                    ...
                                    #2cbee614;">
                                        ...
                                        <div class="card-body-section">
                                            ...
                                            <div class="link-section">
                                                <a href="#" style="color: #2fc0e4;
                                             border: 1px solid #4ac1e7;
                                             padding: 5px;
                                             border-radius: 4px;
                                             font-weight: 600;">Know More</a>
                                            </div>
                                            <div class="custom-tags-main">
                                                <ul class="custom-tags">
                                                    <li>
                                ...
                                <div class="swiper-slide-top-franchise-opportunities">
                                    ...
                                    <div class="card card-m card-p-10">
                                        <div class="brand-img">
                                            <div class="brand-img-section">
                                                <a href="">
                                                    <img src="https://www.franchiseindia.com/franchiseinternational/images/banners/homepage/engage_199x81.png" class="" alt="engage">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                                                    ...
                                                    <div class="d-flex author-section">
                                                        ...
                                                        <div class="author-info">
                                                            <ul class="author-share">
                                                                <li>
                                                                    <img src="./assets/img/facebookx2.png" alt="Facebook">
                                                                </li>
                                                                <li>
                                                                    <img src="./assets/img/twitterx2.png" alt="Twitter">
                                                                </li>
                                                                <li>
                                                                    <img src="./assets/img/linkedinx2.png" alt="Linkend">
                                                                </li>
                                                            </ul>
                                            ...
                                            <div class="news-min-section">
                                                <ul class="news-min-section-info">
                                                    <li>
                                                      ...
                                                      col-lg-4 col-xl-4">
                                                                <img src="./assets/img/min-post.jpg" class="img-z-fluid" alt="Min Post">
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-xs-4 col-sm-4 col-md-4
                                                      col-lg-4 col-xl-4">
                                                                <img src="./assets/img/min-post.jpg" class="img-z-fluid" alt="img fluid">
                                                            </div>
                                                            <div class="col-xs-8 col-sm-8 col-md-8
                                                      col-lg-8 col-xl-8">
                                                                <div class="post-news-text">
                                                ...
                                                <ul class="news-min-section-info">
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-xs-4 col-sm-4 col-md-4
                                                      col-lg-4 col-xl-4">
                                                                <img src="./assets/img/min-post.jpg" class="img-z-fluid" alt="img fliuid">
                                                            </div>
                                                            <div class="col-xs-8 col-sm-8 col-md-8
                                                      col-lg-8 col-xl-8">
                                                                <div class="post-news-text">
                            ...
                            <div id="testimonial-carousel" class="owl-carousel owl-arrow">
                                <div class="carousel-item-a">
                                    <div class="testimonial-main">
                                        <div class="testimonial-brand-section">
                                            <img src="./assets/img/brandlogo.jpg"
                                                 class="img-b-fluid" alt="img fluid">
                                        </div>
                                ...
                                <div class="carousel-item-a">
                                    <div class="testimonial-main">
                                        <div class="testimonial-brand-section">
                                            <img src="./assets/img/brandlogo.jpg"
                                                 class="img-b-fluid" alt="Brand Logo">
                                        </div>
                                        <div class="testimonial-brand-summury">
                                            <div class="open-quotes">
                                                <img src="./assets/img/open-qoutes.svg" alt="open-qoutes" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="main-newsletter">
                                <form action="">
                                    <ul class="newsletter">
                                        <li><input type="email" class="form-control
                                       emailer-main" placeholder="Enter Mail"
                                ...
                                <form action="">
                                    <ul class="newsletter-social">
                                        <li><a href="#"><img src="./assets/img/fb-icon.svg"
                                                             alt="facebook"></a></li>
                                        <li><a href="#"><img
                                                        src="./assets/img/instagram-icon.svg" alt="Instagram"></a></li>
                        ...
                        <div class="modified-col col-xs-6 col-sm-6
                           ...
                           col-lg-2">
                            <div class="footer-widget-link">
                                ...
                                <ul class="footer-links">
                                    <li><a
                                                href="https://www.franchiseindia.com/business-opportunities/automobile.sc443">Automobile</a></li>
                                    <li><a
                                                href="https://www.franchiseindia.com/business-opportunities/fmcg.sc476">FMCG</a></li>
                                    <li><a
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.entrepreneur.com/">
                                            <img src="./assets/img/entrepreneure-india.jpg"
                                                 class="img-b" alt="entrepreneure-india">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.indianretailer.com/">
                                            <img src="./assets/img/indianretailer.jpg"
                                                 class="img-b" alt="indianretailer">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.restaurantindia.in/">
                                            <img src="./assets/img/restaurantindia.jpg"
                                                 class="img-b" alt="restaurantindia">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franchiseindia.com/wellness/">
                                            <img src="./assets/img/frachiseindia-wellness.jpg"
                                                 class="img-b" alt="frachiseindia-wellness">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franchiseindia.com/education/">
                                            <img src="./assets/img/frachiseindia-education.jpg"
                                                 class="img-b" alt="frachiseindia-education">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franchisenepal.com/">
                                            <img src="./assets/img/franchiseindia-nepal.jpg"
                                                 class="img-b" alt="franchiseindia-nepal">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="http://www.franchisebangladesh.com/">
                                            <img src="./assets/img/frachiseindia-bangladesh.jpg"
                                                 class="img-b" alt="frachiseindia-bangladesh">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.bradfordlicenseindia.com/">
                                            <img src="./assets/img/brandford.jpg" class="img-b"
                                                 alt="brandford">
                                        </a>
                                    </div>
                                </div>
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franchiseindia.net/">
                                            <img src="./assets/img/franchiseindia-exbition.jpg"
                                                 class="img-b" alt="franchiseindia-exbition">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franchiseindia.in/">
                                            <img src="./assets/img/franchiseindia.jpg"
                                                 class="img-b" alt="franchiseindia">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.francorp.in/">
                                            <img src="./assets/img/fancorp.jpg" class="img-b"
                                                 alt="fancorp">
                                        </a>
                                    </div>
                                </div>
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="https://www.franglobal.com/">
                                            <img src="./assets/img/fanglobal.jpg" class="img-b"
                                                 alt="fanglobal">
                                        </a>
                                    </div>
                                </div>
                                 ...
                                 col-lg-2">
                                    <div class="our-group-site-main">
                                        <a href="http://www.franchiseindiaventures.com/">
                                            <img src="./assets/img/franchiseindia-aventure.jpg"
                                                 class="img-b" alt="franchiseindia-aventure">
                                        </a>
                                    </div>
                                </div>
                                <div class="modified-col col-xs-4 col-sm-4
                            ...
                            <div class="modified-col col-md-12">
                                <div class="brows-by-location">
                                    <ul class="fihl-loaction-browse">
                                        <li> <a
                                                    href="https://www.franchiseindia.com/business-opportunities/maharashtra.LOC18">Maharashtra</a></li>
                                        <li> <a
                                                    href="https://www.franchiseindia.com/business-opportunities/delhi.LOC23">Delhi</a>
                                        </li>
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/karnataka.LOC14">Karnataka</a></li>
                                        <li><a
                                        ...
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/gujarat.LOC9">Gujarat</a></li>
                                        <li><a
                                        ...
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/haryana.LOC10">Haryana</a></li>
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/rajasthan.LOC27">Rajasthan</a></li>
                                        <li> <a
                                                    href="https://www.franchiseindia.com/business-opportunities/andhra-pradesh.LOC1">Andhra
                                                Pradesh</a>
                                        </li>
                                        <li> <a
                                                    href="https://www.franchiseindia.com/business-opportunities/kerala.LOC15">Kerala</a></li>
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/punjab.LOC26">Punjab</a></li>
                                        <li><a
                                                    href="https://www.franchiseindia.com/business-opportunities/chandigarh.LOC5">Chandigarh</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<script
        src="{{url('newhomepage/assets/vendor/mCustomScrollbar/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<!-- Font Awesome JS -->
