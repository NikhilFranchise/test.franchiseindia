<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fro-south-btm.jpg") no-repeat center top;
    }
    ...
    .headtag {
        ...
        overflow: hidden;
        width: 600px;
        background: url("https://www.franchiseindia.com/images/popup/fro-south-top.jpg") no-repeat center top;
        overflow: hidden;
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            <form class="form registration-form align-center"
                                action="https://master.franchiseindia.com/fro/register_update_franchise_show.php"
                                method="post">
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <input name="txtPhone" type="tel" placeholder="Contact" class="form-control"
                                            pattern="[56789][0-9]{9}" minlength="10" maxlength="10"
                                            onkeypress="return isNumber(event)" required="">
                                    </div>
                                    <div class="f3">
                                        <select type="text" placeholder="No. of Visitors" id="eventdays"
                                            name="event_year" class="form-control myselectclass3" accesskey=""
                                            onChange="checkNumbers();">




                                            <option value="West India, 01 November 2020">West India, Sunday, 01st
                                                November 2020</option>
                                            <option value="South India, 07 November 2020">South India, Saturday, 07th
                                                November 2020</option>
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <select name="txtState" onchange="getcitypopup(this)" class="form-control"
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <select class="form-control blur" id="investment_range_gallery"
                                    ...
                                    <div class="f3">
                                        <select name="industry_type" id="industry_type" required="required"
                                            ...
                                            <option value="Medical &amp; Distributors">Medical &amp; Healthcare
                                            </option>


                                            <option value="Dealers &amp; Distributors">Dealers &amp; Distributors
                                            </option>
                                            ...
                                            <option value="Sports, Fitness &amp; Entertainment">Sports, Fitness &amp;
                                                Entertainment</option>
                                            <option value="Hotel, Travel &amp; Tourism">Hotel, Travel &amp; Tourism
                                            </option>
                                ...
                                <div class="sec" style="text-align:center">
                                    <input type="submit" value="Get Your Entry Pass" name="btnSubmitReg"
