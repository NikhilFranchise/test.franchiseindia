                        ...
                        <div class="p-30 d-flex">
                            <div class="p-2">
                                <ul class="top-navigation">
                                    <li>
                                        <a href="https://www.licenseindia.com/" target="_blank">ब्रांड लाइसेंस
                                            खरीदें</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="https://www.franchiseindia.com/property-loan/" target="_blank">संपत्ती
                                            के बदले कर्ज </a>
                                    </li>
                                          ...
                                          input-group-custom">
                                            <span
                                             ...
                                             input-group-prepend-custom"
                                                id="basic-addon1">
                                                <img src="{{ url('newhomepage/assets/img/language-icon.svg') }}"
                                                    alt="language-icon">
                                            </span>
                    ...
                    <div class="col-md-12">
                        <div class="d-flex p-30">
                            ...
                            <div class="logo"> <a href="{{ url('') }}"><img
                                        src="{{ url('newhomepage/assets/img/Logo.svg') }}" alt="@yield('seoTitle', 'Franchise India - Business Opportunities, Franchise Opportunities')"
                                        title="@yield('seoTitle', 'Franchise India - Business Opportunities, Franchise Opportunities')"></a>
                            ...
                            <div class="d-flex">
                                ...
                                <span
                                    class="login-text-right text-right
                                          d-main">
                                    <span>
                    ...
                    <div class="col-md-12">
                        <div class="p-30 d-flex">
                            <div class="p-2">
                                <ul class="top-navigation">
                                    <li>
                                        <a href="https://www.licenseindia.com/" target="_blank"> Buy a Brand
                                            License</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#" target="_blank" data-toggle="modal"
                                            data-target="#expandFranchisenew">Expand Your Franchise</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="https://www.franchiseindia.com/property-loan/" target="_blank">Loan
                                            Against Property </a>
                                    </li>
                                    <li class="top-investors">
                                        <div class="dropdown policydropdown">
                                            <button class="btn dropdown-toggle" type="button" id="btnDropdownDemo"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                style="">Investor <i class="fa fa-caret-down"></i></button>
                                            <div class="dropdown-menu policydropdownmenu"
                                                aria-labelledby="btnDropdownDemo">
                                                <a class="dropdown-item"
