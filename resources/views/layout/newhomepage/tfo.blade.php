        ...
        <div class="row justify-content-center">
            <div class="modified-col col-md-12">
                <div class="section-ptb">
                    <h2>{{ (Request::segment(1) == 'hi') ? 'शीर्ष फ्रैंचाइज़ अवसर' : 'Top Franchise Opportunities' }}</h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <ul class="top-franchise">
                    ...
                    $logoDetail['brand_category'])).".m". $logoDetail['brand_category_id']; @endphp
                        ...
                        <div class="card card-m card-p-10">
                            <div class="brand-md-image-section">
                                <div class="brand-main-section">
                                    <a href="{{ $brandUrl }}" target="_blank"><img src="{{$logoDetail['brand_img']}}" alt="{{$logoDetail['brand_alt']}}" class="img-b img-border" /></a>
                                </div>
                            </div>
                            <div class="card-body-section">
                                ...
                                <div class="link-section">
                                    <a href="{{ $brandUrl }}" target="_blank">{{ (Request::segment(1) == 'hi') ? 'अधिक जानिए' : 'Know More'}}</a>
                                </div>
                            </div>
                        </div>
                    </li>
