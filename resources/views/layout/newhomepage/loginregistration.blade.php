...
<script>
   function checkInputType() {
       var input = document.getElementById('email_or_mobile').value;
       var isEmail = validateEmail(input);
       var passwordGroup = document.getElementById('password_group');
       var getOtpBtn = document.getElementById('get_otp_btn');
   ...
   function validateMobile(mobile) {
       var re = /^\d{10}$/; // Adjust this regex according to your mobile number validation
