                    ...
                    <div class="topright">
                        <ul class="togl">
                            ...
                            <li @if (App::getLocale() == 'en') class="active" @endif><a
                                    href="{{ url('/crre') }}">English</a></li>
                            <li @if (App::getLocale() == 'hi') class="active" @endif><a
                                    href="{{ url('/crre/hindi') }}">Hindi</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 d-flex align-items-center">
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="categoryList">
                                        @php
                                            $categories = \App\Http\Controllers\Crre\CrreController::insightcategory(
                                                $locale,
                                            );
                                            $specificCategories = \App\Http\Controllers\Crre\CrreController::specificCategories(
                                                $locale,
                                            );
                                        @endphp
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="">
                                        <a class="dropdown-item"
                                            href="{{ $categoryUrlPrefix }}toparticles">{{ $ArticleLabel }}</a>
                                        <a class="dropdown-item"
                    ...
                    <div class="search-main mx-auto">
                        ...
                        <div id="searchbar" style="display: none;">
                            <form action="{{ url('/crre/' . $locale . '/search') }}" method="get">
