...
<div class="newheader hindiver" id="headsticknew">
    ...
    <div class="newstickly">
        <div class="headerblack {{ request()->segment(1) == 'restaurant' ? 'ri' : '' }}">
            <div class="container">
                <div class="navb"><span id="c-button--slide-left"><img src="{{ url('images/' . $menuicon) }}"
                            alt="icon"></span></div>
                <div class="{{ $logoClass }}"><a href="{{ Config('constants.MainDomain') }}/{{ $mainUrl }}"><img
                            src="{{ url('images/' . $logo) }}" alt="logo"></a></div>
                <div class="headrightblk">
                    <div class="searchfixrightblk">
                        <div class="searchspace">
                            <ul class="headersublink">
                                <li><a href="{{ Config('constants.MainDomain') }}/hi/content">फ्रैंचाइज़ी इनसाइट्स</a>
                                </li>
                                <li><a href="https://news.franchiseindia.com/hi">समाचार</a></li>
                                <li><a href="https://video.franchiseindia.com/">वीडियो</a></li>
                                <li><a href="https://www.businessex.com/" target="_blank"
                                        class="highlightlink"><strong>सेल योर बिज़नेस</strong></a></li>
                                <li><a href="https://www.licenseindia.com/" target="_blank"
                                        class="highlightlink"><strong>बाय ए ब्रांड लइसेंस</strong></a></li>
                                <li><a href="https://www.franchiseindia.com/event">इवेंट्स</a></li>
                            </ul>
                            <div class="headarticle sublinkdropsearch">
                                <span id="searchoptnew"><img src="{{ url('images/searchicon-black.png') }}"
                        ...
                        <div class="searchblknew" style="display:none;">
                            <div class="searchblkclk">
                                ...
                                <div class="hidesub" id="closegsearch"><img src="{{ url('images/crosssearch.png') }}"
                                        alt="cross search"></div>
                            </div>
                        </div>
                        <!--google search end -->
                    </div>
                    ...
                    <div class="headarticle sublinkdrop2">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" type="button" data-toggle="dropdown">पूर्ण भारत<i
                                    class="fa fa-angle-down fa-lg"></i></a>
                            <div class="dropdown-menu">
                                <ul class="all-city-link">
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/andhra-pradesh.LOC1">आंध्र
                                            प्रदेश</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/andaman-and-nicobar.LOC35">अंडमान
                                            और निकोबार</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/arunachal-pradesh.LOC2">अरुणाचल
                                            प्रदेश</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/assam.LOC3">असम</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/bihar.LOC4">बिहार</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/chandigarh.LOC5">चंडीगढ़</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/chhattisgarh.LOC6">छत्तीसगढ़</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/daman-and-diu.LOC7">दमन
                                            और दीव</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/goa.LOC8">गोवा</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/gujarat.LOC9">गुजरात</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/haryana.LOC10">हरियाणा</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/himachal-pradesh.LOC11">हिमाचल
                                            प्रदेश</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/jammu-and-kashmir.LOC12">जम्मू
                                            और कश्मीर</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/jharkhand.LOC13">झारखंड</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/karnataka.LOC14">कर्नाटक</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/kerala.LOC15">केरल</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/lakshadweep.LOC16">लक्षद्वीप</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/madhya-pradesh.LOC17">मध्य
                                            प्रदेश</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/maharashtra.LOC18">महाराष्ट्र</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/manipur.LOC19">मणिपुर</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/meghalaya.LOC20">मेघालय</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/mizoram.LOC21">मिजोरम</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/nagaland.LOC22">नागालैंड</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/delhi.LOC23">दिल्ली</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/orissa.LOC24">उड़ीसा</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/pondicherry.LOC25">पुडुचेरी</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/punjab.LOC26">पंजाब</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/rajasthan.LOC27">राजस्थान</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/sikkim.LOC28">सिक्किम</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/tamilnadu.LOC29">तमिलनाडु</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/telangana.LOC34">तेलंगाना</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/tripura.LOC30">त्रिपुरा</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/uttaranchal.LOC31">उत्तराखंड</a>
                                    </li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/uttar-pradesh.LOC32">उत्तर
                                            प्रदेश</a></li>
                                    <li><a
                                            href="{{ Config('constants.MainDomain') }}/business-opportunities/west-bengal.LOC33">पश्चिम
                                            बंगाल</a></li>
                                </ul>
                    ...
                    <div class="headarticle sublinkdrop">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" type="button" data-toggle="dropdown">हमारी
                                वेबसाइट<i class="fa fa-angle-down fa-lg"></i></a>
                            <ul class="dropdown-menu website">
                                <li {{ $dotUrlSelected }}><a href="https://www.franchiseindia.com" rel="nofollow"
                                        class="dotcom"></a></li>
                                <li><a target="_blank" href="https://retail.franchiseindia.com" rel="nofollow"
                                        class="irin"></a></li>
                                <li><a target="_blank" href="http://www.entrepreneur.com" rel="nofollow"
                                        class="entin"></a></li>
                                <li {{ $resUrlSelected }}><a href="https://www.franchiseindia.com/restaurant"
                                        class="riin"></a></li>
                                <li {{ $wellUrlSelected }}><a href="https://www.franchiseindia.com/wellness"
                                        class="wiin"></a></li>
                                <li {{ $eduUrlSelected }}><a href="https://www.franchiseindia.com/education"
                                        class="eiin"></a></li>
                    ...
                    @if ($__env->yieldContent('hindiUrl'))
                        ...
                        <div class="mainrighthindi" id="changeLang1">
                            <div class="rigarthindi">अ / A <i class="fa fa-chevron-down" aria-hidden="true"></i>
                            </div>
        ...
        <div class="headerbright">
            <div class="container">
                <div class="hotlineblk">
                    ...
                    <ul class="social">
                        <li><a href="https://www.facebook.com/FranchiseIndiaMedia" target="_blank"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li><a href="http://twitter.com/FranchiseIndia" target="_blank"><i
                                    class="fa fa-twitter"></i></a></li>
                        <li><a href="http://www.linkedin.com/company/102548?trk=tyah" target="_blank"><i
                                    class="fa fa-linkedin"></i></a></li>
                        <li><a href="http://www.youtube.com/user/FranchiseIndia" target="_blank"><i
                ...
                <div class="searchright">
                    ...
                    <ul class="advertliks">
                        ...
                        <li><a href="https://master.franchiseindia.com/emagazine/" target="_blank">सदस्यता लें</a>
                        </li>
                    </ul>
                    ...
                    <div class="sear" id="searchblk">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="{{ $catTab }}"><a href="#categories" aria-controls="categories"
                                    role="tab" data-toggle="tab">केटेगरी</a></li>
                            <li class="{{ $locTab }}"><a href="#location" aria-controls="location"
                                    role="tab" data-toggle="tab">स्थान</a></li>
                            <li class="{{ $invTab }}"><a href="#investment" aria-controls="investment"
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane {{ $catTab }}" id="categories">
                                <form class="form-horizontal" method="get"
                                    action="{{ Config('constants.MainDomain') }}/hi/category/searchby"
                                    onsubmit="return submitCategory()">
                                    <input type="hidden" name="catTab" value="1">
                                    <ul class="searblk">
                                        <li>
                                            <select name="mc" class="form-control myselectclasssearch"
                                                id="getMainCategoryDataHeader" required
                                        ...
                                        <li>
                                            <select class="form-control myselectclasssearch" name="sc"
                                                id="getSubCategoryDataHeader"
                                                onchange="getSubCatCategoryHeader(this.value);">
                                                <option value="">क्षेत्र का चयन करें</option>
                                                @if (!empty($subCat))
                                                    @foreach ($subCat as $index => $value)
                                                        <option
                                                            slug="{{ Config('category.SeoSubCategoryArr.' . $index) }}"
                                                            value="{{ $index }}"
                                                            @if (isset($sc) && $index == $sc) selected @endif>
                                                            {!! $value !!}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <li class="rdi">
                                            <select name="ssc" id="getSubCatCategoryDataHeader"
                                                class="form-control myselectclasssearch">
                                                <option value="">सेवा / उत्पाद का चयन करें</option>
                                                @if (isset($subSubcat) && isset($ssc))
                                                    @foreach ($subSubcat as $index => $value)
                                                        <option
                                                            slug="{{ Config('category.SeoSubSubCategoryArr.' . $index) }}"
                                                            value="{{ $index }}"
                                                            @if ($index == $ssc) selected @endif>
                                                            {!! $value !!}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <li>
                                            <button type="submit" class="btn btn-default"><i class="fa fa-search"
                                                    ...
                                                    class="searchmhide">Search</span></button>
                                        </li>
                                    </ul>
                                </form>
                            </div>
                            <div role="tabpanel" class="tab-pane {{ $locTab }}" id="location">
                                <form class="form-horizontal" method="get"
                                    action="{{ Config('constants.MainDomain') }}/hi/category/searchby"
                                    onsubmit="return submitLocation()">
                                    <input type="hidden" name="locTab" value="1">
                                    <ul class="searblk">
                                        <li>
                                            <select name="mc" id="getMainCategoryDataHeaderLoc"
                                                class="form-control myselectclasssearch">
                                        ...
                                        <li>
                                            <select name="loc" id="stateHeader"
                                                class="form-control myselectclasssearch" required
                                                onchange="getcity(this.value)">
                                                <option value="">एक राज्य का चयन करे</option>
                                                @foreach ($states as $index => $value)
                                                    <option slug="{{ strtolower(Str::slug($value)) }}"
                                                        value="{{ $index }}"
                                                        @if (isset($loc[0]) && $loc[0] == $index) selected @endif>
                                                        {{ Config('location.hindiStatesArr.' . $value) }}</option>
                                                @endforeach
                                            </select>
                                        </li>
                                        <li class="rdi">
                                            <select name="city" class="form-control myselectclasssearch"
                                                id="headercity">
                                                <option value="">एक शहर का चयन करें</option>
                                                @if (isset($cities))
                                                    @foreach ($cities as $value)
                                                        <option value="{!! $value !!}"
                                                            @if (!empty($city) && $city == $value) selected @endif>
                                                            {!! $value !!} </option>
                                                    @endforeach
                                                @endif
                                            </select>
                            ...
                            <div role="tabpanel" class="tab-pane {{ $invTab }}" id="investment">
                                <form class="form-horizontal" method="get"
                                    action="{{ Config('constants.MainDomain') }}/hi/category/searchby"
                                    onsubmit="return submitInvestment()">
                                    <input type="hidden" name="invTab" value="1">
                                    <ul class="searblk">
                                        <li>
                                            <select name="mc" id="getMainCategoryDataHeaderInv"
                                                class="form-control myselectclasssearch" title="mainCat">
                                                <option value="">उद्योग का चयन करें</option>
                                                @foreach ($catArr as $index => $value)
                                                    <option value="{{ $index }}"
                                                        slug="{{ Config('category.SeoCategoryArr.' . $index) }}"
                                        ...
                                        <li>
                                            <select name="min_cost" class="form-control myselectclasssearch"
                                                id="minAmount" required onchange="selectMax(this.value)">
                                        ...
                                        <li class="rdi">
                                            <select name="max_cost" class="form-control myselectclasssearch"
                                                id="maxAmount">
                                                <option value=""> अधिकतम निवेश का चयन करें </option>
                                                @foreach (Config('constants.investRangeInWordsSingle') as $index => $value)
                                                    <option
                                                        slug="{{ Config('constants.InvestRange')[$index]['min'] }}"
                                                        @if (isset($maxCost)) @if ($maxCost == $index) selected @endif
                                                        @endif
                                                        value="{{ $index }}">{{ $value == 21 ? 'above' : $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </li>
                        ...
                        <ul class="righlink">
                            ...
                            @if ($auth::check())
                                <li class="hidedesktopmenu"><span id="c-button--slide-right"
                                        class="btn btn-default myaccount {{ $class }}">मेरा खाता</span></li>
                            ...
                            @if (!$auth::check())
                                <li class="hidedesktopmenu"><a href="{{ $regUrl }}" {{ $modelWindow }}
                                        class="btn btn-default {{ $class }}" id="mobilereg">रजिस्टर</a></li>
                                ...
                                <div class="frm-pnl">
                                    <div style="text-align: center;">
                                        <div><a href="{{ Config('constants.MainDomain') }}/investor/create"
                                                class="btn btn-large btn-default btn-gry btn-prop"> आज एक बिजनेस शुरू
                                                करें <span>(निवेशक पंजीकरण) </span> </a></div>
                                        <br>
                                        <div><a href="{{ Config('constants.MainDomain') }}/franchisor/registration/step/1"
                                                class="btn btn-large btn-default btn-gry btn-prop">चैनल पार्टनर नियुक्त
                                                करें <span> (फ़्रैंचाइज़र पंजीकरण) </span></a></div>
                                        <br>
                                        <div><a href="{{ Config('constants.MainDomain') }}/franchisor/international-registration"
                                                class="btn btn-large btn-default btn-gry btn-prop">चैनल पार्टनर नियुक्त
                                                करें <span> (अंतरराष्ट्रीय फ़्रैंचाइज़र पंजीकरण) </span></a></div>
                                    </div>
                                </div>
                            </form>
