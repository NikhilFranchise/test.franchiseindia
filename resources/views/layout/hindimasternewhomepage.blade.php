...
<body>
    ...
    @php
        $TopInternationalOpportunities = [
            ...
            '1' => [
                ...
                'image' =>
                    'https://www.franchiseindia.com/franchiseinternational/images/banners/homepage/fatburger_tbo_gold.gif',
            ...
            '2' => [
                ...
                'image' =>
                    'https://www.franchiseindia.com/franchiseinternational/images/banners/homepage/oldtown_tbo_gold.gif',
                'category' => 'Ice Cream Chain',
                'title' => 'Potato Hut',
        ...
        @notmobile
            ...
            <div id="content">
                ...
                <main class="main" id="main">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                                        <div class="business-a">
                                                            <a href="{{ url('investor/create') }}">
                                                                आज एक व्यवसाय शुरू करें <span class="smallimp">(निवेशक
                                                                    पंजीकरण)</span>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                                        <div class="business-a">
                                                            <a href="{{ url('franchisor/registration/step/1') }}">
                                                                चैनल पार्टनर नियुक्त करें <span
                                                                    class="smallimp">(फ्रैंचाइज़ी
                                                                    पंजीकरण)</span>
                                                                <i class="fas fa-chevron-right float-right
                                                icon-bar-main-fihl"
                                                                    aria-hidden="true"></i>
                                                    ...
                                                    <div class="col-md-12 pt-30">
                                                        ...
                                                        10000+ से अधिक फ्रैंचाइज़ी व्यापार करने के लिए पहुँच प्राप्त
                                                        करने के लिए
                                                        अवसर।<br><br>
                                                ...
                                                <div class="form-ask-experts">
                                                    ...
                                                    <form id="homepage" name="homepage" method="post">
                                                                ...
                                                                <li>
                                                                    <div class="radio">
                                                                        <label><input type="radio" name="optionsRadios"
                                                                                id="optionsRadios3" checked
                                                                                value="franchisor"> मेरा ब्रांड का
                                                                            विस्तार करें </label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="input-group mb-15">
                                                            ...
                                                            <input type="email" class="form-control blur"
                                                                required="" name="emailfreeadvice"
                                                        ...
                                                        <div class="input-group mb-15">
                                                            ...
                                                            <input type="text" class="form-control blur"
                                                                maxlength="10" name="mobilefreeadvice"
                                                                id="mobilefreeadvice" placeholder="मोबाइल नंबर दर्ज करें"
                                                                required="">
                                                        </div>
                    ...
                    <section class="bg-sectionwize covidproof section-30" id="covidproof">
                        <div class="container">
                            <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                                @php
                                    $pageType =
                                        request()->segment(1) == 'premiumbrand' ||
                                        request()->segment(2) == 'premiumbrand'
                                            ? 2
                                            : 1;
                                @endphp
                                @foreach ($brands->where('brand_section', 2)->where('page_type', $pageType)->take(4)->shuffle() as $logoDetail)
                                    @php
                                        ...
                                        if (
                                            ...
                                            $brandUrl =
                                                Config('constants.MainDomain') . '/hi' . $logoDetail['brand_link'];
                                        }
                                    @endphp
                                    <div
                                        class="modified-col col-xs-6 col-sm-6 col-md-3 col-lg-3
                           col-xl-3">
                                        ...
                                        <div class="card card-m card-p-10">
                                            <div class="brand-image-section">
                                                <div class="brand-main-section">
                                                    <a href="{{ $brandUrl }}" target="_blank"><img
                                                            ...
                                                            alt="Top Business Opportunities"></a>
                                                </div>
                                            </div>
                                            <div class="card-body-section">
                                                ...
                                                <h2><a href="{{ $brandUrl }}"
                                                        target="_blank">{{ $logoDetail['brand_heading'] }} </a></h2>
                                                <div class="d-flex">
                                                    <div class="card-info">
                                                        निवेश सीमा
                                                    </div>
                                            ...
                                            <div class="brand-main-section">
                                                <a href="http://www.globalfranchiseleaders.com/" target="_blank">
                                                    <img src="https://www.franchiseindia.com/images/events/gflfbg.jpg"
                                                        class="img-fluid" alt="Global Franchise Leaders">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                                            ...
                                            <div class="brand-main-section">
                                                <a href="https://www.franchiseindia.com/franchise-show-west/"
                                                    ...
                                                    <img src="https://www.franchiseindia.com/images/events/westfs.png"
                                                        class="img-fluid" alt="Franchise Show West">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                                            ...
                                            <div class="brand-main-section">
                                                <a href="https://www.franchiseindia.com/franchise-show-south/"
                                                    ...
                                                    <img src="https://www.franchiseindia.com/images/events/southfs.png"
                                                        class="img-fluid" alt="Franchise Show South">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body-section">
                           ...
                           col-xl-3">
                                            ...
                                            <div class="card card-m card-p-10">
                                                ...
                                                <div class="card-body-section">
                                                    ...
                                                    <h2><a href="{{ $brandUrl }}"
                                                            target="_blank">{{ $logoDetail['brand_heading'] }} </a>
                                                    </h2>
                                                    <div class="d-flex">
                                                        <div class="card-info">
                                                            निवेश सीमा
         ...
         section-30"
                        id="top-international-opportunities">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="modified-col col-md-12">
                                    <div class="section-ptb">
                  ...
                  col-xl-3">
                                ...
                                {{ $top['bgcolor'] }}4f;">
                                            <div class="brand-image-section">
                                                <div class="brand-main-section">
                                                    <a href="{{ $top['url'] }}"> <img src="{{ $top['image'] }}"
                            ...
                            <div id='adslot970x90_ATF' class="img-b ads-main-center">
                                <script>
                                    googletag.cmd.push(function() {
                                        googletag.display('adslot970x90_ATF');
                                    });
                                </script>
                            </div>
                        </div>
                           ...
                           col-xl-2 mt-2 mb-2">
                                ...
                                <div class="card-fihl card-m card-p-10">
                                    <div class="brand-ffc-image-section">
                                        <div class="brand-main-section">
                                            <a href="{{ $brandUrl }}"><img src="{{ $logoDetail['brand_img'] }}"
                                                    alt="Featured Franchise Companies"
                                                    class="img-b
                                       img-border"></a>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="modified-col col-md-12">
                            ...
                            <div id='adslot970x90_Mid_1' class="img-b ads-main-center">
                                <script>
                                    googletag.cmd.push(function() {
                                        googletag.display('adslot970x90_Mid_1');
                                    });
                                </script>
                            </div>
                        </div>
                                ...
                                @foreach ($articles as $article)
                                    @php
                                        ...
                                        $imagePath =
                                            ...
                                            str_replace('uploads/content/', 'uploads/thumbnails/', $article['image']);
                                        $kickerUrl = '/content/' . $article['urlKicker'];
                                        $articleUrl =
                                            '/' . $siteType . '/' . $article['slug'] . '.' . $article['content_id'];
                                        if ($siteType == 'gallery') {
                                            $sourcePhoto = public_path($article['image']);
                                            $imagename = pathinfo($sourcePhoto)['basename'];
                                            $imagePath =
                                                Config('constants.MainDomain') . '/uploads/thumbnails/ga/' . $imagename;
                                            $kickerUrl =
                                                '/gallery/' .
                                                   ...
                                                   author-section">
                                                        <div class="author-info">
                                                            <ul class="author-share">
                                                                <li>
                                                                    <a
                                                                        href="http://www.facebook.com/sharer.php?u={{ url($articless[0]['url']) }}">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="https://twitter.com/share?url={{ url($articless[0]['url']) }}">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="http://www.linkedin.com/shareArticle?mini=true&url={{ url($articless[0]['url']) }}">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="author-info">
                                                            <ul class="author-share">
                                                                <li>
                                                                    <a
                                                                        href="http://www.facebook.com/sharer.php?u={{ url($news[0]['url']) }}">
                                                                        <img src="{{ url('newhomepage/assets/img/facebookx2.png') }}"
                                                                            alt="Facebook">
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="https://twitter.com/share?url={{ url($news[0]['url']) }}">
                                                                        <img src="{{ url('newhomepage/assets/img/twitterx2.png') }}"
                                                                            alt="twitter">
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="http://www.linkedin.com/shareArticle?mini=true&url={{ url($news[0]['url']) }}">
                                                                        <img src="{{ url('newhomepage/assets/img/linkedinx2.png') }}"
                                                                            alt="linkedin">
                                                                    </a>
                                                                </li>
                                                        ...
                                                        <div class="author-info-main">
                                                            <a
                                                                href="{{ $news[0]['url'] }}">-{{ $news[0]['auther'] }}<br>समाचार</a>
                                                            संपादक
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="testimonial-main">
                                            ...
                                            <div class="testimonial-brand-summury">
                                                <div class="open-quotes">
                                                    <img src="{{ url('newhomepage/assets/img/open-qoutes.svg') }}"
                                                        alt="quotes-open">
                                                </div>
                                                <p> We partnered with FranchiseIndia.com to scale our business and it
                                                    has been a great experience. With their zeal to actually take out
                                                    time for their clients and understand their business needs, they
                                                    were able to generate the best leads for us. The team at
                                                    FranchiseIndia.com is also quick to respond to your queries and
                                                    their service is impeccable.</p>
                                                <div class="textimonial-brand-section">
                                                    REMAX INDIA
                                                </div>
                                                <div class="close-quotes">
                                                    <img src="{{ url('newhomepage/assets/img/close-quotes.svg') }}"
                                                        alt="quotes-close">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-main">
                                            ...
                                            <div class="testimonial-brand-summury">
                                                ...
                                                <p> It is indeed an ideal platform to expand any brand PAN India. Our
                                                    long association has helped us to grow our network & establish 270
                                                    outlets in 98 cities"</p>
                                                <div class="textimonial-brand-section">
                                                    Ferns N Petals
                                                </div>
                                                <div class="close-quotes">
                                                    <img src="{{ url('newhomepahe/assets/img/close-quotes.svg') }}"
                                                        alt="quotes-close">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-main">
                                            ...
                                            <div class="testimonial-brand-summury">
                                                ...
                                                <p> As a trusted Trade magazine Franchise India is great tool to spread
                                                    your message to the Franchise Community and our experience in this
                                                    effort has been excellent with the magazine</p>
                                                <div class="textimonial-brand-section">
                                                    Liberty Shoes Ltd
                                                </div>
                                                <div class="close-quotes">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-main">
                                            ...
                                            <div class="testimonial-brand-summury">
                                                ...
                                                <p> We have been using Franchise India website services for a very long
                                                    time. And we have been able to create some very successful
                                                    franchisee partners. The quality and flow of leads is really very
                                                    good. Our association with Franchise India has been a great
                                                    experience and we will not only continue this relationship but also
                                                    recommend others to take their expert services and advisory.</p>
                                                <div class="textimonial-brand-section">
                        ...
                        <div class="modified-col col-md-4">
                            <div class="testimonial-ads-section">
                                ...
                                <div id='adslot300x250' class="img-b ads-main-center">
                                    <script>
                                        googletag.cmd.push(function() {
                                            googletag.display('adslot300x250');
                                        });
                                    </script>
                                </div>
                            </div>
                            ...
                            <div class="main-newsletter">
                                <form id="update" method="post" action="{{ url('newslettersignup') }}">
                                    <ul class="newsletter">
                                        ...
                                        <li><button class="btn btn-main" type="submit" id="button-addon2">साइन
                                                अप</button></li>
                                    </ul>
                                </form>
                            </div>
                                ...
                                <form action="">
                                    <ul class="newsletter-social">
                                        <li><a href="https://www.facebook.com/FranchiseIndiaMedia" target="_blank"><img
                                                    src="{{ url('newhomepage/assets/img/fb-icon.svg') }}"
                                                    alt="facebook"></a></li>
                                        <li><a href="https://www.instagram.com/franchiseindia_/" target="_blank"><img
                                                    src="{{ url('newhomepage/assets/img/instagram-icon.svg') }}"
                                                    alt="Instagram"></a></li>
                    ...
                    <div class="row justify-content-center">
                        <div class="modified-col col-md-12">
                            ...
                            <div class="about-text-section">
                                ...
                                कंपनी के तत्वावधान में, वेबसाइट उद्यमियों को फ्रैंचाइज़िंग, मताधिकार के अवसरों, व्यवसाय
                                के अवसरों, भागीदारी, डीलरों, विनिर्माण, वितरण, खुदरा और बहुत कुछ के पहलुओं पर हर मिनट का
                                विवरण प्रदान करती है। फ्रेंचाइज़िंग में दुनिया के नेता होने के नाते, निवेशक और
                                फ्रेंचाइज़र हमेशा समृद्ध, सक्षम और लाखों फलदायी लीड्स और बिक्री के लिए
                                Franchiseindia.com पर भरोसा कर सकते हैं। वेबसाइट फ्रेंचाइज़र, स्टार्ट-अप्स, फ्रेंचाइजी,
                                डीलर्स, डिस्ट्रीब्यूटर्स, रिटेलर्स और फ्रैंचाइज़ी संभावना चाहने वालों का पसंदीदा गंतव्य
                                है। <br /> <br />

                                Franchiseindia.com के पास प्रीमियम, घरेलू और अंतर्राष्ट्रीय डोमेन में अद्वितीय
                                व्यावसायिक अवसर हैं। अवसरों की तलाश करने वाले हमारे पाठकों के लिए, हमने उद्योग लेखों और
                                कहानियों के लिए व्हाट्स न्यू जैसे विभिन्न वर्गों को अलग कर दिया है, कंपनी / पीपल
                                प्रोफ़ाइल के लिए साक्षात्कार अनुभाग और दुनिया भर में फ्रेंचाइज़िंग में जो हो रहा है उसकी
                                दैनिक खुराक प्रदान करता है। <br />

                                हमारे निवेशकों और अवसर चाहने वालों को साप्ताहिक Franchiseindia.com न्यूज़लेटर में छपने
                                का मौका भी मिलता है जो हजारों ब्रांडों और निवेशकों के इनबॉक्स में सीधे जाता है।
                                Franchiseindia.com ट्विटर, फेसबुक, लिंक्ड, और बहुत कुछ जैसे सोशल नेटवर्क वेबसाइटों पर
                                सीधे ब्रांड को बढ़ावा देने का एक मौका प्रदान करता है। <br />
                                यहां आपका ब्रांड क्यों होना चाहिए
                                <b><a href="www.franchiseindia.com">franchiseindia.com</a>
                                </b>
                                <br /> <br />

                                इसके अलावा, व्यापार और फ्रैंचाइज़ी के अवसरों की प्रचुरता के साथ, फ्रैंचाइज़ींडिया.कॉम के
                                पास फ्रैंचाइज़ी उद्योग में भारत के सबसे बड़े फ्रैंचाइज़ी शो, एफआरओ (नेशनल फ्रेंचाइजी
                                रिटेल और एसएमई शो), बीओएस (बिजनेस अपॉर्च्युनिटी शो) जैसे सभी कार्यक्रमों के नियमित अपडेट
                                भी हैं। फ्रैंचाइज़ इंडिया द्वारा फ्रैंचाइज़ी और रिटेल अवार्ड शो।
                                आगंतुक केवल वेबसाइट पर पंजीकरण करके एक नया व्यवसाय शुरू कर सकते हैं और वह भी मुफ़्त में।
                                Franchiseindia.com उपयोगकर्ता हजारों ब्रांडों के माध्यम से ब्राउज़ कर सकते हैं और आदर्श
                                अवसर चुन सकते हैं। <br /> <br />
                                Franchiseindia.com भी आपको वेबसाइट पर आवक यातायात और आगंतुकों की एक स्थिर धारा के साथ
                                अपडेट करता है। <br />
                                विज्ञापनदाता बुकस्टोर सेक्शन पर क्लिक करके फ्रेंचाइज़ इंडिया की पुस्तकों और रिपोर्टों का
                                लाभ भी ले सकते हैं। <br />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="d-flex">
                                ...
                                <div class="p-2 logo"> <a href="{{ url('') }}"><img
                                            src="{{ url('newhomepage/assets/img/Logo.svg') }}" alt="Home Logo"></a>
                                </div>
                                <div class="ml-auto d-flex">
                                    <span class="login-text-right text-right" data-toggle="modal" data-target="#search">
                                    ...
                                    @else
                                        <span class="login-text-right text-right" data-toggle="modal"
                                            data-target="#login-pnl" id="loginselect">
                                            <img src="{{ url('newhomepage/assets/img/Login.svg') }}" alt="Login">
                                        </span>
                                    @endif
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ url('investor/create') }}">
                                <div class="btn-main btn-franchise" data-toggle="modal" data-target="#start-franchise">एक
                                    फ्रैंचाइज़ बिजनेस आज शुरू करें
                                </div>
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="swiper-slide-section-main">
                                            ...
                                            <div class="card card-m card-p-10">
                                                ...
                                                <div class="card-body-section">
                                                    ...
                                                    <h2><a href="{{ $brandUrl }}">{{ $logoDetail['brand_heading'] }}
                                                        </a></h2>
                                                    <div class="d-flex">
                                                        <div class="card-info">
                                                            निवेश सीमा
                                                ...
                                                <div class="card card-m card-p-10">
                                                    <div class="brand-img-dfa">
                                                        <div class="brand-img-section">
                                                            <a href="{{ $brandUrl }}">
                                                                <img src="{{ $logoDetail['brand_img'] }}"
                                                                    alt="Top Business Opportunities">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="card-body-section">
                                                        ...
                                                        <h2><a
                                                                href="{{ $brandUrl }}">{{ $logoDetail['brand_heading'] }}</a>
                                                        </h2>
                                                        <div class="d-flex">
                                                            <div class="card-info">
                                                                निवेश सीमा
                ...
                <section class="top-international-opportunities section-30" id="top-international-opportunities">
                    <div class="container">
                        ...
                        <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                            <div class="swiper-wrapper"
                                style="transform: translate3d(-2340px, 0px, 0px); transition: all 0ms ease 0s;">
                                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3"
                                    style="width: 1140px; margin-right: 30px;">
                                ...
                                green;">
                                            <div class="brand-image-section">
                                                <div class="brand-main-section">
                                                    <a href="https://www.franglobal.com/engage-and-grow/"><img
                                                            src="https://www.franchiseindia.com/franchiseinternational/images/banners/homepage/engage_199x81.png"
                                                            class="" alt="Remax"></a>
                                                </div>
                                            </div>
                                            <div class="card-body-section">
                                                ...
                                                <h2> Enage &amp; Grow</h2>
                                                <div class="card-info-summry">
                                                    Become A Certified Engage &amp; Grow Franchise in your Region &amp;
                                                    Grow Your Business
                                                </div>
                                ...
                                #2cbee614;">
                                            <div class="brand-image-section">
                                                <div class="brand-main-section">
                                                    <a href="https://www.franchiseindia.com/brands/REMAX-INDIA.25791"><img
                                                            src="https://www.franchiseindia.com/images/remax(199x81).gif"
                                                            class="" alt="Remax"></a>
                                                </div>
                                            </div>
                                            <div class="card-body-section">
                                ...
                                ">
                                            <div class="brand-image-section">
                                                <div class="brand-main-section">
                                                    <a href="https://www.franglobal.com/fatburger/"><img
                                                            src="https://www.franchiseindia.com/franchiseinternational/images/banners/homepage/fatburger_tbo_gold.gif"
                                                            class="" alt="Remax"></a>
                                                </div>
                                            </div>
                                            <div class="card-body-section">
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev"
                                    data-swiper-slide-index="0" style="width: 1140px; margin-right: 30px;">
                                    <div class="swiper-slide-international-opportunities">
                                        <div class="overlay-card"></div>
                                        <div class="card card-m card-p-10"
                                            style="background-color:
                                    ...
                                    <div class="swiper-slide">
                                       ...
                                       img-border">
                                                ...
                                                <div class="card-body-section">
                                                    ...
                                                    <div class="link-section">
                                                        <a href="{{ $brandUrl }}" class="know-more">अधिक
                                                            जानिए</a>
                                                    </div>
                                            ...
                                            <div class="card-fihl card-m card-p-10">
                                                <div class="brand-img-fcc">
                                                    <div class="brand-img-section">
                                                        <a href="{{ $brandUrl }}"><img
                                                                src="{{ $logoDetail['brand_img'] }}"
                                                                alt="Featured Franchise Companies"></a>
                                                    </div>
                                                </div>
                                                <div class="card-body-section">
                                                    <p>
                                          ...
                                          col-sm-12 col-md-6 col-xl-6 col-lg-6">
                                                ...
                                                <div class="newsx-main-bg">
                                                    ...
                                                    <div class="news-headin-section">
                                                        ...
                                                        <p>{{ mb_strimwidth($articless[0]['content'], 0, 221, '...') }}
                                                        </p>
                                                        <div class="news-konwmore">
                                                            <a href="{{ $articless[0]['url'] }}">
                                                                अधिक जानिए
                                                ...
                                                <div class="newsx-main-bg">
                                                    ...
                                                    <div class="news-headin-section">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="author-info-main">
                                                                <a
                                                                    href="#">-{{ $news[0]['auther'] }}<br>समाचार</a>
                                                                संपादक
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="testimonial-main">
                                            ...
                                            <div class="testimonial-brand-summury">
                                                ...
                                                <p> We have been using Franchise India website services for a very long
                                                    ...
                                                    good. Our association with Franchise India has been a great
                                                    experience and we will not only continue this relationship but also
                                                    recommend others to take their expert services and advisory.
                                                </p>
                                                <div class="textimonial-brand-section">
                                                    Liberty Shoes Ltd
                                                </div>
                        ...
                        <div class="row">
                                        ...
                                        <ul class="newsletter">
                                            <li>
                                                ...
                                                <input type="email"
                                                    class="form-control
                                          emailer-main"
                                                    aria-label="Enter Mail" aria-describedby="button-addon2"
                                                    name="email" required="">
                                            </li>
                                            <li><button class="btn btn-main" type="submit" id="button-addon2">साइन
                                                    अप</button></li>
                            ...
                            <div class="col-md-6 text-center socail-newsletter-section">
                                ...
                                <div class="main-newsletter">
                                    <form action="">
                                        <ul class="newsletter-social">
                                            <li><a href="https://www.facebook.com/FranchiseIndiaMedia"
                                                    target="_blank"><img
                                                        src="{{ url('newhomepage/assets/img/fb-icon.svg') }}"
                                                        alt="Facebook"></a></li>
                                            ...
                                            <li><a href="https://twitter.com/FranchiseIndia" target="_blank"><img
                                                        src="{{ url('newhomepage/assets/img/twitter-icon.svg') }}"
                                                        alt="twitter"></a></li>
                                            <li><a href="https://www.youtube.com/user/FranchiseIndia"
                                                    target="_blank"><img
                                                        src="{{ url('newhomepage/assets/img/you-tube-icon.svg') }}"
                                                        alt="youtube"></a></li>
                                        </ul>
                        ...
                        <div class="row justify-content-center">
                            <div class="modified-col col-md-12">
                                ...
                                <div class="about-text-section">
                                    Franchiseindia.com दुनिया की # 1 फ्रेंचाइजी वेबसाइट और एक उद्यमी की दैनिक खुराक है।
                                    फ्रैंचाइज़ इंडिया होल्डिंग्स लिमिटेड - एशिया की सबसे बड़ी एकीकृत फ़्रैंचाइज़ समाधान
                                    कंपनी के तत्वावधान में, वेबसाइट उद्यमियों को फ्रैंचाइज़िंग, मताधिकार के अवसरों,
                                    व्यवसाय के अवसरों, भागीदारी, डीलरों, विनिर्माण, वितरण, खुदरा और बहुत कुछ के पहलुओं
                                    पर हर मिनट का विवरण प्रदान करती है। फ्रेंचाइज़िंग में दुनिया के नेता होने के नाते,
                                    निवेशक और फ्रेंचाइज़र हमेशा समृद्ध, सक्षम और लाखों फलदायी लीड्स और बिक्री के लिए
                                    Franchiseindia.com पर भरोसा कर सकते हैं। वेबसाइट फ्रेंचाइज़र, स्टार्ट-अप्स,
                                    फ्रेंचाइजी, डीलर्स, डिस्ट्रीब्यूटर्स, रिटेलर्स और फ्रैंचाइज़ी संभावना चाहने वालों का
                                    पसंदीदा गंतव्य है। <br /> <br />

                                    Franchiseindia.com के पास प्रीमियम, घरेलू और अंतर्राष्ट्रीय डोमेन में अद्वितीय
                                    व्यावसायिक अवसर हैं। अवसरों की तलाश करने वाले हमारे पाठकों के लिए, हमने उद्योग लेखों
                                    और कहानियों के लिए व्हाट्स न्यू जैसे विभिन्न वर्गों को अलग कर दिया है, कंपनी / पीपल
                                    प्रोफ़ाइल के लिए साक्षात्कार अनुभाग और दुनिया भर में फ्रेंचाइज़िंग में जो हो रहा है
                                    उसकी दैनिक खुराक प्रदान करता है। <br />

                                    हमारे निवेशकों और अवसर चाहने वालों को साप्ताहिक Franchiseindia.com न्यूज़लेटर में
                                    छपने का मौका भी मिलता है जो हजारों ब्रांडों और निवेशकों के इनबॉक्स में सीधे जाता है।
                                    Franchiseindia.com ट्विटर, फेसबुक, लिंक्ड, और बहुत कुछ जैसे सोशल नेटवर्क वेबसाइटों
                                    पर सीधे ब्रांड को बढ़ावा देने का एक मौका प्रदान करता है। <br />

                                    यहां आपका ब्रांड क्यों होना चाहिए
                                    <b><a href="https://www.franchiseindia.com"> Franchiseindia.com </a></b>
                                    <br /> <br />

                                    इसके अलावा, व्यापार और फ्रैंचाइज़ी के अवसरों की प्रचुरता के साथ,
                                    फ्रैंचाइज़ींडिया.कॉम के पास फ्रैंचाइज़ी उद्योग में भारत के सबसे बड़े फ्रैंचाइज़ी शो,
                                    एफआरओ (नेशनल फ्रेंचाइजी रिटेल और एसएमई शो), बीओएस (बिजनेस अपॉर्च्युनिटी शो) जैसे सभी
                                    कार्यक्रमों के नियमित अपडेट भी हैं। फ्रैंचाइज़ इंडिया द्वारा फ्रैंचाइज़ी और रिटेल
                                    अवार्ड शो।
                                    आगंतुक वेबसाइट पर पंजीकरण करके एक नया व्यवसाय शुरू कर सकते हैं और वह भी मुफ्त में।
                                    Franchiseindia.com उपयोगकर्ता हजारों ब्रांडों के माध्यम से ब्राउज़ कर सकते हैं और
                                    आदर्श अवसर चुन सकते हैं। <br /> <br />
                                    Franchiseindia.com भी आपको वेबसाइट पर आवक यातायात और आगंतुकों की एक स्थिर धारा के
                                    साथ अपडेट करता है। <br />
                                    विज्ञापनदाता बुकस्टोर सेक्शन पर क्लिक करके फ्रेंचाइज़ इंडिया की पुस्तकों और
                                    रिपोर्टों का लाभ भी ले सकते हैं। <br />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ url('newhomepage/assets/vendor/mCustomScrollbar/js/jquery.mCustomScrollbar.concat.min.js') }}">
    </script>
    <!-- Font Awesome JS -->
    ...
    <script>
        function submitCategory1() {
            ...
            if (subSubCat) {
                url = url + $('option:selected', $('#getSubCatCategoryDataHeader1')).attr('slug') + '.ssc' + subSubCat +
                    "?catTab=1";
            } else if (subCat) {
                url = url + $('option:selected', $('#getSubCategoryDataHeader1')).attr('slug') + '.sc' + subCat +
                    "?catTab=1";
