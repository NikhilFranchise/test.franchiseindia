...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="{{ route('crreAdmin.dashboard') }}" title="Go to Home" class="tip-bottom"><i
                    class="fa fa-home"></i> Home</a> <a href="{{ route('crreAdmin.list.author') }}" class="tip-bottom"
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <form id="editform" method="POST"
                        action="{{ route(isset($author) ? 'crreAdmin.update.author' : 'crreAdmin.register.author') }}"
                        ...
                        <div class="form-actions">
                            <a href="{{ route('crreAdmin.list.author') }}" class="btn btn-secondary"><i
                                    class="fa fa-times"></i>
                                Cancel</a>
