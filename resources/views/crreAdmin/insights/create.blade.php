    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('crreAdmin.content.list', ['lang' => $lang]) }}" class="tip-bottom"
                title="Go to Manage Content"><i class="fa fa-newspaper"></i> Manage Content</a>
            <a href="{{ url()->current() }}" class="current">{{ 'Add ' . $language . ' Content' }}</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"><i class="fa fa-newspaper"></i></span>
                    <h5>{{ 'Add ' . $language . ' Content' }}</h5>
                </div>
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                        action="{{ route('crreAdmin.content.store', ['lang' => $lang]) }}" id="insightform" novalidate>
                        @csrf

                        <div class="control-group">
                            <label class="control-label" for="publisher">Content Publisher :</label>
                        ...
                        <div class="control-group">
                            <label class="control-label">Content Sub Title :</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label for="inputStatus" class="control-label">Content Desc:</label>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('crreAdmin.content.list', ['lang' => $lang]) }}"
                                class="btn btn-secondary"><i class="fa fa-times"></i> Cancel</a>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#publisher').select2({
                    ...
                    minimumInputLength: 2,
                    ajax: {
                        url: "{{ route('crreAdmin.author.select') }}",
                        dataType: 'json',
                        delay: 250,
                        processResults: function(data) {
                            return {
