    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('crreAdmin.content.list', ['lang' => $lang]) }}" title="Go to Manage Content"
                ...
                Content</a>
            <a href="{{ url()->current() }}" class="current">{{ 'Edit ' . $language . ' Content' }}</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>{{ 'Edit ' . $language . ' Content' }}</h5>
                </div>
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                        action="{{ route('crreAdmin.content.update', ['lang' => $lang]) }}" id="insightform">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <!-- Existing image -->
                                <img class="oldImage" src="{{ imageUrl($data->image, $lang) }}"
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.getElementById("insightform").addEventListener("submit", function(e) {
                ...
                if (content.value == '') {
                    errors.push("Content description must have at least 2 characters.");
                }
                if (errors.length > 0) {
