...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="" class="current">Edit-Insights</a> </div>
        <h1>Edit Insights</h1>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="{{ url('admin/update-insights') }}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select required class="span11" name="insights_type" title="insights_type">
                                    ...
                                    <option value="News" @if($data->insight_type == 'News') selected @endif >News</option>
                                    <option value="Article" @if($data->insight_type == 'Article') selected @endif >Article</option>
                                    <option value="Interview" @if($data->insight_type == 'Interview') selected @endif >Interview</option>
                                    <option value="Report" @if($data->insight_type == 'Report') selected @endif >Report</option>
                                    <option value="Event" @if($data->insight_type == 'Event') selected @endif >Event</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select  class="span11" name="insights_cat" title="Main Category" onchange="Subcategoriesdata(value);">
                                    <option value="">Select Main Category</option>
                                    @foreach($InsightCategory as $category)
                                        <option value="{{ $category->id }}" @if($category->id == $data->cat_id) selected @endif>{{ $category->catname }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="controls">
                                <select  class="span11" name="insights_subcat" id="insights_subcat" title="Sub Category">
                                    ...
                                    @foreach($InsightSubcategory as $subcat)
                                        <option value="{{ $subcat->id }}" @if($subcat->id == $data->subcat_id) selected @endif>{{ $subcat->subcat_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls span9">
                                <div class="form-group">
                                    <textarea name="content" id="inputDescription" class="form-control customError" minlength="2" placeholder="Content Description" required>{{$data->content}}</textarea>
