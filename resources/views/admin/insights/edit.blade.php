...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('insights.list', ['lang' => $lang]) }}" title="Go to Manage Insights" class="tip-bottom"><i
                    class="fa fa-newspaper"></i> Manage
                Insights</a>
            <a href="{{ url()->current() }}" class="current">{{ 'Edit ' . $language . ' Insights' }}</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="hidden" name="old_image"
                                    value="{{ insightsImageUrl($data->image, $lang) }}" />
                                ...
                                <!-- Existing image -->
                                <img class="oldImage" src="{{ insightsImageUrl($data->image, $lang) }}"
                        ...
                        {{-- ================= FEATURED CONTENT ================= --}}
                        <div class="control-group">
                            <label class="control-label">Featured on Insights Home?</label>
                            <div class="controls">
                                <label>
                                    <input type="checkbox" id="is_featured" name="is_featured" value="1"
                                        {{ $featured ? 'checked' : '' }}>
                                    Yes, feature this content
                                </label>
                            </div>
                        </div>

                        <div id="featuredOptions" style="{{ $featured ? '' : 'display:none;' }}">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="featured_slot" class="span11">
                                        ...
                                        <option value="1" {{ optional($featured)->slot == 1 ? 'selected' : '' }}>
                                            Slot 1 (Any Content)
                                        </option>
                                        <option value="2" {{ optional($featured)->slot == 2 ? 'selected' : '' }}>
                                            Slot 2 (Article Only)
                                        </option>
                                    </select>
                                    @if ($errors->has('featured_slot'))
                                        @foreach ($errors->get('featured_slot') as $error)
                                            <br><span style="color: red;">{{ $error }}</span>
                                        @endforeach
                                    @endif
                                </div>
                            ...
                            @if ($featured)
                                <div class="control-group">
                                    <label class="control-label">Currently Active</label>
                                    <div class="controls">
                                        <p style="margin-top:6px;">
                                            {{ $featured->start_at->format('d-m-Y') }}
                                            →
                                            {{ $featured->end_at->format('d-m-Y') }}
                                        </p>
                                    </div>
                                </div>
                            @endif
