    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('insights.list', ['lang' => $lang]) }}" title="Go to Manage Insights" class="tip-bottom"><i
                ...
                Insights</a>
            <a href="{{ url()->current() }}" class="current">{{ 'Quick Edit ' . $language . ' Insights' }}</a>
        </div>
        <h1>{{ 'Quick Edit ' . $language . ' Insights' }}</h1>
    </div>
    <!--End-breadcrumbs-->
    <br>
    <div class="search-results container-fluid">
        <div class="search-result-inner">
            ...
            <form method="get">
                ...
                <a href="{{ route('insights.quick', ['lang' => $lang]) }}" class="btn btn-secondary"
        ...
        <div class="row-fluid">
            <div class="span12">
                <ul class="nav nav-tabs">
                    <li @if (url()->current() == route('insights.quick', ['lang' => 'en'])) class="active" @endif><a
                            href="{{ route('insights.quick', ['lang' => 'en']) }}">English Insights List</a></li>
                    <li @if (url()->current() == route('insights.quick', ['lang' => 'hi'])) class="active" @endif><a
                            href="{{ route('insights.quick', ['lang' => 'hi']) }}">Hindi Insights List</a></li>
                </ul>
                <div class="widget-box">
                    <h4 style="text-align:center; cursor:pointer; background:#f5f5f5; padding:10px; border-radius:4px;"
                        id="toggleColaps">
                        Quick Edit {{ $language }} Insights
                        <i id="toggleIcon" class="fa fa-chevron-down" style="float:right;"></i> <!-- Arrow icon -->
                    </h4>

                    <div id="colaps">
                        <form method="POST" action="{{ route('insights.bulkStore', ['lang' => $lang]) }}" id="bulkForm">
