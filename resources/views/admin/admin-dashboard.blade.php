  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="dashboard"> <i class="icon-dashboard"></i> <span class="label label-important">0</span> My Dashboard </a> </li>
        ...
        <li class="bg_lo"> <a href="list-article-interview"> <i class="icon-th"></i>Articles/Interviews</a> </li>
