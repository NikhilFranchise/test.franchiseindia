...
<div id="content-header">
    <div id="breadcrumb"><a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i
                class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Author</a> <a href="#" class="current">{{
            isset($author) ? "Update" : "Create" }}-Author</a></div>
            ...
            <div class="widget-content nopadding">
                <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span11" name="twitter_profile" placeholder="Enter Twitter Profile"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span11" name="insta_profile" placeholder="Enter Instagram Profile"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            @endif
                            <input type="file" name="image" class="span11"><br>
                            Note: *Image Size 484x484
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls span9">
                            <textarea name="desc"
                                placeholder="Description">{{isset($author) ? $author->text : ""}}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="international_check" class="control-label">News Writer? :</label>
                        <div class="controls">
                            <input type="checkbox" name="news_upload_capability" value="1" @if( isset($author) &&
                                $author->news_upload_capability == 1) checked @endif>
                        </div>
                    </div>
