...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Kicker</a> <a href="#" class="current">List-Article-Interview</a> </div>
        <h1>Kicker Listing</h1>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                <form action="{{url('admin/kickers/list/'.$type)}}" method="get">
                    ...
                    <a href="{{url('admin/kickers/list/'.$type)}}" class="btn" style="margin-top: -12px;">Reset Search</a>
                </form>
            </div>
        </div>
        <hr>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach($kickers as $kicker)
                                <tr class="gradeX">
                                    ...
                                    <td ><button class="btn btn-medium btn-danger deletetag" style="border-radius: 4px" data-value="{{ $kicker->tag_id }}">Delete</button></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
    ...
    $('.deletetag').on('click', function(){
        ...
        confirmDialog(YOUR_MESSAGE_STRING_CONST, function() {
            $.ajax({
                ...
                data: {"tag_id" : x, "type" : '{{ $type }}', "_token" : "{{csrf_token()}}"},
                success: function() {
