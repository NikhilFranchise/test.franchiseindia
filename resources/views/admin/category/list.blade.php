...
<div id="content">
    ...
    <div id="content-header">
        ...
        <a href="#" class="current">List Main Category</a> </div>
        <h1>Main Category Listing</h1>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                <form action="{{url('admin/cat/list/')}}" method="get">
                    Search Keyword :  <input type="text" name="search" class="span7" placeholder="Enter Main Category or Category Id to search" @if(!empty(request()->search)) value="{{ request()->search }}" @endif />
                    <input type="submit"  class="btn" value="Search" style="margin-top: -12px; margin-left: 10px; width: 110px;" />
                    <a href="{{url('admin/cat/list/')}}" class="btn" style="margin-top: -12px;">Reset Search</a>
                </form>
            </div>
        </div>
        <hr>
    ...
    <div class="container-fluid">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach($catdata as $data)
                                <tr class="gradeX">
                                    ...
                                    <td ><button class="btn btn-medium btn-danger deletetag" style="border-radius: 4px" data-value="{{ $data->id }}">Delete</button></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
        ...
        <div class="custpagin">
            {!! $catdata->appends([ 'search' => request()->search ])->render() !!}
        </div>
    </div>
</div>
<!--Footer-part-->
