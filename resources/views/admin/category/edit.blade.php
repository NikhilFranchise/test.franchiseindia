    ...
    <div id="content">
        ...
        <div id="content-header">
            ...
            <div id="breadcrumb">
                ...
                <a class="current">Edit {{ $locale }} Main Category</a>
            </div>
            <h1>Edit {{ $locale }} Main Category</h1>
        </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <form method="POST" class="form-horizontal"
                            action="{{ url('admin/' . $lang . '/update/cat') }}">
                            @csrf
                            <div class="control-group">
                                <label class="control-label">Main Category :</label>
                                <div class="controls">
                                    <input type="text" maxlength="125" required class="typeahead tt-query"
                                        autocomplete="off" spellcheck="false" name="maincat"
                                        placeholder="Enter Main Category" value="{{ $editData->catname }}">
