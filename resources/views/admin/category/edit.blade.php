...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="#" class="current">Edit Main Category</a> </div>
        ...
        <div class="row-fluid">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    @endif
                    <form method="POST" class="form-horizontal" action="{{url('admin/update/cat')}}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                        <div class="control-group">
                            <label class="control-label">Main Category :</label>
                            <div class="controls">
                                <input type="text"  maxlength="125" required class="typeahead tt-query" autocomplete="off" spellcheck="false" name="maincat" placeholder="Enter Main Category" value="{{$catdata->catname}}">
