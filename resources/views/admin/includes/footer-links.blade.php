...
<script src="{{URL::asset('admin/js/bootstrap-colorpicker.js')}}"></script> 
<script src="{{URL::asset('admin/js/bootstrap-datepicker.js')}}"></script> 
<script src="{{URL::asset('admin/js/jquery.toggle.buttons.js')}}"></script> 
<script src="{{URL::asset('admin/js/masked.js')}}"></script> 
<script src="{{URL::asset('admin/js/matrix.form_common.js')}}"></script> 
<script src="{{URL::asset('admin/js/wysihtml5-0.3.0.js')}}"></script> 
<script src="{{URL::asset('admin/js/bootstrap-wysihtml5.js')}}"></script> 
