<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        @if(session()->get('role') != 'ga' && session()->get('author_creation_capability') == 1)
            <li class="submenu @yield('DAU')"> <a href="#"><i class="icon icon-th-list"></i> <span>Author</span></a>
                <ul>
        ...
        <li class="submenu @yield('KICK')"> <a href="#"><i class="icon icon-th-list"></i> <span>Kickers</span></a>
            <ul>
         ...
         @if(session()->get('role') != 'ga' && session()->get('adminEmail') == 'techsupport@franchiseindia.net')
        <li class="submenu @yield('CAT')"> <a href="#"><i class="icon icon-th-list"></i> <span>Main Category/Sub Category</span></a>
            <ul>
        ...
        <li class="submenu @yield('AA')"> <a href="#"><i class="icon icon-th-list"></i> <span>Article/Interview</span></a>
            <ul>
        ...
        @if(session()->get('role') != 'ga')
            <li class="submenu @yield('NA')"> <a href="#"><i class="icon icon-th-list"></i> <span>News</span></a>
                <ul>
            ...
            <li class="submenu @yield('MAG')"> <a href="#"><i class="icon icon-th-list"></i> <span>Magazines</span></a>
                <ul>
        ...
        <li class="submenu @yield('COM')"> <a href="#"><i class="icon icon-th-list"></i> <span>Comments</span></a>
        ...
        @endif
        @if(session()->get('role') != 'ga')
        <li class="submenu @yield('IN')"> <a href="#"><i class="icon icon-th-list"></i> <span>Insights</span></a>
            <ul>
