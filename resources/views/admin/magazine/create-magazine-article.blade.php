...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="#" class="current">Create-Article</a> </div>
        ...
        <div class="row-fluid">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="{{Config::get('constants.MainDomain')}}/admin/create-magazine-article">
                        <input type="hidden" name="category_id" value="{{$caregoryId}}"/>
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="control-group">
                            <label class="control-label">Article Title :</label>
                            <div class="controls">
                                <input type="text" required class="span11" placeholder="Enter Title" name="article_title" required/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Author :</label>
                            <div class="controls">
                                <select multiple="true" required style="display: none;" name="author" id ="publisher" required></select>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Summery :</label>
                            <div class="controls">
                                <input type="text" required class="span11" placeholder="Summery" name="summery"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Article Pharagraph :</label>
                            <div class="controls">
                                <input type="text" required class="span11" placeholder="Pharagraph" name="pharagraph"/>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls" id="associatedTags">
                                    <select multiple="true" style="display: none;" name="tags[]" id ="select3"></select>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">slug :</label>
                                <div class="controls">
                                    <input type="text" required class="span11" placeholder="Enter slug" name="slug"/>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" id="magazinesubmit" class="btn btn-success">Save</button>
                            </div>
                    </form>
                </div>
            </div>
