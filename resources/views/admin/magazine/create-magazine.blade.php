  ...
  <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="{{Config::get('constants.MainDomain')}}/admin/create-magazine" >
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="control-group">
              <label class="control-label">Magazine Title :</label>
              <div class="controls">
                <input type="text" required class="span11" name="title" placeholder="Enter Magazine Title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Magazine Month :</label>
              <div class="controls">
                <input type="text" required pattern="[0-9]{1,2}" maxlength="2" class="span11" name="month" placeholder="Enter Magazine Month" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Magazine Year :</label>
              <div class="controls">
                <input type="text" required pattern="[0-9]{1,4}" maxlength="4" class="span11" name="year" placeholder="Enter Magazine Year" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Image :</label>
              <div class="controls">                
                  <input type="file" required name="image" class="span11" id="showImage">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required name="slug" id="slug" class="span11" placeholder="Enter Slug"  />
              </div>
            </div>
