...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('subcat.list', ['lang' => $lang]) }}" title="Go to Manage Categories" class="tip-bottom"><i
    ...
    <div class="search-results container-fluid">
        <div class="search-result-inner">
            ...
            <a href="{{ route('subcat.create', ['lang' => $lang]) }}" class="greens float-right btn btn-md btn-success">
                <i class="fa fa-plus-circle"></i>{{ ' Add New ' . $language . ' Subcategory' }}
            </a>
            <form action="{{ route('subcat.list', ['lang' => $lang]) }}" method="get">
                ...
                <a href="{{ route('subcat.list', ['lang' => $lang]) }}" class="btn btn-secondary"
        ...
        <div class="row-fluid">
            <div class="span12">
                <ul class="nav nav-tabs">
                    <li @if (url()->current() == route('cat.list', ['lang' => $lang])) class="active" @endif><a
                            href="{{ route('cat.list', ['lang' => $lang]) }}">English Main Categories</a></li>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        {{-- <td>
                                            <center><button class="btn btn-medium btn-warning" style="border-radius: 4px"><a
                                                        href="{{ route('subcat.edit', ['lang' => $lang, 'id' => $data->id]) }}"><i
                                                            class="fa fa-edit"></i> Edit</a></button></center>
                                        </td> --}}
            ...
            $('.deleteSubCat').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('delete.subcat', ['lang' => $lang, 'id' => '__ID__']) }}"
