...
<script language="javascript">
    /*<![CDATA[*/
    var minval = {{$minRangeValue}};
    var maxval = {{$maxRangeValue}};;
    $(function() {
        $("#price-range").slider({
            range: true,
            min: minval,
        ...
        <div class="cat-filter">
            <div class="cat-type">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#franchise" aria-controls="franchise" role="tab"
                            data-toggle="tab">Franchise</a></li>
                </ul>
                                    ...
                                    @foreach ($categArr as $indexMainCat => $mainCat)
                                        @php
                                            $url =
                                                ...
                                                Config('category.SeoCategoryArr.' . $indexMainCat) .
                                                '.m' .
                                                $indexMainCat;
                                            $mainCheck = '';
                                            $display = 'none';
                                        ...
                                        <li>
                                            <a href="JavaScript:Void(0)" class="accordian-arrow main-lst"
                                                id="cat-{{ $indexMainCat }}" onclick="accordionCategory(this.id)"></a>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" {{ $mainCheck }}
                                                        slug="{{ Config('category.SeoCategoryArr.' . $indexMainCat) }}"
                                                        name="mainCat" url="{{ $url }}" class="mainCat"
                                            ...
                                            <ul class="cat-main-list" id="cat-{{ $indexMainCat }}_1"
                                                ...
                                                @foreach (Config('constants.subCategoryArr.' . $indexMainCat) as $subCatIndex => $subCat)
                                                    @php
                                                        $subCatUrl =
                                                            Config('constants.MainDomain') .
                                                            '/business-opportunities/' .
                                                            Config('category.SeoSubCategoryArr.' . $subCatIndex) .
                                                            '.sc' .
                                                            $subCatIndex;
                                                        $subCheck = '';
                                                        $displaysc = 'none';
                                                    ...
                                                    <li>
                                                        <a href="JavaScript:Void(0)" class="accordian-arrow sub-lst"
                                                            id="cat-{{ $indexMainCat }}-{{ $subCatIndex }}"
                                                            onclick="accordionSubCategory(this.id)"></a>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input value="{{ $subCatIndex }}" {{ $subCheck }}
                                                                    slug="{{ Config('category.SeoSubCategoryArr.' . $subCatIndex) }}"
                                                                    mainCat="{{ $indexMainCat }}"
                                                        ...
                                                        <ul class="cat-sub-list"
                                                            id="cat-{{ $indexMainCat }}-{{ $subCatIndex }}_1"
                                                            style="display:{{ $displaysc }}">
                                                            @foreach (Config('constants.subSubCategoryArr.' . $subCatIndex) as $subSubCatIndex => $subSubCat)
                                                                ...
                                                                @if (in_array($subSubCatIndex, json_decode(Storage::get('ssc.json'), true)))
                                                                    <li>
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input value="{{ $subSubCatIndex }}"
                                                                                    {{ $subsubcatchecked }}
                                                                                    slug="{{ Config('category.SeoSubSubCategoryArr.' . $subSubCatIndex) }}"
                                                                                    mainCat="{{ $indexMainCat }}"
                                                                                    subCat="{{ $subCatIndex }}"
                                                                                    subCat="{{ $subCatIndex }}"
                                                                                    id="optionsRadiosSubSub{{ $indexMainCat }}_{{ $subSubCatIndex }}"
                                                                                    class="subSubCat" name="subSubCat[]"
                                                                                    type="checkbox"
                                                                                    url="{{ $subsubCatUrl }}" />
                                                                                <a href="{{ $subsubCatUrl }}"
                            ...
                            <div class="franchise-list">
                                <ul>
                                    ...
                                    <li>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" @if ($ftype != 1 && $ftype != 2 && $ftype != 3) checked @endif
                                                    class="franType" name="franchise_type" value="">
                                                All
                                            </label>
                                        </div>
                                    </li>
                                        ...
                                        <li>
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    @endphp
                                                    <input type="radio" slug="{{ Str::slug($value) }}"
                                                        {{ $ftypeCheck }}
                                                        url="{{ Config('MainDomain') }}/business-opportunities/{{ strtolower(Str::slug($value)) }}.FT{{ $key }}"
                                                        class="franType" name="franchise_type"
                                                        id="ftype{{ $key }}" value={{ $key }}>
                                                    <a href="{{ Config('MainDomain') }}/business-opportunities/{{ strtolower(Str::slug($value)) }}.FT{{ $key }}"
                                                        id="aftype{{ $key }}" class="sub-cat-disable">
                                                        {{ $value }}
                                                    </a>
                                                </label>
                                            </div>
                        ...
                        <div class="filter-type">
                            ...
                            <div class="sliderval">
                                @php
                                    ...
                                    // $maxvalueSlider = $maxRangeValue;
                                    $maxvalueSlider = substr($maxRangeValue / 10000000, 0, 5) . ' Cr';
                                @endphp
                                <div class="pull-left" name="minval" id="minval" value="">
                                    {{ $minvalueSlider }}</div>
                                <div class="pull-right" name="maxval" id="maxval" value="">
                                    {{ $maxvalueSlider }}</div>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        ...
                                        @foreach ($state as $stateId => $stateValue) 
                                            ...
                                            <li>
                                                <div class="checkbox">
                                                    <label>
                                                        <input value="{{ $stateId }}" {{ $stateChecked }}
                                                            name="state[]"
                                                            slug="{{ strtolower(Str::slug($stateValue)) }}"
                                                            class="statecheckbox" id="location{{ $l }}"
                                                            type="checkbox"
                                                            url="{{ Config('MainDomain') }}/business-opportunities/{{ strtolower(Str::slug($stateValue)) }}.LOC{{ $stateId }}">
                                                        <a href="{{ Config('MainDomain') }}/business-opportunities/{{ strtolower(Str::slug($stateValue)) }}.LOC{{ $stateId }}"
                                                            class="states-link-disable"
                                                            id="alocation{{ $l }}">
                                                            {{ $stateValue }}
                                                        </a>
                                                    </label>
                                        ...
                                        @endforeach
                                        <form method="get"
                                            action="{{ Config('constants.MainDomain') }}/category/search">
                                            ...
                                            <input type="hidden" name="minrange" id="minvaluerange"
                                                value="@if (isset($minRangeValue)) {{ $minRangeValue }} @endif">
                                            <input type="hidden" name="maxrange" id="maxvaluerange"
                                                value="@if (isset($maxRangevalue)) {{ $maxRangevalue }} @endif">
...
<script language="javascript">
    /*<![CDATA[*/
    $(document).on('click', '.cat-disable', function(event) {
    ...
    $(document).on('click', '.sub-cat-disable', function(event) {
        event.preventDefault();
        var input = $(this).attr('id');
        input = input.replace("a", "");
        $("#" + input).prop('checked', 'checked');
    ...
    $(document).on('click', '.sub-sub-cat-disable', function(event) {
        event.preventDefault();
        var input = $(this).attr('id');
        input = input.replace("a", "");
        $("#" + input).trigger('click');
    });
    $(document).on('click', '.states-link-disable', function(event) {
        event.preventDefault();
        var input = $(this).attr('id');
        input = input.replace("a", "");
        $("#" + input).trigger('click');
    ...
    function getMainCatId() {
        var mainCatId = $("input:radio[name=mainCat]:checked").val();
    ...
    function getCategoryList() {
        ...
        var sort = (sortby && sortby != 'x') ? "?sortby=" + sortby : "";
        locStr.sort(function(a, b) {
            return parseInt(a) - parseInt(b);
        });
        if (franchiseType == "" && subSubCat.length === 0 && mainCatmId == '' && locStr.length === 0 && (rangeMin !=
                10000 || rangeMax != 100000000)) {
            window.location = "/business-opportunities/business/range-" + rangeMin + "-" + rangeMax;
            return;
        }
        if (franchiseType == "" && subSubCat.length === 0 && mainCatmId == '' && locStr.length === 0 && rangeMin ==
            10000 && rangeMax == 100000000) {
            window.location = "/business-opportunities/all/all";
            return;
        }
        if (franchiseType >= 1 && subSubCat.length === 0 && mainCatmId == '' && locStr.length === 0 && rangeMin ==
            10000 && rangeMax == 100000000) {
            window.location = $("input:radio[value='" + franchiseType + "'][class='franType']").attr('url');
            return;
        }
        if (subSubCat.length === 1 && locStr.length === 0 && franchiseType == '' && rangeMin == 10000 && rangeMax ==
            100000000) {
            window.location = $("input:checkbox[value='" + subSubCat[0] + "'][class='subSubCat']").attr('url') + sort;
            return;
        }
        if (subSubCat.length === 0 && mainCatmId == '' && franchiseType == '' && locStr.length === 1 && rangeMin ==
            10000 && rangeMax == 100000000) {
            window.location = $("input:checkbox[value='" + locStr[0] + "'][class='statecheckbox']").attr('url') + sort;
            return;
        }
        if (subSubCat.length === 0 && mainCatmId == '' && locStr.length === 1 && franchiseType >= 1 && rangeMin ==
            10000 && rangeMax == 100000000) {
            ...
            window.location = "/business-opportunities/business-" + ft + "-in-" + loc + "/loc-" + locStr.join("-") +
                "/ft-" + franchiseType + sort;
            return;
        }
        if (subSubCat.length === 0 && mainCatmId == '' && locStr.length > 1 && franchiseType >= 1 && rangeMin ==
            10000 && rangeMax == 100000000) {
            var ft = $("input:radio[value='" + franchiseType + "'][class='franType']").attr('slug')
            window.location = "/business-opportunities/business-" + ft + "-in-india/loc-" + locStr.join("-") + "/ft-" +
                franchiseType + sort;
            return;
        }
        if (subSubCat.length === 0 && mainCatmId == '' && locStr.length > 1 && rangeMin == 10000 && rangeMax ==
            100000000) {
            window.location = "/business-opportunities/business-in-india/loc-" + locStr.join("-") + sort;
            return;
        }
        if (subSubCat.length === 0 && subCat !== '' && locStr.length === 0 && franchiseType == '' && rangeMin ==
            10000 && rangeMax == 100000000) {
            window.location = $("input:radio[value='" + subCat + "'][class='subcatselect']").attr('url') + sort;
            return;
        }
        if (subSubCat.length === 0 && mainCatmId !== '' && locStr.length === 0 && franchiseType == '' && rangeMin ==
            10000 && rangeMax == 100000000) {
            window.location = $("input:radio[value='" + mainCatmId + "'][class='mainCat']").attr('url') + sort;
            return;
        }
        ...
        var location = "india";
        var catText = $("input:radio[value='" + mainCatmId + "'][class='mainCat']").attr('slug');
        ...
        if (subSubCat.length === 1) {
            ...
            catText = $("input:radio[value='" + subCat + "'][class='subcatselect']").attr('slug');
            if (subSubCat.length > 1) {
        ...
        var url = "/business-opportunities/" + catText;
    ...
    $(".franType, .statecheckbox, #price-range").click(function() {
        getCategoryList();
    });
    ...
    $(".subSubCat").click(function() {
        ...
        var subsubCatid = 'cat-' + mainCat + '-' + subCat + '_1';
        $('#optionsRadiosSub' + mainCat + '_' + subCat).prop('checked', true);
        $('#optionsRadios' + mainCat).prop('checked', true);
        $("#categoryunselect input[type=checkbox]").each(function() {
            if ($(this).parent().parent().parent().parent().attr('id') != subsubCatid)
