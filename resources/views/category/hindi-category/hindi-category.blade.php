    ...
    <div class="cateblock margintop20 categories-list">
        <div class="container">
            <div class="row row-no-margin">
                ...
                @include('category.hindi-category.hindi-category-left-section')
                <!-- category left panel end here  -->
                <div class="col-xs-12 col-sm-8 col-md-9 bor-radius backwhite catright row-no-padding">

                    @include('category.hindi-category.navigation-search-by-hindi')
                    ...
                    <div class="row row-no-margin catpadtop20">
                        ...
                        @foreach ($shuffledResults as $brandResult)
                            ...
                            {{--  @php
                                ...
                                if ($brandResult->is_hindi == 1) {
                                    $brandUrl = url(
                                        'hi/brands/' . $brandResult->profile_name . '.' . $brandResult->fran_detail_id,
                                    );
                                }
                                $is_premium = 0;
                                $imgCount = 0;
                        ...
                        @endphp
                            ...
                            @if ($brandResult->membership_type == 1)
                                ...
                                @include('category.hindi-category.paid-brand-hindi')
                            ...
                            @elseif($brandResult->membership_type == 0)
                                ...
                                @include('category.hindi-category.free-brand-hindi')
                ...
                success: function(data) {
                    ...
                    if ($.isNumeric(data)) {
                        ...
                        $('#creditRemaining').html('आपके पास' + data +
                            'क्रेडिट शेष है। क्या आप क्रेडिट का उपयोग करना चाहते हैं');
