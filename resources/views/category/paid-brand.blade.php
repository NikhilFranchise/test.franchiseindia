    ...
    <div class="catlistdest">
        <div class="catdleft pad20">
            ...
            <div class="commanmbs">
                ...
                <div class="subcat">
                    <span>{{ $brandResult->looking_tradepartner == 1 ? "Dealership" : "Franchising" }} Launch Date</span>
        ...
        <div class="catdright pad20">
            ...
            @if($brandResult->looking_tradepartner != 1)
                <div class="subcat">@if($mc != 5)<span>Franchise Type</span>@endif
                    @if($mc == 5)<span>Channel Type</span>@endif
                    {{Config('constants.masterfranchiseType.'.$brandResult->franchise_partner_type)}}
                </div>
            @endif
