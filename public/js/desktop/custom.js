...
$('#investment_range_sldier').on('click keyup change', function(e) {
    getCategoryList();
});

$('.statecheckbox, .franType, .subSubCat').on('change', function(e) {
    getCategoryList();
});
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, value) {
                        ...
                        newHtml = newHtml + '<div class="col-xl-4 col-lg-6 col-sm-6 brand-count">' +
                            '<div style="display: relative;">' +
                            '<div class="franchise-card card">' +
                            '<div class="card-inner">' +
                            '<div class="card-header">' +
                            '<div class="fimg">' +
                            '<img src="'+ value['logo'] +'" id="logo_'+ value['franchisor_id'] +'" alt="'+ value['company_name'] +'">' +
                            '</div>' +
                            '</div>' +
                        ...
                        if((bigAds+smallAds) < 25 ) {
                            ...
                            if((smallAds) < 16 ) {
                                if(index == 3 || index == 14 || index == 19) {
                                    ...
                                    newHtml = newHtml + '<div class = "col-xl-4 col-lg-6 col-sm-6" ><div class="franchise-card card ad-image"><div id="div-gpt-ad-1563348795825-'+ smallAds +'" style="width: 300px; height: 250px;"></div></div></div>';
                                    smallAds = smallAds + 1;
                                }
                            }

                            if(index == 7 || index == 15) {
                                var adId = 'div-gpt-ad-1563348824884-' + bigAds;
                                var adName = 'CP_970x250';
                                ...
                                if($('.ad_big').length > 7) {
                                    ...
                                    adName = 'CP_970x90';
                                    height = 90;
                                    adId = 'div-gpt-ad-1563427321783-' + bigAds;
                                }

                                if (typeof googletag != 'undefined') {
                                    googletag.cmd.push(function() {
                                        googletag.defineSlot('/1057625/New_Category/'+ adName, [width, height],  adId).addService(googletag.pubads());
                                    });
                                    newHtml = newHtml + '<div class = "col-md-12" ><div class="ad_big"><div id='+ adId +' style="width: '+ width +'px; height: '+ height +'px;"></div></div></div>';
                                    bigAds = bigAds + 1;
                                }
                            }
                        }
