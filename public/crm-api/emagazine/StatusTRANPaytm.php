<?php
include_once("../configpg/dbConfig.php");         //Database Connectivity
...
//Mail to Customer
			...
			$body1 = "Dear Subscriber, Thank you for subscribing for Entrepreneur magazine.<br /><br /> 
The magazine subscription is likely to start from 4-6 weeks from now. If you need any other details please feel free to write to us at support@entrepreneurindia.com and call us at 8586891020.
