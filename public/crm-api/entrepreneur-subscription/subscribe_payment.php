...
/*if(empty($first_name) || empty($last_name) || 
	empty($email) || empty($telephone) || empty($company_address)  || empty($delivery_address) || 
...
if($email_validation != "" && $email != "" && $telephone != ""){ 
	...
	if($payment_mode == "Paytm"){
		...
		$paramList["CALLBACK_URL"] = "https://www.franchiseindia.com/crm-api/entrepreneur-subscription/StatusTRANPaytm.php";
	...
	<?php		
		...
		$redirect_url = "redirect_url=".urlencode("https://www.franchiseindia.com/crm-api/entrepreneur-subscription/StatusTRAN.php");
		$cancel_url = "cancel_url=".urlencode("https://www.franchiseindia.com/crm-api/entrepreneur-subscription/StatusTRAN.php");
