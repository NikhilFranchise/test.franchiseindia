...
$MagCode = array(
    ...
    //  $rs_subscribeCount     = $obj_function->get_zoho_magazine_cid_count($from , $perPage); //
      $rs_subscribeCount     = mysqli_query($link,"SELECT `sub_id` FROM `magazine_subscribe` WHERE  `sub_id` > 62863 AND payment_status = 'Y' LIMIT $from , $perPage");	  
