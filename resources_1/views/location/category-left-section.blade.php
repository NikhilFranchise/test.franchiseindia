                                        ...
                                        <li>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    <a
                                                        href="{{ url('/location') . '/' . strtolower(str_replace(' ', '-', $city)) }}">
                                                        {{ $city }} </a>
                                                </label>
                                            </div>
                                        </li>
...
<script language="javascript">
    ...
    function getCategoryList() {
        ...
        // alert(locStr);
        //return false;
        // console.log(locStr + franchiseType);
