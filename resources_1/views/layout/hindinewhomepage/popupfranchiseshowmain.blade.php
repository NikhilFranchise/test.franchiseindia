...
.headtag { height:336px; overflow: hidden; width: 600px;
background: url("https://www.franchiseindia.com/images/popup/fro-south-top.jpg") no-repeat center top;
overflow: hidden;

}
.ftrbg { background: #0b5e57; color: #fff;  padding: 5px; text-align: center;  font-family: 'Open Sans Regular'; font-size: 16px; line-height: 22px;}
</style>
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
  ...
  <input type="hidden" name="txtDelegates" value="1">   
       ...
       <option value="West India, 01 November 2020">West India, Sunday, 01st November 2020</option>
    <option value="South India, 07 November 2020">South India, Saturday, 07th November 2020</option>
