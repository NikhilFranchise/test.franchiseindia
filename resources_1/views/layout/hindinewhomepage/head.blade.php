...
<!-- Bootstrap CSS CDN -->
<link rel="stylesheet" href="{{ url('newhomepage/assets/vendor/bootstrap/css/bootstrap.min.css') }}">
<!-- Scrollbar Custom CSS -->
<link rel="stylesheet"
    href="{{ url('newhomepage/assets/vendor/mCustomScrollbar/css/jquery.mCustomScrollbar.min.css') }}">
<!-- swiper@6.2.0 CSS -->
<link rel="stylesheet" href="{{ url('newhomepage/assets/vendor/swiper/css/swiper-bundle.min.css') }}">
<!-- owl.carousel -->
<link href="{{ url('newhomepage/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
<!-- Our Custom CSS -->
@notmobile
...
@notmobile
    <script>
        ...
        googletag.cmd.push(function() {
            ...
            googletag.defineSlot('/1057625/FIHL/Desktop_HP_970x90_ATF', [
                [970, 90],
                [728, 90]
            ], 'adslot970x90_ATF').addService(googletag.pubads());
            googletag.defineSlot('/1057625/FIHL/Desktop_HP_970x90_Mid_1', [
                [970, 90],
                [728, 90]
            ], 'adslot970x90_Mid_1').addService(googletag.pubads());
            googletag.defineSlot('/1057625/FIHL/Desktop_HP_300x250', [300, 250], 'adslot300x250').addService(
                googletag.pubads());
...
@mobile
    <script>
        ...
        googletag.cmd.push(function() {
            ...
            googletag.defineSlot('/1057625/FIHL/WAP_HP_300x250_ATF', [300, 250], 'adslot300x250_ATF').addService(
                googletag.pubads());
            googletag.defineSlot('/1057625/FIHL/WAP_HP_300x250_Mid_1', [300, 250], 'adslot300x250_Mid_1')
                .addService(googletag.pubads());
            googletag.defineSlot('/1057625/FIHL/WAP_HP_300x250_Mid_2', [300, 250], 'adslot300x250_Mid_2')
                .addService(googletag.pubads());
            //googletag.defineSlot('/1057625/FIHL/WAP_HP_300x250_Mid_3', [300, 250], 'adslot300x250_Mid_3').addService(googletag.pubads());
            googletag.defineSlot('/1057625/FIHL/WAP_HP_300x250_BTF', [300, 250], 'adslot300x250_BTF').addService(
                googletag.pubads());
