<head>
    ...
    <style amp-custom>
        ...
        h1 {      color: #333333; font-size:28px; font-family: 'NotoSansDevanagariUI-Regular',sans-serif; line-height:31px; font-weight:400;     margin:30px 0 20px;}
        ...
        .articlelisthead {font-family: 'NotoSansDevanagariUI-Medium',sans-serif;font-size:22px; line-height:25px; color:#333333;margin:15px 0 15px 0;}
        ...
        .brandcontainer .innercontain > p { margin-top:0;}
