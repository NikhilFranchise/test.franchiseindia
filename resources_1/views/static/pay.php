...
<li>Franchise India Holdings Limited (<a href="https://www.franchiseindia.com" style="text-decoration:underline;"> www.franchiseindia.com </a>)has relied upon those organisations listed on this website for the accuracy of the information concerning them on the site to which their name is linked. FIHL and the site sponsors accept no liability for the accuracy of any information contained on this site or on other linked sites. Its is your responsibility to satisfy yourself as to the accuracy and reliability of the information supplied.</li>

<li>The organisations named within this site are members, partners and sponsors of FIHL. FIHL is not an agent of those organisations and their membership or support/sponsorship of FIHL does not imply that FIHL endorses those organisations or any business opportunities, products or services offered by them. You and your professional advisors should make your own independent enquiries to satisfy yourself as to all aspects of any particular franchise business or opportunity.</li>

<li>The success of a franchise is dependent upon many factors. Although FIHL endeavours to be vigilant in scrutinising members initial compliance with FIHL Code of Practice, FIHL makes no representations whatsoever that any particular member you may deal with is fully compliant with the Code of Practice or that in choosing a franchise operated by any of its members you will be successful in your business.
</li>
</ul>
...
<li>We are not liable for any of the content published on the Site. If you would like to alert us to content that you believe to be inappropriate, please immediately write to us at <a href="mailto:info@franchiseindia.com">info@franchiseindia.com</a>. We will deal with your request as soon as reasonably possible.</li>

<li>All contents and code are copyright &copy; 1999-2022, of Company. All Rights Reserved. We reserve the right at our sole discretion to refuse any advertising of submitted information.</li>
...
<li>You shall not publish or cause to be published any unlawful, defamatory, obscene, threatening, offensive, harmful or otherwise objectionable content.
You confirm that you are the author of any content submitted to the Site and agree to waive all your moral rights to be identified as the author and your copyright to such content.</li>
...
<li>By submitting a request for information regarding any of our sponsors, you represent and warrant that all information submitted is true and non - misleading and does not violate any law or regulation. However the Company reserves the right to deny service to any user at any time in its sole discretion.</li>
    ...
    <li>"Company" means "franchise India holdings limited" and includes franchiseindia.com where the context so requires.</li>

    <li>"Advertiser" means the person, company or other entity that wishes to advertise and avail of the services provided by the Company and whose name is set forthadjacent to the term "Advertiser's Name" appearing overleaf.</li>

    <li>The Company will have the right to change the advertising rates at any given point of time,without notice.</li>

    <li>All advertising material (collectively "Advertisement") supplied by advertiser to the Company should either be owned by or be legally authorized for use by theAdvertiser. The Advertisement must not be obscene, offensive or unlawful in any manner and should not contravene any applicable laws, rules and/or regulations.</li>

    <li>The Company will take every reasonable precaution to upload the information, as supplied by the Advertiser, in the print publication / website. However, theCompany will not be responsible in case of any errors or omissions. But company is committed to edit/correct the errors or omissions as and when the same iscommunicated by the Advertiser in writing wherever changes are possible.</li>

    <li>Unless the Company and the Advertiser otherwise agree in writing, the Advertisement (excluding the trademarks and/or trade name of the Advertiser) used inpreparation of the artworks will be the exclusive property of the Company, The Advertiser hereby warrants that the artwork design by the Company in any of itspublication / website will not be reproduced or assigned for reproducing as a whole or in part, without the prior written consent of the Company.</li>

    <li>Advertising agency involved in placing the Advertisement for and on behalf of any person, company or entity ("Ultimate Customer") assures that it has theauthority to modify and/or amend an Advertisement of an Ultimate Customer, in accordance with Advertiser's instructions without committing any offence ortort. The Advertiser hereby warrants and agrees that it shall indemnify and hold the Company harmless to the extent of any costs, damages or other chargesfalling upon the Company as a result of any claim and/or dispute raised by the Ultimate Customer against the Company arising from or relating to display of theAdvertisement on the website.</li>

    <li>The Advertiser hereby agrees to notify the Company in writing of any change in ownership or authorization as aforesaid, which occurs after the execution of thiscontract invoice.</li>

    <li>The Advertiser hereby agrees to defend at its own, indemnify and keep the Company harmless from any infringement claims, losses and judgments which arisefrom or which are claimed to have arisen from the use of such copy cuts, illustrations, marks and names and Directories, the Advertisement and/or anyAdvertisement related material including but not limiting to any third party infringement claims together with expense, attorney fees and court costs incurred bythe Company.</li>

    <li>The Advertiser assumes sole responsibility and liability for protection of its Intellectual Property right(s) in any pictorial illustration design format, photograph orcombination thereof included in the Advertisement.</li>
    ...
    <li>In the event of any dispute between the Advertiser, and the Company under, in connection with or in relation to this contract invoice, the same will beadjudicated by the courts of competent jurisdiction to Delhi only, and exclusion of all other courts that may have jurisdiction in the matter.</li>

    <li>Thecontract invoice shall be governed and construed in accordance with laws of India without reference to its conflict of laws principles.</li>
    <li>In addition to the terms and conditions set forth in the contract invoice, and unless repugnant to the meaning or context thereof, the Advertiser hereby agreesand acknowledges that the User Agreement/Terms and Conditions, as reproduced on the tradeindi.com website 'tradeindia.com' ("T & Cs") are applicable to the contract invoice and are deemed to be incorporated herein by reference. In the event of any conflict or inconsistency between the contract invoice and the "T &Cs", the latter shall prevail.</li>

    <li>All correspondence to the Advertiser shall be sent to the address set forth overleaf and all correspondences to the Company should be addressed to ourRegistered Office.</li>
...
<ul class="page-list">
<li>Your privacy is very important to us. If you have further questions or feedback, please email us at <a href="mailto:info@franchiseindia.com">info@franchiseindia.com</a></li>
</ul>
<p class="static-txt-ter">Thank you for visiting <a href="https://www.franchiseindia.com/">www.franchiseindia.com</a>.</p>
