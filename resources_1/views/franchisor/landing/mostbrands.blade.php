                        ...
                        @foreach ($brand as $brandlista)
                            @if ($loop->iteration > $i * 25 && $loop->iteration <= ($i + 1) * 25)
                                <li>
                                    ...
                                    <a href="{{ Config('constants.MainDomain') }}/brands/{{ $brandlista['profile_name'] }}.{{ $brandlista['fran_detail_id'] }}"
                                        target="_blank"> {{ ucwords(strtolower($brandlista['company_name'])) }}
                                    </a>
                                </li>
                            @endif
                        @endforeach
