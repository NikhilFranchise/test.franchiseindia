        ...
        @desktop
                            ...
                            <div class="priclist">
                                        ...
                                        <div class="ftyblk">
                                            <div class="rinr">
                                                <div class="radio-item">
                                                    <input type="radio" id="ritema7" name="memberplan" id="price1"
                                                        value="113" checked>
                                            ...
                                            <div class="rinr otherp">
                                                <div class="radio-item">
                                                    <input type="radio" id="ritema8" name="memberplan" id="price2"
                                                        value="114">
                                                    <label for="ritema8"></label>
                                                </div>
                                                <i class="fas fa-rupee-sign"></i>
                                                <span class="pf1">29,997 </span><span class="pf2"><del class="dll">
                                                        58,500</del> /Qrt</span>
                                            </div>

                                            <div class="rinr otherp">
                                                <div class="radio-item">
                                                    <input type="radio" id="ritema10" name="memberplan" id="price2"
                                                        value="122">
                                                    <label for="ritema10"></label>
                                                </div>
                                                <i class="fas fa-rupee-sign"></i>
                                                <span class="pf1">59,994 </span><span class="pf2"><del class="dll">
                                                        1,17,000</del> /Half</span>
                                            </div>

                                            <div class="rinr otherp">
                                                <div class="radio-item">
                                                    <input type="radio" id="ritema9" name="memberplan"
                                                        value="115">
                                                    <label for="ritema9"></label>
                                                </div>
                                                <i class="fas fa-rupee-sign"></i>
                                                <span class="pf1">1,19,988</span><span class="pf2"><del
                                                        class="dll">2,34,000</del> /Yr</span>
                                            </div>
                                        </div>
                                        <input class="btncir active" type="submit" value="Buy Now">
                                    </form>
                                    <ul class="listp">
                                        <li>Get Priority over other business listings under - <strong>Sub - Sub
                                                Category</strong></li>
                                ...
                                <div class="priclistinner">
                                    ...
                                    <form class="form-horizontal" name="form_franchisor"
                                        action="{{ url('franchisor/registration/step/6') }}" method="POST"
                                        ...
                                        <div class="ftyblk">
                                            ...
                                            <div class="rinr otherp">
                                                ...
                                                <span class="pf1">1,43,000</span><span class="pf2">
                                                    <!--<del class="dll">1,95,000</del>-->/Half</span>
                                            </div>
                                            <div class="rinr otherp">
                                                <div class="radio-item">
                                                ...
                                                <i class="fas fa-rupee-sign"></i>
                                                <span class="pf1">1,62,500</span><span class="pf2">
                                                    <!--<del class="dll">3,90,000</del>-->/Yr</span>
                                            </div>
                                        </div>
         ...
         2,39,994</del>-->/Half</span>
                                            ...
                                            <div class="rinr otherp">
                                                ...
                                                <i class="fas fa-rupee-sign"></i>
                                                <span class="pf1">2,92,500</span><span class="pf2">
                                                    <!--<del class="dll">5,27,988</del>-->/Yr</span>
                                            </div>
                                        </div>
                                        <input class="btncir" type="submit" value="Buy Now">
                                    </form>
                            ...
                            <div class="priclistinner">
                                ...
                                <form class="form-horizontal" id="fran-form" name="form_franchisor"
                                    ...
                                    <div class="ftyblk">
                                        ...
                                        <div class="rinr otherp">
                                            <div class="radio-item">
                                                <input type="radio" id="ritema31" name="memberplan" value="123"
                                                    checked>
