<!-- Tech & Digital Launch start here -->

<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Tech & Digital</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Tech-Digital">More >></a></div>
    </div>
