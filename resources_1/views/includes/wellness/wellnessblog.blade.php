<!-- Wellness Blog Launch start here -->

<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Wellness Blog</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Wellness-blog">More >></a></div>
    </div>
