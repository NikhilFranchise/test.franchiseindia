                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/bos/" target="_blank">
                                <img src="https://www.franchiseindia.com/images/popup/bos-punjab.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form method="post" id="form1-stall" name="form1-stall" action="https://master.franchiseindia.com/bos/register_update.php" class="fro-expo-form">
					<input type="hidden" value="BOS-Insta-Register" id="ref" name="ref">
                <input type="hidden" name="src" id="src" value="Popup">
                <input type="hidden" name="reg_type" id="reg_type" value="BOS Free LP Punjab">                				
                <input type="hidden" value="Punjab April 2019" name="event_year" id="event_year">
