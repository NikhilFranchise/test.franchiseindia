<style type="text/css">
    ...
    .expo-header{ }
    .fi-bg-expo{height:460px; width:600px; margin:0 auto; background:url("https://www.franchiseindia.com/images/popup/janbackfro.jpg") no-repeat center top;}
    ...
    .expo-submitnew{background:url("https://www.franchiseindia.com/images/popup/submitfro2018.gif") no-repeat; width:123px;
        height:35px;cursor:pointer;  margin:5px auto 0 0px; border:none; display:inline-block;}
                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/fro/" target="_blank"><img class="lozad" data-src="https://www.franchiseindia.com/images/popup/popup-ahmedabad.jpg" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">

                        <div class="fblk">
                            <div class="fi-expotest">Want to <span>Start</span><br />
                                <span>your own business</span></div>
                            <div class="tsha">Explore from <span>200+ Business options</span> at Asia's Biggest<br />
                                Business Opportunity Expo</div>
                        ...
                        <div class="boxblk">
                                          ...
                                          <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_ahm.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                    <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
                                    <input type="hidden" value="Ahmedabad February 2019" name="event_year" id="event_year">
                                    <input type="hidden" value="FRO 2019 Ahmedabad" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select name="txtState" class="form-control myselectclasscat" id="txtState">
                                            ...
                                            <option value="Andhra Pradesh" >Andhra Pradesh</option><option value="Arunachal Pradesh" >Arunachal Pradesh</option><option value="Assam" >Assam</option><option value="Bihar" >Bihar</option><option value="Chhattisgarh" >Chhattisgarh</option><option value="Goa" >Goa</option><option value="Gujarat" selected>Gujarat</option><option value="Haryana" >Haryana</option><option value="Himachal Pradesh" >Himachal Pradesh</option><option value="Jammu and Kashmir" >Jammu and Kashmir</option><option value="Jharkhand" >Jharkhand</option><option value="Karnataka" >Karnataka</option><option value="Kerala" >Kerala</option><option value="Madhya Pradesh" >Madhya Pradesh</option><option value="Maharashtra" >Maharashtra</option><option value="Manipur" >Manipur</option><option value="Meghalaya" >Meghalaya</option><option value="Mizoram" >Mizoram</option><option value="Nagaland" >Nagaland</option><option value="Delhi/NCR" >Delhi/NCR</option><option value="Orissa" >Orissa</option><option value="Pondicherry" >Pondicherry</option>
                                            <option value="Punjab">Punjab</option><option value="Rajasthan" >Rajasthan</option><option value="Sikkim" >Sikkim</option><option value="Tripura" >Tripura</option><option value="Uttaranchal" >Uttaranchal</option><option value="Uttar Pardesh" >Uttar Pardesh</option><option value="West Bengal" >West Bengal</option><option value="Tamil Nadu" >Tamil Nadu</option>
