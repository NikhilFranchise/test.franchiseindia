        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    <div class="headtag">
                        <img src="https://www.franchiseindia.com/images/popup/fro-header-feb2020.jpg" /></a>
                    </div>
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
                                <input type="hidden" value="Ahmedabad February 2020" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2020 Ahmedabad" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select type="text" id="eventdays" name="eventdays" class="form-control" accesskey="" onchange="checkNumbers()" required>
                                            <option value="Saturday15thfebruary">Select Date</option>
                                            <option value="Saturday15thfebruary" selected="selected">Saturday, 15th February</option>
                                            <option value="Sunday16thfebruary">Sunday, 16th February</option>
                                            <option value="Bothdays">Both days, 15th-16th February</option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers(){var amt=500;var eventdays=$("#eventdays :selected").val();var visitVal=$("#txtDelegates :selected").val();if(eventdays=="Saturday15thfebruary")
    {amt=1000;$('#txtAmount').val(amt);}
    else if(eventdays=="Sunday16thfebruary")
    {amt=1000;$('#txtAmount').val(amt);}
    else if(eventdays=="Bothdays")
    {amt=2000;$('#txtAmount').val(amt);}
