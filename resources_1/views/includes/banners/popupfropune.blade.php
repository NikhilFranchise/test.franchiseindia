                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/fro/" target="_blank"><img class="lozad" data-src="https://www.franchiseindia.com/images/popup/pune-header.gif" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                                ...
                                <form class="form fro-expo-form" action="https://master.franchiseindia.com/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                    ...
                                    <input type="hidden" value="Pune July 2019" name="event_year" id="event_year">
                                    <input type="hidden" value="FRO 2019 Pune" name="event_title" id="event_title">
                                        ...
                                        <div class="f3">
                                            <select name="txtCity" class="form-control myselectclasssearch" id="popupcity" >
                                                ...
                                                @foreach($cities as $value)
                                                    <option value="{!! $value !!}"  @if ( $value == "Pune") selected @endif>{!! $value !!} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
