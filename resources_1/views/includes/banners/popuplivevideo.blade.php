    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="yt-player">
                <iframe id="videoModalone" width="100%" height="400" src="https://dezd00medastx.cloudfront.net/belive/franchise_india/index.html" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>
