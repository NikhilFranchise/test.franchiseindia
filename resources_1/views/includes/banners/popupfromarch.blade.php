        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    <div class="headtag">
                        <img src="https://www.franchiseindia.com/images/popup/fro-header-mar2020.jpg" /></a>
                    </div>
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_hyderabad.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                ...
                                <input type="hidden" value="Hyderabad March 2020" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2020 Hyderabad" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select type="text" id="eventdays" name="eventdays" class="form-control" accesskey="" onchange="checkNumbers()" required>
                                            <option value="Saturday14thMarch">Select Date</option>
                                            <option value="Saturday14thMarch" selected="selected">Saturday, 14th March</option>
                                            <option value="Sunday15thMarch">Sunday, 15th March</option>
                                            <option value="Bothdays1415March">Both days, 14th-15th March</option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers(){var amt=500;var eventdays=$("#eventdays :selected").val();var visitVal=$("#txtDelegates :selected").val();if(eventdays=="Saturday14thMarch")
