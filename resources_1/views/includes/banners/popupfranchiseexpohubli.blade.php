...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-top:110px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-expo-hubli-bottom.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/franchise-expo-hubli-top.jpg") no-repeat center top;
overflow: hidden;
...
<input type="hidden" value="Hubli23rdDecember2023" name="eventdays" id="eventdays">
<div class="sec">
                                      <div class="f1">
                                    </div>
                                    <div class="f1">
