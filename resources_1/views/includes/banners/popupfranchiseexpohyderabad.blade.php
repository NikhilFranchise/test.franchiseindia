...
.submit-sec{display: block;
    ...
    .fi-bg-expo {
        ...
        padding-top:110px;
        margin: 0 auto;
background: url("https://ds120o7vl8cz9.cloudfront.net/images/popup/franchise-expo-hyderabad-bottom.jpg") no-repeat center top;
    }
...
background: url("https://ds120o7vl8cz9.cloudfront.net/images/popup/franchise-expo-hyderabad-top.jpg") no-repeat center top;
overflow: hidden;
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                    	<div class="boxblk">
<form class="form registration-form align-center" action="https://www.franchiseindia.net/fro/hyderabad/register_update.php" method="post">
<input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
<input type="hidden" value="Hyderabad March 2024" name="event_year" id="event_year">
<input type="hidden" value="FRO 2024 Hyderabad" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                   <div class="f1">
                                    <input type="text" class="form-control" maxlength="150" value="" id="txtAddress" name="txtAddress" title="Enter Address" required="">
                                                                    ...
                                                                    <div class="sec">
                                    <div class="f1">
                                     <select id="txtDelegates" name="txtDelegates" class="form-control" onchange="checkNumbersforfrom(this.value);" required="">
...
<div class="submit-sec">
                        <button type="submit" id="submtval" value="Book Your Seat" name="btnSubmitReg" class="expo-submitnew"><img src="https://ds120o7vl8cz9.cloudfront.net/images/popup/submits.jpg"></button>
</div>
