...
select option{background:#07406f;}
    .f1 {
        float: left;
        width: 40%;
        margin-left: 10px;
    ...
    .model_top{
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/time-kids.jpg") no-repeat center top;
    }


    .fi-bg-expo {
        margin: 0 auto;padding-top: 177px;
    }
  ...
  height: 31px;
  border: 1px solid #01aae4 !important;
    }
...
<input type="hidden" value="FIHL670484" id="franchisor_id" name="franchisor_id">
