<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        padding-top:71px;
        margin: 0 auto;
background: url("https://www.franchiseindia.com/images/popup/franchiseshowbottom.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/franchiseshowtop.jpg") no-repeat center top;
overflow: hidden;
...
@php
    ...
    asort($states);
@endphp
<div id="myModal1" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
              <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_franchise_show_fihl.php" method="post">
    ...
    <input id="tfw_interest" name="tfw_interest" type="hidden" value="Visit the Expo - Paid">  
                                ...
                                <div class="sec">
                                      <div class="f1">
                                        <select type="text" placeholder="No. of Visitors" id="eventdays" name="event_year" class="form-control" accesskey="" onchange="checkNumbers();">
<option value="Raipur, 18 February 2023">Raipur, 18 February 2023</option>
<option value="Nagpur, 19 February 2023">Nagpur, 19-February 2023</option>
<option value="Amravati, 21 February 2023">Amravati, 21 February 2023</option>
<option value="Aurangabad, 23 February 2023">Aurangabad, 23 February 2023</option>
<option value="Nashik, 24 February 2023">Nashik, 24 February 2023</option>
<option value="Pune, 26 February 2023">Pune, 26 February 2023</option>
<option value="Kolhapur, 28 February 2023">Kolhapur, 28 February 2023</option>
<option value="Goa, 02 March 2023">Goa, 02 March 2023</option>
<option value="Thane, 04 March 2023">Thane, 04 March 2023</option>
<option value="Navi Mumbai, 05 March 2023">Navi Mumbai, 05 March 2023</option>
               </select>
                                    </div>
                                    <div class="f1">
