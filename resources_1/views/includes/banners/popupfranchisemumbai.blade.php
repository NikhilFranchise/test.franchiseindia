...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fromumbaitop.jpg") no-repeat center top;
    }
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/fromumbaibottom.jpg") no-repeat center top;
    }
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
         ...
         <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_mumbai.php" method="post">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Mumbai December 2022" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2022 Mumbai" name="event_title" id="event_title">  
         ...
         <input type="hidden" name="tfw_interest" value="Visit the Expo - Paid"> 
                                ...
                                <div class="sec">
                                    <div class="f1">
                                     ...
                                     <div class="f3">
                       <select type="text" placeholder="No. of Visitors" id="eventdays" name="eventdays" class="form-control" accesskey="" onchange="checkNumbers();">
                   <option value="Friday02ndDecember" selected="selected">Friday, 02nd December  </option>
                     <option value="Saturday03rdDecember">Saturday, 03rd December  </option>
                     <option value="Bothdays0203December">Both days, 02nd-03rd December </option>
                  </select>
