...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/frohyderabad-top.jpg") no-repeat center top;
    }
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/frohyderabad-bottom.jpg") no-repeat center top;
    }
        ...
        <div class="modal-content">
                ...
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_hyderabad.php" method="post">

           <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Hyderabad March 2023" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2023 Hyderabad" name="event_title" id="event_title">  
         ...
         <input type="hidden" name="tfw_interest" value="Visit the Expo - Paid"> 
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                    <select type="text" placeholder="No. of Visitors" id="eventdays" name="eventdays" class="form-control myselect" required="">
<option value="Visitor" selected="selected">Expo Visitor</option>
<option value="Delegate">Business Delegate</option>
</select>
                                    </div>
                                </div>
