...
input:focus {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/franchise-india-mumbai-footer.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/franchise-india-mumbai-header.jpg") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
           ...
           <form action="https://www.franchiseindia.com/expo/mumbai/register_update.php" class="form registration-form align-center" method="post">
                        ...
                        <input type="hidden" value="Mumbai November 2024" name="event_year" id="event_year">
