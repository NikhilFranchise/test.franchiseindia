...
.expo-header{ }
.fi-bg-expo{height:534px; width:600px; margin:0 auto; background:url("https://www.franchiseindia.com/images/popup/bospopup-bg.jpg") no-repeat center top;}
...
.fro-expo-form  input[type="text"], .fro-expo-form input[type="tel"], .fro-expo-form input[type="email"]{ width:50%;     height: 36px;  padding:6px 0 6px 10px; color:#454545; float:left; background:white; border:1px solid #dfdfdf; border-radius:4px;}
...
<div id="my_modal" class="model_top" style="width:600px;"> 
  ...
  <div class="expo-header">
      <a href="https://www.franchiseindia.com/bos/" target="_blank"><img src="https://www.franchiseindia.com/images/popup/bos-up.gif" /></a>
  </div>
  </div>
...
<div class="fblk">
  ...
  <div class="boxblk">
       ...
       <form method="post" id="form1-stall" name="form1-stall" action="https://master.franchiseindia.com/bos/insta_reg_ticket.php" class="fro-expo-form">
           ...
           <input type="hidden" name="event_year" id="event_year" value="February 2019">
           <input type="hidden" name="city" id="event_year" value="Lucknow">
           ...
           <div class="sec">
           <select id="listBox" name="state" onchange="selct_district(this.value)" class="form-control myselectclasscat" required="">
               ...
               <option value="Nagaland">Nagaland</option><option value="Orissa">Orissa</option><option value="Puducherry">Puducherry</option>
               <option value="Punjab">Punjab</option><option value="Rajasthan">Rajasthan</option><option value="Sikkim">Sikkim</option>
               <option value="Tamil Nadu">Tamil Nadu</option><option value="Telangana">Telangana</option>
               <option value="Tripura">Tripura</option><option value="Uttar Pradesh" selected>Uttar Pradesh</option>
               <option value="Uttarakhand">Uttarakhand</option><option value="West Bengal">West Bengal</option></select>
           </div>


            <div class="sec">
    
            	<input id="address" name="txtCity" type="text" class="form-control" placeholder="City" required="">
 ...
 <ul class="bostxt">
 <li><span>9</span> Years</li><li>|</li>
  <li><span>500+</span> Shows</li><li>|</li>
   <li><span>70+</span> Cities</li>
   </ul>
  </div>
</div>
      </div>
