<style type="text/css">
    ...
    .fi-bg-expo {
        ...
        padding-top:77px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/popupboagbtm.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/popupboagtop.jpg") no-repeat center top;
overflow: hidden;
...
<div id="myModal" class="modal fade" aria-hidden="true" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        ...
        <input id="lp_type" name="event_title" type="hidden" value="Franchise Show - BOAG"> 
...
<option value="Rajasthan13July2021">Rajasthan, 13 July 2021</option>
<option value="Gujarat14July2021">Gujarat, 14 July 2021</option>
<option value="UttarPradesh15July2021">UttarPradesh, 15 July 2021</option>
<option value="Karnataka16July2021">Karnataka, 16 July 2021</option>  
<option value="Maharashtral7July2021">Maharashtra, 17 July 2021</option> 
<option value="TamilNadu20July2021">Tamil Nadu , 20 July 2021</option>  
<option value="MadhyaPradesh21July2021">Madhya Pradesh, 21 July 2021</option>
<option value="WestBengal23July2021">West Bengal, 23 July 2021</option>
<option value="DELHINCR24July2021">DELHI-NCR, 24 July 2021</option>
                                        </select>
                                    </div>
                                    <div class="f1">
                                ...
                                <div class="sec">
                                    <div class="f1">
                                        <input name="txtPhone" type="tel" placeholder="Contact" class="form-control" pattern="[567789][0-9]{9}" minlength="10" maxlength="10" onkeypress="return isNumber(event)" required="">
                                    </div>
                                    <div class="f3">
                                ...
                                <div class="sec" style="text-align:leftg">
                                    <input type="submit" value="Book Your Seat" name="btnSubmitReg" class="expo-submitnew">
                                </div>
                        </div>
                    </div>
                </div>
