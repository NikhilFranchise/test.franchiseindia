        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="my_modal" class="model_top" style="width:600px">
                    <div class="headtag">
                        <img src="https://www.franchiseindia.com/images/popup/fro-header-dec-2019.jpg" /></a>
                    </div>
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                ...
                                <input type="hidden" value="Chennai December 2019" name="event_year" id="event_year">
                                <input type="hidden" value="FRO 2019 December" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f3">
                                        <select type="text" id="eventdays" name="eventdays" class="form-control" accesskey="" onchange="checkNumbers()" required>
                                            <option value="Saturday7thdecember">Select Date</option>
                                            <option value="Saturday7thdecember" selected="selected">Saturday, 7th December</option>
                                            <option value="Sunday8thdecember">Sunday, 8th December</option>
                                            <option value="Bothdays">Both days, 7-8th December</option>
                                        </select>
                                    </div>
                                </div>
...
<script language="javascript">
    function checkNumbers(){var amt=500;var eventdays=$("#eventdays :selected").val();var visitVal=$("#txtDelegates :selected").val();if(eventdays=="Saturday7thdecember")
    {amt=500;$('#txtAmount').val(amt);}
    else if(eventdays=="Sunday8thdecember")
    {amt=500;$('#txtAmount').val(amt);}
