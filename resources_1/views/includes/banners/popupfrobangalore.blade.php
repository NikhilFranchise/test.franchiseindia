...
@php
    $states = Config('location.stateArr');
        asort($states);
    $cities = Config('location.cityArr.14');
        asort($cities);
@endphp
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function(){
                        $("#novisit").change(function() {
                            total = $('#novisit :selected').val() * 1000;
                ...
                <div id="my_modal" class="model_top" style="width:600px;">
                    ...
                    <div class="fi-HeadCont-expo">
                        ...
                        <div class="expo-header">
                            <a href="https://www.franchiseindia.com/fro/" target="_blank"><img class="lozad" data-src="https://www.franchiseindia.com/images/popup/bangalore-header.gif" /></a>
                        </div>
                    </div>
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                                ...
                                <form class="form fro-expo-form" action="https://master.franchiseindia.com/fro/register_update.php" method="post" name="frmConferenceReg" id="frmConferenceReg">
                                    ...
                                    <input type="hidden" value="FRO 2019 Bangalore" name="event_title" id="event_title">
                                ...
                                <div class="sec">
                                    ...
                                    <div class="f2">:</div>
                                    <div class="f3">
                                        <select name="txtState" onchange="getcitypopup(this)"  class="form-control myselectclasscat" id="txtState">
                                            <option value="" data-id="">Select State</option>
                                            @foreach($states as $index => $value)
                                                <option value="{{ $value }}" data-id="{{ $index }}"  @if($index == 14) selected @endif >{!! $value !!}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="sec">
                                        ...
                                        <div class="f2">:</div>
                                        <div class="f3">
                                            <select name="txtCity" class="form-control myselectclasssearch" id="popupcity" >
                                                <option value="">Select a City</option>
                                                @foreach($cities as $value)
                                                    <option value="{!! $value !!}"  @if ( $value == "Bangalore Urban District") selected @endif>{!! $value !!} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="sec">
                                    <input class="form-control"  type="hidden" value="1000" id="novisitAmountt" name="txtAmount" readonly>
                                </div>
