...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/froahmedabad-top.png") no-repeat center top;
    }
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/froahmedabad-bottom.jpg") no-repeat center top;
    }
...
background: url("https://www.franchiseindia.com/images/popup/froahmedabad-top.jpg") no-repeat center top;
overflow: hidden;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
             ...
             <div class="fi-bg-expo">
               <div class="boxblk">
      <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_ahmedabad.php" method="post">
         <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Ahmedabad April 2023" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2023 Ahmedabad" name="event_title" id="event_title">  
