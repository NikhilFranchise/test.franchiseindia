...
#myModal .modal-body {
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/frochandigarh-top.jpg") no-repeat center top;
    }
    ...
    .fi-bg-expo {
        ...
        width: 600px;
        margin: 0 auto;
        background: url("https://www.franchiseindia.com/images/popup/frochandigarh-bottom.jpg") no-repeat center top;
    }
                ...
                <div id="my_modal" class="model_top" style="width:600px">
                    ...
                    <div class="fi-bg-expo">
                        ...
                        <div class="boxblk">
                            ...
                            <form class="form registration-form align-center" action="https://master.franchiseindia.com/fro/register_update_chandigarh.php" method="post">

           <input id="ref" name="ref" type="hidden" value="FRO-Insta-Paid">
         <input type="hidden" value="Chandigarh February 2023" name="event_year" id="event_year">  
         <input type="hidden" value="FRO 2023 Chandigarh" name="event_title" id="event_title">  
