...
<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Skill Development</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Skill-Development">More >></a></div>
    </div>
    <ul class="row ri-img-txt-list">
        @foreach( $skillArticles as $article )
        @php
