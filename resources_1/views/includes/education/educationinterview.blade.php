<!-- educationstartups startups  start here -->

<div class="bor-radius backwhite pad20 ovfl mart20">
    <div class="ri-headingRt2">
        <h2><span><div>Education Interview</div></span></h2>
        <div class="ri-c-more"><a href="{{ Config('constants.MainDomain') }}/content/Education-interview">More >></a></div>
    </div>
    <ul class="row ri-img-txt-list">
        @foreach( $interviewArticles as $article )
        @php
        ...
        <li class="col-xs-12 col-sm-4 col-md-4">
            ...
            <div class="ri-himg-blk"><a href="{{ $kicker }}">{{$article['kicker']}}</a>
            </div>
            <div class="ri-inner_bullets"><a
                        href="{{ Config('constants.MainDomain') }}/education/{{$article['slug']}}.{{$article['content_id']}}">
                    {{$article['homeTitle']}}
...
</div><!-- educationstartups Launch End here-->