...
<div class="sidearce bor-radius backwhite pad30" >
    ...
    <div id="instaSubscribeMsg" class="green" style="display: none"><h2><b>Thank you for Enquiry.</b></h2><br>
...
Magazine</span>
        ...
        <div class="formsection padartif">
            <form id="instaSubscribeForm" class="query_cell" method="post">
                ...
                <div class="sbctsxt">
                    OR
                    <span><a href="https://www.franchiseindia.com/emagazine/shop/products/view/id/1">Click here</a> to Subscribe Online</span>
                </div>
            </form>
        </div>
