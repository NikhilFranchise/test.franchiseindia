@if( count($vmlaunchArticles) != 0 )

<!-- Restaurant Store+VM / Product Launch block Start here-->
<div class="bor-radius backwhite pad20 ovfl mart20 othersliderblk">
    <div class="ri-headingRt2">
        <h2><span><div>Restaurant Store+VM / Product Launch</div></span></h2>
        <div class="ri-c-more">&nbsp;</div>
    </div>


    <ul class="row slidecom bxslidervm">
        @foreach($vmlaunchArticles as $article)
                @php
