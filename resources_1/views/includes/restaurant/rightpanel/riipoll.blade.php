<!-- poll start here -->
<div class="sidearce bor-radius backwhite pad20 ovfl ri">
    ...
    <form method="post" name="pollForm">
        ...
        <input type="button" class="pollbtn" value="" id="riipollSubmit" name="submit"><br>

        <div id="voted" style="display: none"><font color="red"><b>Already voted..!</b></font></div>

        <input type="button" class="buttonRes" value="" id="riipollAnswer" name="pollAnswer"></form>
</div>

<!--poll end here -->
<script type="text/javascript">
    $(document).ready(function () {
        $('#riipollSubmit').click(function () {
