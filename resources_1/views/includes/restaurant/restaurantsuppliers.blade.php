...
<div class="bor-radius backwhite pad20 ovfl mart20">
    ...
    <div class="ri-haeding-blk"><span><h3>Restaurant Suppliers</h3></span>
        <div class="pull-right"><a href="{{ Config('constants.MainDomain') }}/content/Business-suppliers"><img class="fr" alt=""
