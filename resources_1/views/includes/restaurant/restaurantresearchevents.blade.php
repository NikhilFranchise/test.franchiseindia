...
<div class="bor-radius backwhite pad20 ovfl mart20">
    ...
    <div class="ri-haeding-blk"><span><h3>Restaurant Research & Events</h3></span>
        <div class="pull-right">
            <a href="{{ Config('constants.MainDomain') }}/content/Research">
                <img class="fr" src="{{ Config('constants.MainDomain') }}/images/buttons/more.gif">
            </a>
        </div>
    </div>
...
</div><!-- Brands & Product Launch End here-->