...
<div class="bor-radius backwhite pad20 ovfl mart20">
    ...
    <div class="ri-haeding-blk"><span><h3>Restaurant Operations</h3></span>
        <div class="pull-right"><a href="{{ Config('constants.MainDomain') }}/content/operations"><img class="fr" alt=""
                                                 src="{{ Config('constants.MainDomain') }}/images/buttons/more.gif"></a></div>
    </div>


    <ul class="row ri-img-txt-list">
        @foreach( $operationArticles as $article )
            @php
