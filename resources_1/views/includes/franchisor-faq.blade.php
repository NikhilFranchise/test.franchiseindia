...
.rightvideo .homevideo .ytimg img.videoico {
     top: inherit;
    left: inherit;
    text-align: center;
    display: table-cell;
...
<div class="col-xs-12 col-sm-3 col-md-3 bor-radius backwhite pad30 targright rightvideo">
    <div class="homevideo">
        ...
        <a href="#" data-toggle="modal" data-target="#combinedvideo"><div class="ytimg">
                <div class="overlay"> <img alt="guide video" src="{{Config::get('constants.MainDomain')}}/images/guidevideoicon.png"  class="videoico"/></div>
                <img src="https://i.ytimg.com/vi/NNIdvHq81fw/mqdefault.jpg" title="" alt="youtube video"></div>
        </a>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe  width="100%" height="400" id="videoModalonefran"
                         src="https://www.youtube.com/embed/NNIdvHq81fw" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>
