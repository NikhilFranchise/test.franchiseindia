...
@section('dateModified', isset($newsDetails->published_date) ? $newsDetails->published_date : $newsDetails->created_at2)
@php
...
@section('content')
    ...
    <script>
        ...
        (function() {
            ...
            window.__setupGPTOnlyOnce = function() {
                googletag.cmd.push(setupGPTOnlyOnce);
            };
        })();
    </script>
            ...
            <div class="container">
                @desktop
                    <div class="inner-article-detail-desktop-top-ad">
                        ...
                        @endphp
                        <div id="{{ $topAd }}" class="gpt-ad" data-slot="/1057625/FIHL/FI_Desktop_ROS_728x90_ATF"
        ...
        <div class="contentwrapper">
                ...
                <div class="row">
                                ...
                                <div class="content-share">
                                    ...
                                    <div class="follow-us first">
                                        <a href="" target="_blank">
                                            Follow Us
                                            <img src="{{ url('detailpage/images/follows.png') }}" alt="Franchise India"
                                                width="11" height="11">
                                        </a>
                                    </div>
                                </div>
                        ...
                        fetchpriority="high" /> --}}
                            ...
                            @php
                                $relativePath = str_replace(
                                    'https://franchiseindia.s3.ap-south-1.amazonaws.com/',
                                    '',
                                    $ogimage,
                                );
                            ...
                            <picture>
                                <img src="{{ url('img/1600x940/' . $relativePath) }}" alt="{{ $newsDetails->title }}"
                                    class="img-fluid" loading="eager" decoding="async" fetchpriority="high"
                    ...
                    <div class="col-md-4">
                        <div class="right-wrap">
                            ...
                            <div class="ad-right" class="gpt-ad" data-slot="/1057625/FIHL/Desktop_ROS_300x250_ATF"
                                data-sizes="[[300,250]]">
                            </div>
                        </div>
                        {{-- ads top right sidebar --}}
                        ...
                        <div class="ad-right-sticky">
                            ...
                            <div id="{{ $rightBottomAd }}" class="gpt-ad"
                                data-slot="/1057625/FIHL/FI_Desktop_ROS_RHS_300x250_1" data-sizes="[[300,250],[300,600]]">
                                {{-- <script>
                                    googletag.cmd.push(function() {
            ...
            @desktop
                ...
                <div class="inner-article-detail-desktop-top-ad">
                    ...
                    @endphp --}}
                    <div id="{{ $bottomAd }}" class="gpt-ad" data-slot="/1057625/FIHL/FI_Desktop_ROS_728x90_BTF"
    ...
    <script>
        (function() {
            function initAd(div) {
                ...
                let sizes;
                try {
                    sizes = JSON.parse(div.dataset.sizes || '[]');
                } catch (e) {
                    sizes = [];
                }
