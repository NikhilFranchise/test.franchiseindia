        ...
        <div class="listblk smap">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/crre/sitemap') . '/' . $Y }}">{{ $Y }}</a></li>
                    <li class="breadcrumb-item">{{ date('F', mktime(0, 0, 0, $M, 10)) }}</li>
                </ul>
                ...
                <ul class="sitemaplist-year sitemap-week-date">
                    ...
                    @forelse($allDays as $record)
                        <li>
                            <a href="{{ url("/crre/sitemap/{$Y}/{$M}/" . str_pad($record, 2, '0', STR_PAD_LEFT)) }}">
