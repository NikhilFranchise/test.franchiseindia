...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="{{ route('podcast.list', ['lang' => $lang]) }}" title="Go to Manage Podcasts" class="tip-bottom"><i
                    class="fa fa-podcast"></i> Manage
                Podcasts</a>
            <a href="{{ url()->current() }}" class="current">Edit {{ $language }} Podcast</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="row-fluid">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"> <i class="fa fa-podcast"></i> </span>
                    <h5>Edit {{ $language }} Podcast</h5>
                </div>
                <div class="widget-content nopadding">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                        action="{{ route('podcast.update', ['lang' => $lang]) }}" id="podform" novalidate>
                        @csrf
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required class="span11" name="Podcast_url" title="Podcast URL"
                        ...
                        <div class="control-group">
                            ...
                            <img class="oldImage"
                                src="{{ \App\Http\Controllers\Admin\AdminController::createimgurl($data->image_path, 'en') }}"
                                style="max-width: 300px; margin:0px 195px 15px; padding-top:inherit; border-radius: 5px;">
                            <br>
