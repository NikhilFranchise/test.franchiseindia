...
<head>
    <meta charset="UTF-8">
    <title>Query( Expand My Brand ) - FranchiseIndia</title>
...
<table width="698" border="0" cellpadding="0" bgcolor="#fbfbfb" cellspacing="0" align="center" style="margin:0 auto;border:1px solid #eaeaea" id="mainTbl">
    <tr>
        <td valign="top">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td valign="top">
                        <table width="45%" align="center" cellpadding="0" cellspacing="0" class="logo-mo">
                            <tr>
                                <td valign="top" align="center" style="padding:39px 0 39px 0; "><img src="{{url('mail/images/logo.png')}}" alt="logo" style="display:block; line-height:0; border:0;"></td>
                            </tr>
                        </table>
                    </td>
            </table>
    ...
    <tr>
        <td valign="top">
            <table width="92%" class="menu-list" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td valign="top" style="padding-bottom:60px;">
            <table width="89%" class="tbl-main" cellpadding="0" align="center" cellspacing="0"
                   style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666;text-align:left; border:1px solid #eaeaea; ">
                <tbody>
                <tr>
                    <td valign="top" class="mt-tbl">
                        <table width="100%" class="tbl-mo" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td width="5%" class="td-dot" valign="top" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
                                <td width="70%" class="td-value" valign="top" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;">{{ $details->c_code   }} {{ $details->mobile   }}</td>
                            </tr>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#f3f3f3">
                <tr>
                    <td valign="top" width="90%">
                        <table width="90%" align="center" cellpadding="0" cellspacing="0" class="activate-so">
                            <tr>
                            ...
                            <tr>
                                <td valign="top" style="padding:20px 0 40px 0;">
                                    <table width="33%" align="center" cellpadding="0" cellspacing="0" class="logo-mo">
                                        <tr>
