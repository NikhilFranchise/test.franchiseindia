    ...
    <tr>
        <td valign="top">
            <table width="100%" cellspacing="0" cellpadding="0">
                <tbody>
                <tr>
                    <td valign="top" style="padding:60px 0 26px 0; font-size:25px; text-align:center; color:#333333;" align="left"><span style="font-family: Arial, sans-serif; "> Dear Investor</span> </td>
                </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr>
        <td valign="top">
            <table width="100%" cellspacing="0" cellpadding="0">
                <tbody>
                <tr>
                    <td valign="top" class="td-business" style="padding:0 82px 40px 82px; line-height:22px; text-align:center; font-size:18px; color:#666666;"><span style="font-family: Arial, Helvetica, sans-serif; "> We noticed your interest in the<span style="color:#333333; font-weight:bold;">"{{ $category }}"</span> category. Another perfect investment opportunity awaits your attention. Keeping your best interests in mind, we wanted to introduce you to  <span style="color:#333333; font-weight:bold;">"{{ $brandName }}"</span>, who is looking for an investor like you.</span></td>
                </tr>
                </tbody>
            </table>
        </td>
