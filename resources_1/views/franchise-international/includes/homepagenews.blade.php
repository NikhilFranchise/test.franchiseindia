                                                ...
                                                <div class="search-count">
                                                    <div class="vertical-mid">
                                                        <div class="bdr">
                                                            <div class="count">
                                                                {{--  <a
                                                 href="{{ Config('constants.NewsDomain') }}/{{ $article['urlKicker'] }}">Startup</a>  --}}
                                                                <a
