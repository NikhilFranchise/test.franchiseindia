                              ...
                              <form action="{{ route('submit.enquiry') }}" method="POST" id="form2">
                                ...
                                <div class="form-group" style="position: relative;">
                                    ...
                                    <button type="button" id="verifybutton2"
                                            ...
                                            style="position:absolute; right:13px; top:9px; background:#dc3322; border:#dc3322; display:none;">
                                        Verify
                                    </button>
                                ...
                                <div class="form-group" id="otpBlock2" style="display:none; position:relative;">
                                    ...
                                    <button type="button" onclick="verifyOtp(2)"
                                            ...
                                            style="position:absolute; right:13px; top:9px; background:#dc3322; border:#dc3322; ">
                                        Verify OTP
                                    </button>
