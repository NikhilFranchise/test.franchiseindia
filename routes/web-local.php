...
Route::middleware(['TrailingSlashRedirect'])->group(function () {
    Route::group(['prefix' => 'insights'], function () {
        ...
        Route::group(['prefix' => 'en'], function () {
            ...
            Route::get('/education-traning', function () {
                return redirect()->to('/insights/en/education', 301);
            });
            Route::get('{slug}',                        [InsightsController::class, 'insightscategorydata'])->name('catRoute');
        });
        ...
        Route::group(['prefix' => 'hi'], function () {
            ...
            Route::get('industryfocus',                 [InsightsController::class, 'industryfocus']);
            Route::get('/education-traning', function () {
                return redirect()->to('/insights/hi/education', 301);
            });
