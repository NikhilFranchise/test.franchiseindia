...
class CrreSitemapController extends Controller
{
    public function sitemap()
    {
        // Query years from English table
        $englishYears = InsightList::query()
            ->whereIn('insight_type', ['News', 'Article', 'Interview', 'Report'])
        ...
        return view('crre.sitemaps.year_sitemap', compact('allYears'));
    }
    ...
    public function monthsitemap(Request $request, $year)
    {
        ...
        return view('crre.sitemaps.month_sitemap', compact('allMonths', 'Y'));
    }
    ...
    public function daysitemap(Request $request, $year, $month)
    {
        ...
        return view('crre.sitemaps.day_sitemap', compact('allDays', 'M', 'Y'));
    }
    ...
    public function datesitemap(Request $request, $year, $month, $day)
    {
        ...
        return view('crre.sitemaps.date_sitemap', compact('allData', 'year', 'month', 'day'));
    }
    ...
    public function todaysitemap()
    {
        ...
        return view('crre.sitemaps.today_sitemap', compact('allTodayData'));
    }
    ...
    public function yesterdaysitemap()
    {
        ...
        return view('crre.sitemaps.yesterday_sitemap', compact('allYdayData'));
    }
    ...
    public function thisweeksitemap()
    {
        ...
        return view('crre.sitemaps.thisweek_sitemap', compact('allThisWeekData'));
    }
    ...
    public function lastweeksitemap()
    {
        ...
        return view('crre.sitemaps.lastweek_sitemap', compact('allLastWeekData'));
    }
    ...
    public function newssitemap()
    {
        ...
        // Return XML response
        return response()
            ->view('crre.sitemaps.news_sitemap', ['newssitemap' => $newssitemap])
    ...
    public function articlesitemap()
    {
        ...
        $articlesitemap = $model::query()->select('news_id', 'title', 'slug', 'insight_type', 'cat_id', 'created_at', 'published_date')
            ...
            ->get();
        //  dd($model,$locale);
        return response()->view('crre.sitemaps.art_sitemap', ['articlesitemap' => $articlesitemap])->header('Content-type', 'text/xml');
    }
    ...
    public function interviewsitemap()
    {
        ...
        $interviewsitemap = $model::query()->select('news_id', 'title', 'slug', 'insight_type', 'cat_id', 'created_at', 'published_date')
            ...
            ->orderByEffectiveDate('desc')
            ->get();
        return response()->view('crre.sitemaps.interview_sitemap', ['interviewsitemap' => $interviewsitemap])->header('Content-type', 'text/xml');
    }
    ...
    public function eventsitemap()
    {
        ...
        $eventsitemap = $model::query()->select('news_id', 'title', 'slug', 'insight_type', 'cat_id', 'created_at', 'published_date')
            ...
            ->orderByEffectiveDate('desc')
            ->get();
        return response()->view('crre.sitemaps.event_sitemap', ['eventsitemap' => $eventsitemap])->header('Content-type', 'text/xml');
    }
    public function reportsitemap()
    {
        ...
        $reportsitemap = $model::query()->select('news_id', 'title', 'slug', 'insight_type', 'cat_id', 'created_at', 'published_date')
            ...
            ->orderByEffectiveDate('desc')
            ->get();
        return response()->view('crre.sitemaps.report_sitemap', ['reportsitemap' => $reportsitemap])->header('Content-type', 'text/xml');
    }
    ...
    public function categorysitemap()
    {
        ...
        // dd($categorydata);
        return response()
            ->view('crre.sitemaps.categories_sitemap', ['categorydata' => $categorydata])
            ->header('Content-Type', 'text/xml');
    }
    ...
    public function subcategorysitemap()
    {
        ...
        // dd($subcategories);
        return response()
            ->view('crre.sitemaps.subcat_sitemap', ['subcategories' => $subcategories])
            ->header('Content-Type', 'text/xml');
    }
    ...
    public function tagsitemap()
    {
        ...
        return response()
            ->view('crre.sitemaps.tags_sitemap', ['tagsData' => $tagsData])
            ->header('Content-Type', 'text/xml');
    }
    ...
    public function rssFeed()
    {
        ...
        $latestarticles = $newsModel::query()->select('news_id', 'title', 'slug', 'insight_type', 'cat_id', 'created_at', 'published_date')
            ...
            ->limit(5)->get();
        // dd($latestarticles);
        return view('crre.rss-feed', compact('categories', 'latestarticles'));
    }
